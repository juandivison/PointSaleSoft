...
var
  strRuta : String;
begin
  StrRuta:=  FIniFile.ReadString(SECTION, 'ImpCKS', '');
...
begin
  FIniFile.WriteString(SECTION, 'ImpCKS', Trim(edtServidor.Text) + ':' + Trim(edtRuta.Text));
...
begin
  ...
  begin
    MostrarVentana := True;
    RegistrarRuta;
    LabelRuta.Caption := FIniFile.ReadString(SECTION, 'ImpCKS', '');
