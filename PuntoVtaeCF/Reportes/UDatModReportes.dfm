object dmReportes: TdmReportes
  ...
  object qryNCFAfectado_0: TIBQuery
    Database = dmConectar.IBDatabase1
    Transaction = dmConectar.IBTransaction1
    BufferChunks = 1000
    CachedUpdates = False
  ...
  object qryNCFAfectado_1: TIBQuery
    Database = dmConectar.IBDatabase1
    Transaction = dmConectar.IBTransaction1
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'Select n.ECF NUMERO_NCF From eCF_ASIGNADOS n'
      'Where n.SERIE = ('
      'Select r.SERIE_eCF_ASIGNADO SERIE_NCF_ASIGNADO'
      'From VENTAS_MAST r'
      
        'INNER join TRANS_CXC_DET t on t.SERIE_eCF_ASIGNADO=:seriefcnasig' +
        'nado'
      'And t.NUMERO_TRN_ORIGEN = r.NUMERO) ')
    Left = 488
    Top = 592
