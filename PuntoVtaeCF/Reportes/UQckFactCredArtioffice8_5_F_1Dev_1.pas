unit UQckFactCredArtioffice8_5_F_1Dev_1;
...
type
  TqckFactCredArtioffice8_5_F_1Devolucion_1 = class(TQuickRep)
...
var
  qckFactCredArtioffice8_5_F_1Devolucion_1: TqckFactCredArtioffice8_5_F_1Devolucion_1;
...
procedure TqckFactCredArtioffice8_5_F_1Devolucion_1.QuickRepBeforePrint(
  Sender: TCustomQuickRep; var PrintReport: Boolean);
begin
  qckFactCredArtioffice8_5_F_1Devolucion_1.AllDataSets.Add(dmCompania.tblCompania);
...
procedure TqckFactCredArtioffice8_5_F_1Devolucion_1.QRLabel23Print(sender: TObject;
  var Value: String);
begin
  Value:=GlbBuscarCodigoVendedor(glbcodVendedor);
end;

procedure TqckFactCredArtioffice8_5_F_1Devolucion_1.QRLabel24Print(sender: TObject;
  var Value: String);
begin
  Value:=Value + ' '+dmfactura.qryPorcApplicadoenFactServPorcGAdmin.AsString+'%';
end;

procedure TqckFactCredArtioffice8_5_F_1Devolucion_1.QRLabel25Print(sender: TObject;
  var Value: String);
begin
  Value:=Value + ' '+dmfactura.qryPorcApplicadoenFactServPorcItbisGAdmin.AsString+'%';
end;

procedure TqckFactCredArtioffice8_5_F_1Devolucion_1.QRLabel26Print(sender: TObject;
  var Value: String);
begin
  Value:=Value + ' '+dmfactura.qryPorcApplicadoenFactServPorcTrans.AsString+'%';
end;

procedure TqckFactCredArtioffice8_5_F_1Devolucion_1.QRLabel27Print(sender: TObject;
  var Value: String);
begin
  Value:=Value + ' '+dmfactura.qryPorcApplicadoenFactServPorcDirTec.AsString+'%';
end;

procedure TqckFactCredArtioffice8_5_F_1Devolucion_1.QRLabel28Print(sender: TObject;
  var Value: String);
begin
  Value:=Value + ' '+dmfactura.qryPorcApplicadoenFactServPorcItbisDirTec.AsString+'%';
end;

procedure TqckFactCredArtioffice8_5_F_1Devolucion_1.QRLabel29Print(sender: TObject;
  var Value: String);
begin
  Value:=Value + ' '+dmfactura.qryPorcApplicadoenFactServPORCIMPREVISTO.AsString+'%';
end;

procedure TqckFactCredArtioffice8_5_F_1Devolucion_1.QRLabel30Print(sender: TObject;
  var Value: String);
begin
  Value:=Value + ' '+dmfactura.qryPorcApplicadoenFactServPorcItbisImprevisto.AsString+'%';
end;

procedure TqckFactCredArtioffice8_5_F_1Devolucion_1.DetailBand1BeforePrint(
...
procedure TqckFactCredArtioffice8_5_F_1Devolucion_1.QRDBText22Print(sender: TObject;
  var Value: String);
begin
  if (Value <> '') then
  Value:='NCF: '+Value;
...
procedure TqckFactCredArtioffice8_5_F_1Devolucion_1.ChildBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  TPag.Caption:= IntToStr(qckFactCredArtioffice8_5_F_1Devolucion_1.PageNumber);
end;

procedure TqckFactCredArtioffice8_5_F_1Devolucion_1.QRSysData3Print(sender: TObject;
  var Value: String);
begin
  Value:=Value +' de ';
end;

procedure TqckFactCredArtioffice8_5_F_1Devolucion_1.ColumnHeaderBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
  var
    _xImagen : String;
begin
