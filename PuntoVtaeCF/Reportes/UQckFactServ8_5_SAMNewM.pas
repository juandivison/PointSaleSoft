...
type
  TqckFactServ_8_5SAMNewM = class(TQuickRep)
...
var
  qckFactServ_8_5SAMNewM: TqckFactServ_8_5SAMNewM;
...
uses UDatModCompania, UDatModClientes, UGlobal,
  ...
  UDatModFactura, UQckFactServ8_5_SAMNew;

{$R *.DFM}

procedure TqckFactServ_8_5SAMNewM.QuickRepBeforePrint(
...
begin
  ...
  LogInformacionTxt('Record no encontrado en tabla DatosVehculo. Numero='+dmReportes.qryViewVentasMastidNumeroDVeh.AsString);
  ...
  qckFactServ_8_5SAMNewM.AllDataSets.Add(dmCompania.tblCompania);
  qckFactServ_8_5SAMNewM.AllDataSets.Add(dmDatos.qryMembrete);
  qckFactServ_8_5SAMNewM.AllDataSets.Add(dmReportes.qryRepDatosPoliza);
...
procedure TqckFactServ_8_5SAMNewM.QRLabel23Print(sender: TObject;
  var Value: String);
begin
  Value:='';
...
procedure TqckFactServ_8_5SAMNewM.DetailBand1BeforePrint(
...
procedure TqckFactServ_8_5SAMNewM.QRDBText22Print(sender: TObject;
  var Value: String);
begin
  if (Value <> '') then
  Value:='NCF: '+Value;
...
procedure TqckFactServ_8_5SAMNewM.ChildBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  TPag.Caption:= IntToStr(qckFactServ_8_5SAMNewM.PageNumber);
end;

procedure TqckFactServ_8_5SAMNewM.QRSysData3Print(sender: TObject;
  var Value: String);
begin
  Value:=Value +' de ';
end;

procedure TqckFactServ_8_5SAMNewM.ColumnHeaderBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
  var
    _xImagen : String;
begin
...
procedure TqckFactServ_8_5SAMNewM.QRDBText9Print(sender: TObject;
  var Value: String);
begin
...
procedure TqckFactServ_8_5SAMNewM.QRSubDetail1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
  var
  valor : string;
begin
...
procedure TqckFactServ_8_5SAMNewM.QRDBText21Print(sender: TObject;
  var Value: String);
begin
  Value:= Value+strCopia;
end;

procedure TqckFactServ_8_5SAMNewM.QRDBText23Print(sender: TObject;
  var Value: String);
begin
...
procedure TqckFactServ_8_5SAMNewM.QRDBText29Print(sender: TObject;
  var Value: String);
begin
...
procedure TqckFactServ_8_5SAMNewM.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TqckFactServ_8_5SAMNewM.QRSubDetail1AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
