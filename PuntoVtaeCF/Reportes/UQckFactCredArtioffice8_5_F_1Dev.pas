unit UQckFactCredArtioffice8_5_F_1Dev;
...
type
  TqckFactCredArtioffice8_5_F_1Devolucion = class(TQuickRep)
...
var
  qckFactCredArtioffice8_5_F_1Devolucion: TqckFactCredArtioffice8_5_F_1Devolucion;
...
procedure TqckFactCredArtioffice8_5_F_1Devolucion.QuickRepBeforePrint(
  Sender: TCustomQuickRep; var PrintReport: Boolean);
begin
  qckFactCredArtioffice8_5_F_1Devolucion.AllDataSets.Add(dmCompania.tblCompania);
...
procedure TqckFactCredArtioffice8_5_F_1Devolucion.QRLabel23Print(sender: TObject;
  var Value: String);
begin
  Value:=GlbBuscarCodigoVendedor(glbcodVendedor);
end;

procedure TqckFactCredArtioffice8_5_F_1Devolucion.QRLabel24Print(sender: TObject;
  var Value: String);
begin
  Value:=Value + ' '+dmfactura.qryPorcApplicadoenFactServPorcGAdmin.AsString+'%';
end;

procedure TqckFactCredArtioffice8_5_F_1Devolucion.QRLabel25Print(sender: TObject;
  var Value: String);
begin
  Value:=Value + ' '+dmfactura.qryPorcApplicadoenFactServPorcItbisGAdmin.AsString+'%';
end;

procedure TqckFactCredArtioffice8_5_F_1Devolucion.QRLabel26Print(sender: TObject;
  var Value: String);
begin
  Value:=Value + ' '+dmfactura.qryPorcApplicadoenFactServPorcTrans.AsString+'%';
end;

procedure TqckFactCredArtioffice8_5_F_1Devolucion.QRLabel27Print(sender: TObject;
  var Value: String);
begin
  Value:=Value + ' '+dmfactura.qryPorcApplicadoenFactServPorcDirTec.AsString+'%';
end;

procedure TqckFactCredArtioffice8_5_F_1Devolucion.QRLabel28Print(sender: TObject;
  var Value: String);
begin
  Value:=Value + ' '+dmfactura.qryPorcApplicadoenFactServPorcItbisDirTec.AsString+'%';
end;

procedure TqckFactCredArtioffice8_5_F_1Devolucion.QRLabel29Print(sender: TObject;
  var Value: String);
begin
  Value:=Value + ' '+dmfactura.qryPorcApplicadoenFactServPORCIMPREVISTO.AsString+'%';
end;

procedure TqckFactCredArtioffice8_5_F_1Devolucion.QRLabel30Print(sender: TObject;
  var Value: String);
begin
  Value:=Value + ' '+dmfactura.qryPorcApplicadoenFactServPorcItbisImprevisto.AsString+'%';
end;

procedure TqckFactCredArtioffice8_5_F_1Devolucion.DetailBand1BeforePrint(
...
procedure TqckFactCredArtioffice8_5_F_1Devolucion.QRDBText22Print(sender: TObject;
  var Value: String);
begin
  if (Value <> '') then
  Value:='NCF: '+Value;
...
procedure TqckFactCredArtioffice8_5_F_1Devolucion.ChildBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  TPag.Caption:= IntToStr(qckFactCredArtioffice8_5_F_1.PageNumber);
end;

procedure TqckFactCredArtioffice8_5_F_1Devolucion.QRSysData3Print(sender: TObject;
  var Value: String);
begin
  Value:=Value +' de ';
end;

procedure TqckFactCredArtioffice8_5_F_1Devolucion.ColumnHeaderBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
  var
    _xImagen : String;
begin
