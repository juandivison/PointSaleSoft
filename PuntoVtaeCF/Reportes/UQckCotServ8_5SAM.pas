...
type
  TqckCotServ8_5SAM = class(TQuickRep)
...
var
  qckCotServ8_5SAM: TqckCotServ8_5SAM;
...
procedure TqckCotServ8_5SAM.QuickRepBeforePrint(
...
begin
  ...
  qckCotServ8_5SAM.AllDataSets.Add(dmCompania.tblCompania);
  qckCotServ8_5SAM.AllDataSets.Add(dmDatos.qryMembrete);
end;

procedure TqckCotServ8_5SAM.QRLabel23Print(sender: TObject;
  var Value: String);
begin
...
procedure TqckCotServ8_5SAM.DetailBand1BeforePrint(
...
procedure TqckCotServ8_5SAM.QRDBText22Print(sender: TObject;
  var Value: String);
begin
  if (Value <> '') then
  Value:='NCF: '+Value;
...
procedure TqckCotServ8_5SAM.ChildBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  TPag.Caption:= IntToStr(qckCotServ8_5SAM.PageNumber);
end;

procedure TqckCotServ8_5SAM.QRSysData3Print(sender: TObject;
  var Value: String);
begin
  Value:=Value +' de ';
end;

procedure TqckCotServ8_5SAM.ColumnHeaderBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
  var
    _xImagen : String;
begin
...
procedure TqckCotServ8_5SAM.QRDBText9Print(sender: TObject;
  var Value: String);
begin
...
procedure TqckCotServ8_5SAM.QRLabel25Print(sender: TObject;
  var Value: String);
begin
...
procedure TqckCotServ8_5SAM.QRSubDetail1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
  var
  valor : string;
begin
...
procedure TqckCotServ8_5SAM.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
