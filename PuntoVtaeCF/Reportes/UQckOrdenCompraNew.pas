...
type
  TqckOrdenDeCompraNew = class(TQuickRep)
...
var
  qckOrdenDeCompraNew: TqckOrdenDeCompraNew;
...
procedure TqckOrdenDeCompraNew.QuickRepBeforePrint(
  Sender: TCustomQuickRep; var PrintReport: Boolean);
begin
  qckOrdenDeCompraNew.AllDataSets.Add(dmCompania.tblCompania);
end;

procedure TqckOrdenDeCompraNew.QRLabel23Print(sender: TObject;
  var Value: String);
begin
...
procedure TqckOrdenDeCompraNew.QRDBText22Print(sender: TObject;
  var Value: String);
begin
  //if (Value <> '') then Value:='NCF: '+Value;
end;

procedure TqckOrdenDeCompraNew.ChildBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  TPag.Caption:= IntToStr(qckOrdenDeCompraNew.PageNumber);
end;

procedure TqckOrdenDeCompraNew.QRSysData3Print(sender: TObject;
  var Value: String);
begin
  Value:=Value +' de ';
end;

procedure TqckOrdenDeCompraNew.ColumnHeaderBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
  var
    _xImagen : String;
begin
...
procedure TqckOrdenDeCompraNew.QRDBText13Print(sender: TObject;
  var Value: String);
begin
  if dmDatos.qryDatosOrdenImpFECHA_DEBERECIBIR.IsNull then
  Value:='';
end;
