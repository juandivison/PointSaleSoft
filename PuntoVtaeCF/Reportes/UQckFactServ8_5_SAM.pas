...
type
  TqckFactServ_8_5SAM = class(TQuickRep)
...
var
  qckFactServ_8_5SAM: TqckFactServ_8_5SAM;
...
procedure TqckFactServ_8_5SAM.QuickRepBeforePrint(
...
begin
  ...
  qckFactServ_8_5SAM.AllDataSets.Add(dmCompania.tblCompania);
  qckFactServ_8_5SAM.AllDataSets.Add(dmDatos.qryMembrete);
...
procedure TqckFactServ_8_5SAM.QRLabel23Print(sender: TObject;
  var Value: String);
begin
  Value:='';
...
procedure TqckFactServ_8_5SAM.DetailBand1BeforePrint(
...
procedure TqckFactServ_8_5SAM.QRDBText22Print(sender: TObject;
  var Value: String);
begin
  if (Value <> '') then
  Value:='NCF: '+Value;
...
procedure TqckFactServ_8_5SAM.ChildBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  TPag.Caption:= IntToStr(qckFactServ_8_5SAM.PageNumber);
end;

procedure TqckFactServ_8_5SAM.QRSysData3Print(sender: TObject;
  var Value: String);
begin
  Value:=Value +' de ';
end;

procedure TqckFactServ_8_5SAM.ColumnHeaderBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
  var
    _xImagen : String;
begin
...
procedure TqckFactServ_8_5SAM.QRDBText9Print(sender: TObject;
  var Value: String);
begin
...
procedure TqckFactServ_8_5SAM.QRSubDetail1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
  var
  valor : string;
begin
...
procedure TqckFactServ_8_5SAM.QRDBText21Print(sender: TObject;
  var Value: String);
begin
  Value:= Value+strCopia;
end;

procedure TqckFactServ_8_5SAM.QRDBText23Print(sender: TObject;
  var Value: String);
begin
...
procedure TqckFactServ_8_5SAM.QRDBText29Print(sender: TObject;
  var Value: String);
begin
...
procedure TqckFactServ_8_5SAM.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TqckFactServ_8_5SAM.QRSubDetail1AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
