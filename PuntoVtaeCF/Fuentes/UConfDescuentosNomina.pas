...
uses
  ...
  DBCtrls, rxToolEdit,IBCustomDataSet, EditNew, RxLookup, WinSkinData;
...
begin
  ...
  dmDescuentosNom.qryFechasTipoDes.Close;
  dmDescuentosNom.qryFechasTipoDes.Open;
  dmDescuentosNom.tblDescNomina.Close;
  dmDescuentosNom.tblDescNomina.Params[0].Value:=ExtraerFecha(dmDescuentosNom.qryFechasTipoDesFECHA_INICIAL.Value);
...
begin
  ...
  try
    ...
    begin
      dmDescuentosNom.tblDescNomina.Close;
      dmDescuentosNom.tblDescNomina.Params[0].Value := ExtraerFecha(frmSelFecha.FechaIni.Date);
      dmDescuentosNom.tblDescNomina.Open;
    end;
  finally
  frmSelFecha.Free;
