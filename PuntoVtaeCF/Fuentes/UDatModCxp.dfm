object dmCxp: TdmCxp
  ...
  object tblTransCxp: TIBDataSet
    ...
    InsertSQL.Strings = (
      'insert into TRANS_CXP'
        ...
        '   FECHA_IN, IN_POR, FECHA_MOD, MOD_POR, CODIGO_USUARIO, SERIETR' +
        'NCOSTO)'
      'values'
        ...
        '   :FECHA_IN, :IN_POR, :FECHA_MOD, :MOD_POR, :CODIGO_USUARIO, :S' +
        'ERIETRNCOSTO)')
    RefreshSQL.Strings = (
      'Select '
      '  SERIE,'
    ...
    object tblTransCxpCODIGO_USUARIO: TIntegerField
      FieldName = 'CODIGO_USUARIO'
      Origin = 'TRANS_CXP.CODIGO_USUARIO'
    end
    object tblTransCxpCIA_KEY: TIntegerField
      FieldName = 'CIA_KEY'
      Origin = 'TRANS_CXP.CIA_KEY'
    end
    object tblTransCxpSERIETRNCOSTO: TIntegerField
      FieldName = 'SERIETRNCOSTO'
      Origin = 'TRANS_CXP.SERIETRNCOSTO'
    end
  end
  ...
  object qryFactPendCxp: TIBQuery
    ...
    SQL.Strings = (
      ...
      '      FACTURAS_CXP_PENDIENTES.num_fact_prov,'
    ...
    object qryFactPendCxpNUM_FACT_PROV: TIBStringField
      FieldName = 'NUM_FACT_PROV'
      Origin = 'FACTURAS_CXP_PENDIENTES.NUM_FACT_PROV'
    end
  end
  ...
  object transCxpNotaDebito: TIBDataSet
    Database = dmConectar.IBDatabase1
    Transaction = dmConectar.IBTransaction1
    BufferChunks = 1000
    CachedUpdates = False
    DeleteSQL.Strings = (
      'delete from TRANS_CXP_DET'
      'where'
      '  SERIE = :OLD_SERIE')
    InsertSQL.Strings = (
      'insert into TRANS_CXP_DET'
    ...
    Left = 296
    Top = 272
    object transCxpNotaDebitoSERIE: TIntegerField
      FieldName = 'SERIE'
      Origin = 'TRANS_CXC_DET.SERIE'
      Required = True
    end
    object transCxpNotaDebitoNUM_DOC: TIntegerField
      FieldName = 'NUM_DOC'
      Origin = 'TRANS_CXC_DET.NUM_DOC'
      Required = True
    end
    object transCxpNotaDebitoNUMERO_FACT: TIntegerField
      FieldName = 'NUMERO_FACT'
      Origin = 'TRANS_CXC_DET.NUMERO_FACT'
      Required = True
    end
    object transCxpNotaDebitoSERIE_NCF_ASIGNADO: TIntegerField
      FieldName = 'SERIE_NCF_ASIGNADO'
      Origin = 'TRANS_CXC_DET.SERIE_NCF_ASIGNADO'
    end
  end
  object qryRepTransCxpNDB_NCR: TIBQuery
    Database = dmConectar.IBDatabase1
    Transaction = dmConectar.IBTransaction1
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'SELECT '
      '       TRANS_CXP.SERIE,'
      '       TRANS_CXP_DET.NUM_DOC,'
      '       TRANS_CXP_DET.NUMERO_FACT,'
      '       TRANS_CXP_DET.SERIE_NCF_ASIGNADO,'
      '       DOC_TRAN_CXT.DESCRIPCION,'
      '       TRANS_CXP.TIPO_DOC,'
      '       TRANS_CXP.MONEDA,'
      '       TRANS_CXP.FECHA,'
      ...
      '       TRANS_CXP.STATUS,'
      '       0 NUMERO_TRN_VENTA,'
      '       TRANS_CXP.CODIGO_USUARIO CODIGO_VENDEDOR,'
      '       NCF_ASIGNADOS.NUMERO_NCF,'
      '       PROVEEDORES.DESCRIPCION NOMBRE_CTE,'
      '       PROVEEDORES.CALYYNUM DIRECCION_CONT,'
      '       PROVEEDORES.TELEFONO TELEF_CONTACTO,'
      '       PROVEEDORES.RNC_PROVEEDOR RNC_NUMERO,'
      '       TIPO_CF.DESCRIPCION DescNCF'
      'FROM'
      '  TIPO_CF'
      
        '  INNER JOIN NCF_ASIGNADOS ON (TIPO_CF.TIPO_CF = NCF_ASIGNADOS.T' +
        'IPO_NCF)'
      
        '  RIGHT OUTER JOIN TRANS_CXP_DET ON (NCF_ASIGNADOS.SERIE = TRANS' +
        '_CXP_DET.SERIE_NCF_ASIGNADO)'
      
        '  RIGHT OUTER JOIN TRANS_CXP ON (TRANS_CXP_DET.SERIE = TRANS_CXP' +
        '.SERIE)'
      
        '  LEFT OUTER JOIN PROVEEDORES ON (TRANS_CXP.CODIGO_CLIENTE = PRO' +
        'VEEDORES.CODIGO_CTE)'
      
        '  INNER JOIN DOC_TRAN_CXT ON (TRANS_CXP.TIPO_DOC = DOC_TRAN_CXT.' +
        'CODIGO)'
      ''
      'Where TRANS_CXP.TIPO_DOC in (3,5)'
      'And TRANS_CXP_DET.NUM_DOC =:numdoc'
      'And TRANS_CXP.TIPO_DOC =:tiodoc'
      'ORDER BY TRANS_CXP.TIPO_DOC')
    Left = 368
    Top = 368
    ParamData = <
      item
    ...
    object qryRepTransCxpNDB_NCRSERIE: TFloatField
      FieldName = 'SERIE'
      Origin = 'TRANS_CXC.SERIE'
      Required = True
    end
    object qryRepTransCxpNDB_NCRNUM_DOC: TIntegerField
      FieldName = 'NUM_DOC'
      Origin = 'TRANS_CXC_DET.NUM_DOC'
      Required = True
    end
    object qryRepTransCxpNDB_NCRNUMERO_FACT: TIntegerField
      FieldName = 'NUMERO_FACT'
      Origin = 'TRANS_CXC_DET.NUMERO_FACT'
    end
    object qryRepTransCxpNDB_NCRSERIE_NCF_ASIGNADO: TIntegerField
      FieldName = 'SERIE_NCF_ASIGNADO'
      Origin = 'TRANS_CXC_DET.SERIE_NCF_ASIGNADO'
    end
    object qryRepTransCxpNDB_NCRDESCRIPCION: TIBStringField
      FieldName = 'DESCRIPCION'
      Origin = 'DOC_TRAN_CXT.DESCRIPCION'
      Size = 30
    end
    object qryRepTransCxpNDB_NCRTIPO_DOC: TIntegerField
      FieldName = 'TIPO_DOC'
      Origin = 'TRANS_CXC.TIPO_DOC'
      Required = True
    end
    object qryRepTransCxpNDB_NCRMONEDA: TIBStringField
      FieldName = 'MONEDA'
      Origin = 'TRANS_CXC.MONEDA'
      FixedChar = True
      Size = 1
    end
    object qryRepTransCxpNDB_NCRFECHA: TDateTimeField
      FieldName = 'FECHA'
      Origin = 'TRANS_CXC.FECHA'
    end
    object qryRepTransCxpNDB_NCRNUMERO_DOC: TIntegerField
      FieldName = 'NUMERO_DOC'
      Origin = 'TRANS_CXC.NUMERO_DOC'
    end
    object qryRepTransCxpNDB_NCRCODIGO_CLIENTE: TIntegerField
      FieldName = 'CODIGO_CLIENTE'
      Origin = 'TRANS_CXC.CODIGO_CLIENTE'
    end
    object qryRepTransCxpNDB_NCRCONCEPTO: TIBStringField
      FieldName = 'CONCEPTO'
      Origin = 'TRANS_CXC.CONCEPTO'
      Size = 60
    end
    object qryRepTransCxpNDB_NCRVALOR_DOCUMENTO: TFloatField
      FieldName = 'VALOR_DOCUMENTO'
      Origin = 'TRANS_CXC.VALOR_DOCUMENTO'
    end
    object qryRepTransCxpNDB_NCRTIPO_TRANF: TSmallintField
      FieldName = 'TIPO_TRANF'
      Origin = 'TRANS_CXC.TIPO_TRANF'
    end
    object qryRepTransCxpNDB_NCRSTATUS: TIBStringField
      FieldName = 'STATUS'
      Origin = 'TRANS_CXC.STATUS'
      FixedChar = True
      Size = 1
    end
    object qryRepTransCxpNDB_NCRNUMERO_TRN_VENTA: TIntegerField
      FieldName = 'NUMERO_TRN_VENTA'
      Origin = 'TRANS_CXC.NUMERO_TRN_VENTA'
    end
    object qryRepTransCxpNDB_NCRCODIGO_VENDEDOR: TIntegerField
      FieldName = 'CODIGO_VENDEDOR'
      Origin = 'TRANS_CXC.CODIGO_VENDEDOR'
    end
    object qryRepTransCxpNDB_NCRNUMERO_NCF: TIBStringField
      FieldName = 'NUMERO_NCF'
      Origin = 'NCF_ASIGNADOS.NUMERO_NCF'
      Size = 21
    end
    object qryRepTransCxpNDB_NCRNOMBRE_CTE: TIBStringField
      FieldName = 'NOMBRE_CTE'
      Origin = 'CLIENTES.NOMBRE_CTE'
      Size = 60
    end
    object qryRepTransCxpNDB_NCRDIRECCION_CONT: TIBStringField
      FieldName = 'DIRECCION_CONT'
      Origin = 'CLIENTES.DIRECCION_CONT'
      Size = 60
    end
    object qryRepTransCxpNDB_NCRTELEF_CONTACTO: TIBStringField
      FieldName = 'TELEF_CONTACTO'
      Origin = 'CLIENTES.TELEF_CONTACTO'
      Size = 14
    end
    object qryRepTransCxpNDB_NCRRNC_NUMERO: TIBStringField
      FieldName = 'RNC_NUMERO'
      Origin = 'CLIENTES.RNC_NUMERO'
      Size = 14
    end
    object qryRepTransCxpNDB_NCRDESCNCF: TIBStringField
      FieldName = 'DESCNCF'
      Origin = 'TIPO_CF.DESCRIPCION'
      Size = 60
    end
  end
  object transCxpNotaCredito: TIBDataSet
    Database = dmConectar.IBDatabase1
    Transaction = dmConectar.IBTransaction1
    BufferChunks = 1000
    CachedUpdates = False
    ...
    Left = 248
    Top = 408
    object transCxpNotaCreditoSERIE: TIntegerField
      FieldName = 'SERIE'
      Origin = 'TRANS_CXC_DET.SERIE'
      Required = True
    end
    object transCxpNotaCreditoNUM_DOC: TIntegerField
      FieldName = 'NUM_DOC'
      Origin = 'TRANS_CXC_DET.NUM_DOC'
      Required = True
    end
    object transCxpNotaCreditoNUMERO_FACT: TIntegerField
      FieldName = 'NUMERO_FACT'
      Origin = 'TRANS_CXC_DET.NUMERO_FACT'
    end
    object transCxpNotaCreditoSERIE_NCF_ASIGNADO: TIntegerField
      FieldName = 'SERIE_NCF_ASIGNADO'
      Origin = 'TRANS_CXC_DET.SERIE_NCF_ASIGNADO'
    end
  end
  object dstblTransCxp: TDataSource
    DataSet = tblTransCxp
    Left = 328
    Top = 32
  end
  ...
  object qryBalanceCtes: TIBDataSet
    ...
    InsertSQL.Strings = (
      'insert into Balance_cxp'
        ...
        '  (CODIGO, TIPO, MONEDA, CIA_KEY, BALANCE_ACT, BALANCE_ANT, DEBI' +
        'TO_MES, '
      
        '   CREDITO_MES, DEBITO_ACM, CREDITO_ACM, FECHA_BCE, FECHA_ULT_PA' +
        'GO, STATUS_BCE, '
      '   FECHA_IN, IN_POR, FECHA_MOD, MOD_POR, CODIGO_USUARIO)'
      'values'
      
        '  (:CODIGO, :TIPO, :MONEDA, :CIA_KEY, :BALANCE_ACT, :BALANCE_ANT' +
        ', :DEBITO_MES, '
      
        '   :CREDITO_MES, :DEBITO_ACM, :CREDITO_ACM, :FECHA_BCE, :FECHA_U' +
        'LT_PAGO, '
      
        '   :STATUS_BCE, :FECHA_IN, :IN_POR, :FECHA_MOD, :MOD_POR, :CODIG' +
        'O_USUARIO)')
    RefreshSQL.Strings = (
      'Select '
      '  CODIGO,'
      ...
      '  MONEDA = :MONEDA')
    SelectSQL.Strings = (
      'Select  b.* , p.descripcion nombre'
      'From Balance_cxp b, proveedores p'
      'where b.codigo = p.codigo_cte'
      'order by b.codigo')
    ModifySQL.Strings = (
      'update Balance_cxp'
      'set'
    ...
    object qryBalanceCtesNOMBRE: TIBStringField
      FieldName = 'NOMBRE'
      Origin = 'PROVEEDORES.DESCRIPCION'
      Size = 40
    end
    object qryBalanceCtesTIPO: TIntegerField
      FieldName = 'TIPO'
      Origin = 'BALANCE_CXP.TIPO'
      Required = True
    end
    ...
    object qryBalanceCtesCODIGO_USUARIO: TIntegerField
      FieldName = 'CODIGO_USUARIO'
      Origin = 'BALANCE_CXP.CODIGO_USUARIO'
    end
    object qryBalanceCtesCIA_KEY: TIntegerField
      FieldName = 'CIA_KEY'
      Origin = 'BALANCE_CXP.CIA_KEY'
    end
  end
  object qryFactPendCxp_Base: TIBQuery
    Database = dmConectar.IBDatabase1
    Transaction = dmConectar.IBTransaction1
    BufferChunks = 1000
    CachedUpdates = False
