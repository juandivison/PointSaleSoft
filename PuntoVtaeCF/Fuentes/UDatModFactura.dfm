object dmFactura: TdmFactura
  ...
  object tblDgii_SerieNCF: TIBTable
    ...
    OnFilterRecord = tblDgii_SerieNCFFilterRecord
    Left = 167
    Top = 261
  ...
  object tblQryHistoricoSecNCF: TIBDataSet
    ...
    SelectSQL.Strings = (
      'Select * From CONTROL_SEC_NCF'
      'Where IDNCF Between :idncfini and :idncffin')
    ModifySQL.Strings = (
  ...
  object ibQryViewNCFGastos: TIBQuery
    ...
    SQL.Strings = (
      ...
      'v.IDSEC_2018,v.DESCRIPCION_2018,v.FECHA_VENCE,'
        ...
        'CR '
      'From View_nfc v Where v.TIPO_CF in ('#39'11'#39','#39'44'#39')')
    Left = 232
    Top = 480
  ...
  object tblTipoCF: TIBDataSet
    ...
    InsertSQL.Strings = (
      'insert into TIPO_CF'
      '  (TIPO_CF, DESCRIPCION, DESCRIPCION_2018)'
      'values'
      '  (:TIPO_CF, :DESCRIPCION, :DESCRIPCION_2018)')
    RefreshSQL.Strings = (
      'Select '
    ...
    SelectSQL.Strings = (
      'Select * From TIPO_CF'
      'Where tipo_cf between :tipoini and :tipofin'
      'Order by Tipo_Cf')
    ModifySQL.Strings = (
      'update TIPO_CF'
      'set'
      '  TIPO_CF = :TIPO_CF,'
      '  DESCRIPCION = :DESCRIPCION,'
      '  DESCRIPCION_2018 = :DESCRIPCION_2018'
      'where'
      '  TIPO_CF = :OLD_TIPO_CF')
    Left = 16
    Top = 248
    ...
    object tblTipoCFDESCRIPCION_2018: TIBStringField
      FieldName = 'DESCRIPCION_2018'
      Origin = 'TIPO_CF.DESCRIPCION_2018'
      Size = 60
    end
  end
  object ibQryViewNCF_1: TIBQuery
    Database = dmConectar.IBDatabase1
    Transaction = dmConectar.IBTransaction1
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'Select distinct  v.id, v.SERIE,'
      'v.IDSEC_2018,v.DESCRIPCION_2018,v.FECHA_VENCE,'
      
        'v.DIV_NEGOCIO,v.PECF,v.AICF,v.TIPO_CF,v.NCF, iif(v.SERIE ='#39'E'#39',v.' +
        'DESCRIPCION_2018,n.DESCRIPCION) DESCRIPCION, '
      
        'iif(v.SERIE ='#39'E'#39',null,n.TIPO_NCF_IFISCAL) TIPO_NCF_IFISCAL, iif(' +
        'v.SERIE ='#39'E'#39',null,n.tipo_ncfNCR) tipo_ncfNCR '
      'From View_nfc v, NCF_TIPO_IFISCAL n '
      'Where v.TIPO_CF = n.TIPO_NCF'
      'and v.SERIE ='#39'E'#39' and n.DESCRIPCION is not null'
      'order by v.TIPO_CF, n.tipo_ncfNCR desc')
    Left = 272
    Top = 440
    object ibQryViewNCF_1ID: TIBStringField
      FieldKind = fkInternalCalc
      FieldName = 'ID'
      Origin = 'VIEW_NFC.ID'
      ReadOnly = True
    ...
    object ibQryViewNCF_1SERIE: TIBStringField
      FieldName = 'SERIE'
      Origin = 'VIEW_NFC.SERIE'
      FixedChar = True
      Size = 1
    end
    object ibQryViewNCF_1IDSEC_2018: TIBStringField
      FieldKind = fkInternalCalc
      FieldName = 'IDSEC_2018'
      Origin = 'VIEW_NFC.IDSEC_2018'
      ReadOnly = True
    ...
    object ibQryViewNCF_1DESCRIPCION_2018: TIBStringField
      FieldName = 'DESCRIPCION_2018'
      Origin = 'VIEW_NFC.DESCRIPCION_2018'
      Size = 60
    end
    object ibQryViewNCF_1FECHA_VENCE: TDateTimeField
      FieldName = 'FECHA_VENCE'
      Origin = 'VIEW_NFC.FECHA_VENCE'
    end
    object ibQryViewNCF_1DIV_NEGOCIO: TIBStringField
      FieldName = 'DIV_NEGOCIO'
      Origin = 'VIEW_NFC.DIV_NEGOCIO'
      FixedChar = True
      Size = 2
    end
    object ibQryViewNCF_1PECF: TIBStringField
      FieldName = 'PECF'
      Origin = 'VIEW_NFC.PECF'
      FixedChar = True
      Size = 3
    end
    object ibQryViewNCF_1AICF: TIBStringField
      FieldName = 'AICF'
      Origin = 'VIEW_NFC.AICF'
      FixedChar = True
      Size = 3
    end
    object ibQryViewNCF_1TIPO_CF: TIBStringField
      FieldName = 'TIPO_CF'
      Origin = 'VIEW_NFC.TIPO_CF'
      FixedChar = True
      Size = 2
    end
    object ibQryViewNCF_1NCF: TFloatField
      FieldName = 'NCF'
      Origin = 'VIEW_NFC.NCF'
    end
    object ibQryViewNCF_1DESCRIPCION: TIBStringField
      FieldName = 'DESCRIPCION'
      Size = 80
    end
    object ibQryViewNCF_1TIPO_NCF_IFISCAL: TIntegerField
      FieldName = 'TIPO_NCF_IFISCAL'
    end
    object ibQryViewNCF_1TIPO_NCFNCR: TSmallintField
      FieldName = 'TIPO_NCFNCR'
    end
  end
  object qryGeteCFAsignado_0: TIBQuery
    Database = dmConectar.IBDatabase1
    Transaction = dmConectar.IBTransaction1
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
        ...
        'SELECT r.NUMERO_FACT, r.NUM_DOC, r.SERIE_eCF_ASIGNADO, r.NUMERO_' +
        'TRN_ORIGEN, '
      'n.NUMERO_eCF numero_ncf_afectado, '
      'n.tipo_ncf, v.TIPONCFIFISCAL'
      'FROM TRANS_CXC_DET r, VENTAS_MAST v, eCF_ASIGNADOS n'
      'Where r.NUMERO_TRN_ORIGEN = v.NUMERO'
      'And n.SERIE = v.SERIE_eCF_ASIGNADO'
      'And r.NUMERO_TRN_ORIGEN=:numerotrn')
    Left = 968
    Top = 420
    ParamData = <
  ...
  object qryGeeCFAsignado_1: TIBQuery
    Database = dmConectar.IBDatabase1
    Transaction = dmConectar.IBTransaction1
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
        ...
        'SELECT distinct  0 SERIE,  0 NUMERO_FACT, 0  NUM_DOC, v.SERIE_eC' +
        'F_ASIGNADO SERIE_NCF_ASIGNADO, v.NUMERO NUMERO_TRN_ORIGEN, n.NUM' +
        'ERO_eCF numero_ncf_afectado, n.tipo_ncf, v.TIPONCFIFISCAL'
      'FROM VENTAS_MAST v, eCF_ASIGNADOS n'
      'Where v.NUMERO = v.NUMERO'
      'And v.SERIE_NCF_ASIGNADO = n.SERIE'
      'And v.NUMERO =:numerotrn')
    Left = 968
  ...
  object qryGeteCFAsignado: TIBQuery
    Database = dmConectar.IBDatabase1
    Transaction = dmConectar.IBTransaction1
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
        ...
        'SELECT r.NUMERO_FACT, r.NUM_DOC, r.SERIE_eCF_ASIGNADO SERIE_NCF_' +
        'ASIGNADO, r.NUMERO_TRN_ORIGEN, n.NUMERO_eCF numero_ncf_afectado,' +
        ' n.tipo_ncf, v.TIPONCFIFISCAL'
      'FROM TRANS_CXC_DET r, VENTAS_MAST v, eCF_ASIGNADOS n'
      'Where r.NUMERO_TRN_ORIGEN = v.NUMERO'
      'And n.SERIE = v.SERIE_eCF_ASIGNADO'
    ...
    object qryGeteCFAsignadoNUMERO_FACT: TIntegerField
      FieldName = 'NUMERO_FACT'
      Origin = 'TRANS_CXC_DET.NUMERO_FACT'
    end
    object qryGeteCFAsignadoNUM_DOC: TIntegerField
      FieldName = 'NUM_DOC'
      Origin = 'TRANS_CXC_DET.NUM_DOC'
      Required = True
    end
    object qryGeteCFAsignadoNUMERO_TRN_ORIGEN: TIntegerField
      FieldName = 'NUMERO_TRN_ORIGEN'
      Origin = 'TRANS_CXC_DET.NUMERO_TRN_ORIGEN'
    end
    object qryGeteCFAsignadoNUMERO_NCF_AFECTADO: TIBStringField
      FieldName = 'NUMERO_NCF_AFECTADO'
      Origin = 'ECF_ASIGNADOS.NUMERO_ECF'
      Required = True
      Size = 21
    end
    object qryGeteCFAsignadoTIPO_NCF: TIBStringField
      FieldName = 'TIPO_NCF'
      Origin = 'ECF_ASIGNADOS.TIPO_NCF'
      Required = True
      Size = 2
    end
    object qryGeteCFAsignadoTIPONCFIFISCAL: TIntegerField
      FieldName = 'TIPONCFIFISCAL'
      Origin = 'VENTAS_MAST.TIPONCFIFISCAL'
    end
    object qryGeteCFAsignadoSERIE_NCF_ASIGNADO: TIntegerField
      FieldName = 'SERIE_NCF_ASIGNADO'
      Origin = 'TRANS_CXC_DET.SERIE_ECF_ASIGNADO'
    end
  end
end
