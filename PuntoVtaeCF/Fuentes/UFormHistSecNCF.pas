...
uses
  ...
  Dialogs, StdCtrls, Buttons, RXCtrls, RXDBCtrl, rxToolEdit, Grids, DBGrids,
  DB, Mask, DBCtrls, RxLookup, WinSkinData, ExtCtrls;
...
begin
  ...
  begin
    dmFactura.tblQryHistoricoSecNCF.params[0].Value:=31;
    dmFactura.tblQryHistoricoSecNCF.params[1].Value:=50;
  end else
  begin
    dmFactura.tblQryHistoricoSecNCF.params[0].Value:=0;
    dmFactura.tblQryHistoricoSecNCF.params[1].Value:=30;
  end;
