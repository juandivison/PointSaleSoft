object frmConsultaReordenInvXProv: TfrmConsultaReordenInvXProv
  Left = 321
  Top = 162
  Width = 1138
  Height = 623
  Caption = 'Consultar Reorden Productos'
  Color = clBtnFace
  ...
  object edtCodProdTxt: TEdit
    Left = 72
    Top = 72
    Width = 121
    Height = 21
    TabOrder = 10
    OnChange = edtCodProdTxtChange
  end
  ...
  object RadioGroup2: TRadioGroup
    ...
    Width = 313
    Height = 37
    Caption = 'Productos solo con reorden'
    Columns = 3
    ItemIndex = 2
    Items.Strings = (
      'Si'
  ...
  object qryDatosConsulta: TIBQuery
    ...
    SQL.Strings = (
      'With Datos as ('
      'select '
      'i.CODIGO CODIGO_PROD, '
      'i.codigo_texto, i.codigo_barra,'
      'p.CODIGO_CTE CODIGO_PROV, '
      'P.DESCRIPCION DESC_PROVEEDOR, '
      'p.RNC_PROVEEDOR RNC_PROVEEDOR, '
      'i.descripcion, '
      'i.CANTIDAD,'
      'i.CANTIDAD_REORDEN,'
      'i.PRECIO_COMPRA precio_compra,'
      ...
      'LEFT OUTER JOIN UNIDADES U ON U.IDUNIDAD = I.TIPO_UNIDAD'
      
        'LEFT OUTER join PROVEEDORES p ON (P.CODIGO_CTE = I.CODFABRICANTE' +
        ') '
    ...
    object qryDatosConsultaCANTIDAD_REORDEN: TIntegerField
      FieldName = 'CANTIDAD_REORDEN'
    ...
    object qryDatosConsultaPRECIO_VENTA: TFloatField
      FieldName = 'PRECIO_VENTA'
    ...
    object qryDatosConsultaCIA_KEY: TIntegerField
      FieldName = 'CIA_KEY'
