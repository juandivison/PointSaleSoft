...
uses
  ...
  UFormTipoCliente in 'UFormTipoCliente.pas' {Form1},
  ...
  Uutilprocesaventadiaria in 'Uutilprocesaventadiaria.pas',
  uFormAsignareCFVenta in 'uFormAsignareCFVenta.pas' {frmAsignareCFVenta};
