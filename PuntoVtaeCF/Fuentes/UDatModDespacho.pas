...
type
  TdmDespacho = class(TDataModule)
    ...
    tblEditarDespachoMaster: TIBDataSet;
    dstblEditarDespachoMaster: TDataSource;
    tblEditarDespachoMasterNUMERO: TIntegerField;
    tblEditarDespachoMasterFECHA: TDateTimeField;
    tblEditarDespachoMasterTIPO_TRN: TSmallintField;
    tblEditarDespachoMasterCODIGO_DESPACHADOR: TIntegerField;
    tblEditarDespachoMasterCODIGO_EMP: TIntegerField;
    tblEditarDespachoMasterMONTO_TOTAL: TFloatField;
    tblEditarDespachoMasterNUM_ORDEN: TFloatField;
    tblEditarDespachoMasterSTATUS: TIBStringField;
    tblEditarDespachoMasterFECHA_IN: TDateTimeField;
    tblEditarDespachoMasterIN_POR: TIBStringField;
    tblEditarDespachoMasterFECHA_MOD: TDateTimeField;
    tblEditarDespachoMasterMOD_POR: TIBStringField;
    tblEditarDespachoMasterCODIGO_RUTA: TIntegerField;
    tblEditarDespachoMasterNUM_CONDUCE: TIntegerField;
    tblEditarDespachoMasterCODIGO_PROV: TIntegerField;
    tblEditarDespachoMasterNCF: TIBStringField;
    tblEditarDespachoMasterRNC_PROVEEDOR: TIBStringField;
    tblEditarDespachoMasterINVENTARIO_ID: TIntegerField;
    tblEditarDespachoMasterSERIE_INV_ID: TIntegerField;
    tblEditarDespachoMasterINV_ID_ORIGEN: TIntegerField;
    tblEditarDespachoMasterINV_ID_DESTINO: TIntegerField;
    tblDespachoMasterRepNCF: TIBStringField;
    tblDespachoMasterRepRNC_PROVEEDOR: TIBStringField;
    tblDespachoMasterRepINVENTARIO_ID: TIntegerField;
    tblDespachoMasterRepSERIE_INV_ID: TIntegerField;
    tblDespachoMasterRepINV_ID_ORIGEN: TIntegerField;
    tblDespachoMasterRepINV_ID_DESTINO: TIntegerField;
    tblDespachoMasterRepFORMA_PAGO: TSmallintField;
    tblDespachoMasterRepNUMERO_FACTURA: TIntegerField;
    tblDespachoMasterRepSTATUS_CNT: TIBStringField;
    QryRepDespachoDetCANT_UNIDADES: TFloatField;
    QryRepDespachoDetUNIDADID: TIntegerField;
    QryRepDespachoDetSTATUS_CNT: TIBStringField;
    QryRepDespachoDetVALORDESCUENTO: TCurrencyField;
    ...
    QryRepDespachoDetCANTOFERTA: TIntegerField;
    ...
    procedure tblEditarDespachoMasterFilterRecord(DataSet: TDataSet;
      var Accept: Boolean);
    procedure QryRepDespachoDetCalcFields(DataSet: TDataSet);
  private
  ...
  public
    ...
    filtrafecha : Boolean;
    filtracodProv : Boolean;
    filtrafpago   : Boolean;
    filtranumConduce : Boolean;
    filtranumOrden   : Boolean;
...
procedure TdmDespacho.tblEditarDespachoMasterFilterRecord(
...
begin
{
  ...
  if filtrafecha then
  begin
    Accept := (DataSet['fecha'] = fecha);
  end else
  if filtracodProv then
  begin
    Accept := (DataSet['codProv'] = fecha);
  end else
  if filtrafpago then
  begin
    Accept := (DataSet['fpago'] = fecha);
  end else
  if filtranumConduce then
  begin
    Accept := (DataSet['numConduce'] = fecha);
  end else
  if filtranumOrden then
  begin
    Accept := (DataSet['numOrden'] = fecha);
  end;  
end;

procedure TdmDespacho.QryRepDespachoDetCalcFields(DataSet: TDataSet);
begin
  QryRepDespachoDetVALORDESCUENTO.Value:=
  (QryRepDespachoDetPORC_DESC_DET.Value / 100) * QryRepDespachoDetVALOR_BRUTO.Value;
  //QryRepDespachoDetITBI_DET.Value
end;
