...
type
  TdmCxc = class(TDataModule)
    ...
    qryTrancxcCIA_KEY: TIntegerField;
    tblTransCxcCIA_KEY: TIntegerField;
    tblTransCxcNUMERO_RECIBO: TIntegerField;
    dsrxIngChequeDet: TDataSource;
    rxIngChequeDet: TRxMemoryData;
    rxIngChequeDetNumero_Recibo: TIntegerField;
    rxIngChequeDetNumero_Cheque: TIntegerField;
    rxIngChequeDetCodigo_Banco: TIntegerField;
    rxIngChequeDetMonto_Cheque: TCurrencyField;
    tblIngChequesDet: TIBDataSet;
    tblIngChequesDetSERIE: TIntegerField;
    tblIngChequesDetNUMERO_RECIBO: TIntegerField;
    tblIngChequesDetNUMERO_CHEQUE: TIntegerField;
    tblIngChequesDetCODIGO_BANCO: TIntegerField;
    tblIngChequesDetMONTO_CHEQUE: TFloatField;
    tblIngChequesDetCOD_USUARIO: TIntegerField;
    tblIngChequesDetFECHA_IN: TDateTimeField;
    tblIngChequesDetIN_POR: TIBStringField;
    tblIngChequesDetMOD_POR: TIBStringField;
    tblIngChequesDetFECHA_MOD: TDateTimeField;
    tblIngChequesDetSTATUS: TIBStringField;
    dsTblIngChequesDet: TDataSource;
    ...
    rxIngresoEnBonos: TRxMemoryData;
    dsrxIngresoEnBonos: TDataSource;
    rxIngresoEnBonosNumero: TStringField;
    rxIngresoEnBonosEmitidoPor: TIntegerField;
    rxIngresoEnBonosMonto: TCurrencyField;
    rxIngresoEnTarjeta: TRxMemoryData;
    rxIngresoEnTarjetaformaPago: TSmallintField;
    rxIngresoEnTarjetaNumeroDocumento: TStringField;
    rxIngresoEnTarjetaNumeroTarjeta: TStringField;
    rxIngresoEnTarjetaTipoTarjeta: TSmallintField;
    rxIngresoEnTarjetaProveedorTarjeta: TSmallintField;
    rxIngresoEnTarjetaNumeroAutorizacion: TStringField;
    rxIngresoEnTarjetaMes: TSmallintField;
    rxIngresoEnTarjetaAnio: TSmallintField;
    rxIngresoEnTarjetaMONTOAUTORIZADO: TCurrencyField;
    rxIngresoEnTarjetaMontoEnEfectivo: TCurrencyField;
    rxIngresoEnTarjetaMontoEnCheque: TCurrencyField;
    rxIngresoEnTarjetaMontoEnBonos: TCurrencyField;
    rxIngresoEnTarjetaDiferencia: TCurrencyField;
    ...
    qryCobrosConTarjetaCuadre: TIBQuery;
    qryCobrosConTarjetaCuadreMONTO: TFloatField;
    qryCobrosConTarjetaCuadreCODIGO_PROVEEDOR: TSmallintField;
    qryRepServSERIE: TIntegerField;
    ...
    qryRepTransCxcNDB_NCRNUM_NCF_AFECTADO: TIBStringField;
    qryTrancxcNUM_NCF_AFECTADO: TIBStringField;
    tblTransCxcNUM_NCF_AFECTADO: TIBStringField;
    transCxcNotaCreditoNUMERO_TRN_ORIGEN: TIntegerField;
    rxTranCntcod_concepto_cta: TIntegerField;
    rxTranCntrxCodigo_Prod: TStringField;
    qryCobrosConTarjetaCuadreG: TIBQuery;
    qryCobrosConTarjetaCuadreGMONTO: TFloatField;
    qryCobrosConTarjetaCuadreGCODIGO_PROVEEDOR: TSmallintField;
    qryCobrosConTarjetaCuadreGMONEDA: TIBStringField;
    qryRepTransCxcNDB_NCRNUMERO_TRN_ORIGEN: TIntegerField;
    qryIngPropinaLey: TIBSQL;
    ...
    qryTrancxcNUMPOL: TIntegerField;
    tblTransCxcNUMPOL: TIntegerField;
    qryPrepagos: TIBQuery;
    qryPrepagosMONTO: TFloatField;
    tblDetallePagosGLBNUMVTAPOS: TIntegerField;
    qryDatosblccxc: TIBQuery;
    qryDatosblccxcBALANCE: TFloatField;
    qryDatosblccxcBALANCEACT: TFloatField;
    qryDatosblccxcFECHA: TDateTimeField;
