unit URepRecibo8_5_11REspinalReimpFFood;
...
type
  TqckRepRecibo8_5_11REspReimpFFood = class(TQuickRep)
...
var
  qckRepRecibo8_5_11REspReimpFFood: TqckRepRecibo8_5_11REspReimpFFood;
...
procedure TqckRepRecibo8_5_11REspReimpFFood.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  qckRepRecibo8_5_11REspReimpFFood.AllDataSets.Add(dmCompania.tblCompania);
  qckRepRecibo8_5_11REspReimpFFood.AllDataSets.Add(frmProcVentaRapida.rxSolDatoscte);
end;

procedure TqckRepRecibo8_5_11REspReimpFFood.QRLabel19Print(sender: TObject;
  var Value: String);
begin
  Value:=VarNombreUsuario;
end;

procedure TqckRepRecibo8_5_11REspReimpFFood.QRLabel20Print(sender: TObject;
  var Value: String);
begin
...
procedure TqckRepRecibo8_5_11REspReimpFFood.QRBand4BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if (valorNCF = '') then
  begin
...
procedure TqckRepRecibo8_5_11REspReimpFFood.qrtipoVentaPrint(sender: TObject;
  var Value: String);
begin
...
procedure TqckRepRecibo8_5_11REspReimpFFood.PageFooterBand1BeforePrint(
...
procedure TqckRepRecibo8_5_11REspReimpFFood.QRExpr2Print(sender: TObject;
  var Value: String);
begin
  if Trim(Value) = '/' then
  value:='';
...
procedure TqckRepRecibo8_5_11REspReimpFFood.QRExpr3Print(sender: TObject;
  var Value: String);
begin
  if Trim(Value) = ',' then
  value:='';
...
procedure TqckRepRecibo8_5_11REspReimpFFood.QRExpr4Print(sender: TObject;
  var Value: String);
begin
...
procedure TqckRepRecibo8_5_11REspReimpFFood.QRLabel24Print(sender: TObject;
  var Value: String);
begin
  Value := GlbPiedePaginaFactura;
end;

procedure TqckRepRecibo8_5_11REspReimpFFood.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrLabel24.Caption:= GlbPiedePaginaFactura;
end;

procedure TqckRepRecibo8_5_11REspReimpFFood.TPagPrint(sender: TObject;
  var Value: String);
begin
  Value := ' de '+ IntToStr(glbTPag);
end;

procedure TqckRepRecibo8_5_11REspReimpFFood.QRSysData4Print(sender: TObject;
  var Value: String);
begin
  Value:= Value;
end;

procedure TqckRepRecibo8_5_11REspReimpFFood.QRSubDetail1AfterPrint(
...
procedure TqckRepRecibo8_5_11REspReimpFFood.QRDBText12Print(sender: TObject;
  var Value: String);
begin
...
procedure TqckRepRecibo8_5_11REspReimpFFood.QRDBText4Print(sender: TObject;
  var Value: String);
begin
  Value:='RNC-'+Value;
end;

procedure TqckRepRecibo8_5_11REspReimpFFood.QRDBText21Print(sender: TObject;
  var Value: String);
begin
...
procedure TqckRepRecibo8_5_11REspReimpFFood.QRDBText22Print(sender: TObject;
  var Value: String);
begin
