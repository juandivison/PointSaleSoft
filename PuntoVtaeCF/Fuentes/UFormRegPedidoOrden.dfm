object frmPedidosProveedores: TfrmPedidosProveedores
  Left = 225
  Top = 163
  Width = 1130
  Height = 598
  Caption = 'Registrar Pedidos/Orden Compra'
  Color = clBtnFace
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      ...
      object DBStatusLabel2: TDBStatusLabel
        ...
        Height = 13
        DatasetName = 'Master'
        DataSource = dstblDespachoMaster
        ShadowSize = 2
      end
      ...
      object Panel1: TPanel
        ...
        object DBText1: TDBText
          ...
          DataSource = dstblInventarioProd
        end
    ...
    object TabSheet3: TTabSheet
      ...
      object dtpkFechaIni: TDateTimePicker
        ...
        Width = 91
        Height = 21
        Date = 44180.435464305560000000
        Time = 44180.435464305560000000
        TabOrder = 3
      end
  ...
  object dstblDespachoMaster: TDataSource
    AutoEdit = False
    DataSet = dmVentas.tblDespachoMaster
    Left = 576
    Top = 271
  end
  object dstblDespachoDet: TDataSource
    DataSet = dmVentas.tblDespachoDet
    Left = 496
    Top = 280
  end
  ...
  object GetAnyDate1: TGetAnyDate
    Fecha = 41749.000000000000000000
    VFechaF = True
    EligeTipo = False
    TipoRes = 1
    UsaFechaCierre = True
  ...
  object dsTblFormaPago: TDataSource
    DataSet = dmVentas.TblFormaPago
    Left = 620
    Top = 336
  end
  object dstblInventarioProd: TDataSource
    DataSet = dmInventario.tblInventarioProd
    Left = 820
    Top = 352
  end
  object qryDatosConsulta: TIBQuery
    Database = dmConectar.IBDatabase1
    Transaction = dmConectar.IBTransaction1
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
        ...
        'select m.NUMERO numero_trn, d.SERIE serie_Trn, d.CODIGO_PROD, i.' +
        'codigo_texto, i.codigo_barra,'
      
        'm.CODIGO_PROV, P.DESCRIPCION DESC_PROVEEDOR, m.RNC_PROVEEDOR, m.' +
        'FECHA, m.INVENTARIO_ID, '
      'f.DESCRIPCION formadepago,m.FORMA_PAGO tipopago,'
      'm.NUMERO_FACTURA,'
      'm.NCF, m.MONTO_TOTAL,'
      
        'iif(d.TIPO_TRN = 1, '#39'ENTRADA'#39',  IIF(d.TIPO_TRN = 2, '#39'SALIDA'#39','#39#39')' +
        ') DESCTIPOTRN, D.TIPO_TRN,'
      'i.descripcion, '
      'u.DESCRIPCION desctipounidad,'
      
        'l.LOTE_NUM, iif(l.FECHA_VENCIMIENTO is null, i.FECHA_VENCIMIENTO' +
        ', l.FECHA_VENCIMIENTO) FECHA_venceprod,'
      'd.CANT_UNIDADES,'
      'd.cantidad,'
      'd.cantoferta cant_oferta,'
      
        'd.precio precio_compra, d.valor_bruto, d.valor_total_Det, d.itbi' +
        '_Det,'
      'd.STATUS_DET'
      'from INVENTARIO_PRODUCTO i'
      'inner join despacho d on d.codigo_prod = i.codigo'
      'INNER JOIN UNIDADES U ON U.IDUNIDAD = d.UNIDADID'
      'inner join DESPACHO_MASTER m on m.NUMERO = d.NUMERO'
      'inner join PROVEEDORES p ON P.CODIGO_CTE = M.CODIGO_PROV'
      
        'left outer join LOTE l on l.CODIGO_PROV = p.CODIGO_CTE and l.COD' +
        'IGO = d.CODIGO_PROD'
      'and l.FECHA = m.FECHA'
      'left outer join TIPO_PAGO f on f.CODIGO = m.FORMA_PAGO')
    OnFilterRecord = qryDatosConsultaFilterRecord
    Left = 196
    Top = 128
    object qryDatosConsultaNUMERO_TRN: TIntegerField
      FieldName = 'NUMERO_TRN'
      Origin = 'DESPACHO_MASTER.NUMERO'
      Required = True
    end
    object qryDatosConsultaSERIE_TRN: TIntegerField
      FieldName = 'SERIE_TRN'
      Origin = 'DESPACHO.SERIE'
      Required = True
    end
    object qryDatosConsultaCODIGO_PROD: TIntegerField
      FieldName = 'CODIGO_PROD'
      Origin = 'DESPACHO.CODIGO_PROD'
    end
    object qryDatosConsultaCODIGO_TEXTO: TIBStringField
      FieldName = 'CODIGO_TEXTO'
      Origin = 'INVENTARIO_PRODUCTO.CODIGO_TEXTO'
      Size = 40
    end
    object qryDatosConsultaCODIGO_BARRA: TIBStringField
      FieldName = 'CODIGO_BARRA'
      Origin = 'INVENTARIO_PRODUCTO.CODIGO_BARRA'
      Size = 40
    end
    object qryDatosConsultaCODIGO_PROV: TIntegerField
      FieldName = 'CODIGO_PROV'
      Origin = 'DESPACHO_MASTER.CODIGO_PROV'
    end
    object qryDatosConsultaDESC_PROVEEDOR: TIBStringField
      FieldName = 'DESC_PROVEEDOR'
      Origin = 'PROVEEDORES.DESCRIPCION'
      Size = 80
    end
    object qryDatosConsultaRNC_PROVEEDOR: TIBStringField
      FieldName = 'RNC_PROVEEDOR'
      Origin = 'DESPACHO_MASTER.RNC_PROVEEDOR'
      Size = 15
    end
    object qryDatosConsultaFECHA: TDateTimeField
      FieldName = 'FECHA'
      Origin = 'DESPACHO_MASTER.FECHA'
    end
    object qryDatosConsultaINVENTARIO_ID: TIntegerField
      FieldName = 'INVENTARIO_ID'
      Origin = 'DESPACHO_MASTER.INVENTARIO_ID'
    end
    object qryDatosConsultaFORMADEPAGO: TIBStringField
      FieldName = 'FORMADEPAGO'
      Origin = 'TIPO_PAGO.DESCRIPCION'
      FixedChar = True
      Size = 15
    end
    object qryDatosConsultaTIPOPAGO: TSmallintField
      FieldName = 'TIPOPAGO'
      Origin = 'DESPACHO_MASTER.FORMA_PAGO'
    end
    object qryDatosConsultaNUMERO_FACTURA: TIntegerField
      FieldName = 'NUMERO_FACTURA'
      Origin = 'DESPACHO_MASTER.NUMERO_FACTURA'
    end
    object qryDatosConsultaNCF: TIBStringField
      FieldName = 'NCF'
      Origin = 'DESPACHO_MASTER.NCF'
      Size = 21
    end
    object qryDatosConsultaMONTO_TOTAL: TFloatField
      FieldName = 'MONTO_TOTAL'
      Origin = 'DESPACHO_MASTER.MONTO_TOTAL'
    end
    object qryDatosConsultaDESCTIPOTRN: TIBStringField
      FieldName = 'DESCTIPOTRN'
      Required = True
      FixedChar = True
      Size = 7
    end
    object qryDatosConsultaTIPO_TRN: TSmallintField
      FieldName = 'TIPO_TRN'
      Origin = 'DESPACHO.TIPO_TRN'
    end
    object qryDatosConsultaDESCRIPCION: TIBStringField
      FieldName = 'DESCRIPCION'
      Origin = 'INVENTARIO_PRODUCTO.DESCRIPCION'
      Size = 80
    end
    object qryDatosConsultaDESCTIPOUNIDAD: TIBStringField
      FieldName = 'DESCTIPOUNIDAD'
      Origin = 'UNIDADES.DESCRIPCION'
      Size = 50
    end
    object qryDatosConsultaLOTE_NUM: TIBStringField
      FieldName = 'LOTE_NUM'
      Origin = 'LOTE.LOTE_NUM'
      Size = 25
    end
    object qryDatosConsultaFECHA_VENCEPROD: TDateTimeField
      FieldName = 'FECHA_VENCEPROD'
    end
    object qryDatosConsultaCANT_UNIDADES: TFloatField
      FieldName = 'CANT_UNIDADES'
      Origin = 'DESPACHO.CANT_UNIDADES'
    end
    object qryDatosConsultaCANTIDAD: TFloatField
      FieldName = 'CANTIDAD'
      Origin = 'DESPACHO.CANTIDAD'
    end
    object qryDatosConsultaCANT_OFERTA: TIntegerField
      FieldName = 'CANT_OFERTA'
      Origin = 'DESPACHO.CANTOFERTA'
    end
    object qryDatosConsultaPRECIO_COMPRA: TFloatField
      FieldName = 'PRECIO_COMPRA'
      Origin = 'DESPACHO.PRECIO'
    end
    object qryDatosConsultaVALOR_BRUTO: TFloatField
      FieldName = 'VALOR_BRUTO'
      Origin = 'DESPACHO.VALOR_BRUTO'
    end
    object qryDatosConsultaVALOR_TOTAL_DET: TFloatField
      FieldName = 'VALOR_TOTAL_DET'
      Origin = 'DESPACHO.VALOR_TOTAL_DET'
    end
    object qryDatosConsultaITBI_DET: TFloatField
      FieldName = 'ITBI_DET'
      Origin = 'DESPACHO.ITBI_DET'
    end
    object qryDatosConsultaSTATUS_DET: TIBStringField
      FieldName = 'STATUS_DET'
  ...
  object dsqryDatosConsulta: TDataSource
    DataSet = qryDatosConsulta
    Left = 104
    Top = 192
  end
  object qryDatosConsulta_Base: TIBQuery
    Database = dmConectar.IBDatabase1
    Transaction = dmConectar.IBTransaction1
    BufferChunks = 1000
    CachedUpdates = False
  ...
  object tblLote: TIBDataSet
    ...
    DeleteSQL.Strings = (
      ...
      '  LOTE_NUM = :OLD_LOTE_NUM and'
      '  CODIGO_PROV = :OLD_CODIGO_PROV and'
      '  FECHA = :OLD_FECHA')
    InsertSQL.Strings = (
      'insert into LOTE'
      
        '  (CODIGO, LOTE_NUM, CODIGO_PROV, FECHA, CANT_IN, CANT_OUT, FECH' +
        'A_VENCIMIENTO)'
      'values'
      
        '  (:CODIGO, :LOTE_NUM, :CODIGO_PROV, :FECHA, :CANT_IN, :CANT_OUT' +
        ', :FECHA_VENCIMIENTO)')
    RefreshSQL.Strings = (
      'Select '
      '  CODIGO,'
      ...
      'where'
      '  CODIGO = :CODIGO and'
      '  LOTE_NUM = :LOTE_NUM and'
      '  CODIGO_PROV = :CODIGO_PROV and'
      '  FECHA = :FECHA')
    SelectSQL.Strings = (
      'select *  from LOTE'
      'where fecha = :fecha')
    ...
    Left = 340
    Top = 360
    object tblLoteCODIGO: TIntegerField
      FieldName = 'CODIGO'
      Origin = 'LOTE.CODIGO'
      Required = True
    end
    object tblLoteLOTE_NUM: TIBStringField
      FieldName = 'LOTE_NUM'
      Origin = 'LOTE.LOTE_NUM'
      Required = True
      Size = 25
    end
    object tblLoteCODIGO_PROV: TIntegerField
      FieldName = 'CODIGO_PROV'
      Origin = 'LOTE.CODIGO_PROV'
      Required = True
    end
    object tblLoteFECHA: TDateTimeField
      FieldName = 'FECHA'
      Origin = 'LOTE.FECHA'
    end
    object tblLoteCANT_IN: TIntegerField
      FieldName = 'CANT_IN'
      Origin = 'LOTE.CANT_IN'
    end
    object tblLoteCANT_OUT: TIntegerField
      FieldName = 'CANT_OUT'
      Origin = 'LOTE.CANT_OUT'
    end
    object tblLoteFECHA_VENCIMIENTO: TDateTimeField
      FieldName = 'FECHA_VENCIMIENTO'
