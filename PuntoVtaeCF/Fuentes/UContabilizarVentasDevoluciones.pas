unit UContabilizarVentasDevoluciones;
...
type
  TfrmContabilizarVtasDevol = class(TfrmContabilizaDatos)
    Memo1: TMemo;
    DBGridTest: TDBGrid;
...
var
  frmContabilizarVtasDevol: TfrmContabilizarVtasDevol;
...
procedure TfrmContabilizarVtasDevol.FormCreate(Sender: TObject);
var 
 lfecha: TDatetime;
 lstatus: String;
begin
...
procedure TfrmContabilizarVtasDevol.btnDatosClick(Sender: TObject);
var
  lfecha :TDatetime;
  lstatus:String;
  nError:Boolean;
...
procedure TfrmContabilizarVtasDevol.PrepararDatos;
var
  campos : String;
  strcampokey : string;
  x, y : Integer;
...
procedure TfrmContabilizarVtasDevol.ProcDatos;
var
  xmonto  : Extended;
  fCampos : TField;
  NombreCampo : string;
begin
  GlbDescTipoCNT := 'Trans Devolución Ventas';
...
procedure TfrmContabilizarVtasDevol.HacerTotales;
begin
...
procedure TfrmContabilizarVtasDevol.btnProcesarClick(Sender: TObject);
var
  tempo : extended;
begin
  //inherited;
  ...
  frmPrepararDatosCnt.FTipoTRN      := 3; //Devolucion
...
procedure TfrmContabilizarVtasDevol.btnContabilizarClick(Sender: TObject);
begin
  inherited;
  //
  btnContabilizar.Enabled:=False;
...
function TfrmContabilizarVtasDevol.procPreparaCampootro(xnum : Integer):Boolean;
var
  campos : string;
begin
  Memo1.Clear;
...
procedure TfrmContabilizarVtasDevol.dtpkfechaExit(Sender: TObject);
begin
  inherited;
  //
end;
