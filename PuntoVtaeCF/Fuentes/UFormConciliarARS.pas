...
uses UDatModConectar, UGlobal, UDatModCompania, UFormRecordConciARS,
  ...
  URepReclamacionesARS, USeleccionarNCF, uFormAsignareCFVenta;
...
//Generar y Asignar Numero de Comprobante Fiscal
  ...
  begin              
    ...
    try
      ...
      GlbDescNCF := frmAsignareCFVenta.descNCF;
      frmAsignareCFVenta.IBDataSet1NUMERO_eCF.Value := frmAsignareCFVenta.ncfGenerado;//rxVentaNCF.Value;
      frmAsignareCFVenta.IBDataSet1MONTO.Value      := qryTotalFactMONTOCOBERTURA.Value; //StrToFloat(EditN1.Text);
