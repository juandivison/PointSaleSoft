...
type
  TfrmEdicionVenta = class(TForm)
    ...
    tblDatosVentaCIA_KEY: TIntegerField;
    ...
    tblDatosVentaMONTO_INICIAL: TFloatField;
    tblDatosVentaNOMBRE_CLIENTE_GENERAL: TIBStringField;
    tblDatosVentaMONTO_PAGADO: TFloatField;
    tblDatosVentaMONTO_CAMBIO: TFloatField;
    tblDatosVentaMONTO_TOTAL_ITBIS: TFloatField;
    tblDatosVentaMONTODESCGASTOSADMIN: TFloatField;
    tblDatosVentaMONTODESCITBISGASTOSADMIN: TFloatField;
    tblDatosVentaMONTODESCTRANSP: TFloatField;
    tblDatosVentaMONTODESCDIRTECNICA: TFloatField;
    tblDatosVentaMONTODESCITBISDIRTECNICA: TFloatField;
    tblDatosVentaMONTODESCIMPREVISTO: TFloatField;
    tblDatosVentaMONTODESCITBISIMPREVISTO: TFloatField;
    tblDatosVentaCOMENTARIO: TIBStringField;
    tblDatosVentaNOMBRECLIENTE: TIBStringField;
    tblDatosVentaCODIGO_CTE1: TIntegerField;
    ...
    tblDatosDetSERIE_PROD: TIBStringField;
    tblDatosDetSTATUS_CNT: TIBStringField;
    tblDatosDetTIPO_UNIDAD: TIntegerField;
    tblDatosDetITBIS_EXENTO: TSmallintField;
    tblDatosDetTIPO_VENTA: TSmallintField;
    tblDatosDetDESCRIPCIONPRODUCTO: TMemoField;
    tblDatosDetPRECIO_COMPRA: TFloatField;
    tblDatosDetMONEDA: TIBStringField;
    tblDatosDetMONTO_TASA: TFloatField;
    qryClientesCOD_VENDEDOR: TIntegerField;
    tblDatosDetCANT_CONDUCE: TFloatField;
    tblDatosDetPORC_DESC_ITEM: TFloatField;
    tblDatosDetMONTO_DESC_ITEM: TFloatField;
    tblDatosVentaPORCPROPINALEGAL: TFloatField;
    tblDatosVentaPROPINA: TFloatField;
    tblDatosVentaPROPINALEGAL: TFloatField;
