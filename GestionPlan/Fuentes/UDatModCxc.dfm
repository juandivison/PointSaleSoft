object dmCxc: TdmCxc
  ...
  object qryFactPendientes: TIBQuery
    ...
    SQL.Strings = (
      ...
      '       FACTURAS.FECHA, FACTURAS.DESCRIPCION'
    ...
    OnFilterRecord = qryFactPendientesFilterRecord
    Left = 272
    Top = 432
    ParamData = <
      item
    ...
    object qryFactPendientesTIPO: TIntegerField
      FieldName = 'TIPO'
      Origin = 'FACTURAS_PENDIENTES.TIPO'
      Required = True
    end
    object qryFactPendientesMONEDA: TIBStringField
      FieldName = 'MONEDA'
    ...
    object qryFactPendientesNUMERO_FACT: TIntegerField
      FieldName = 'NUMERO_FACT'
      Origin = 'FACTURAS_PENDIENTES.NUMERO_FACT'
      Required = True
    end
    object qryFactPendientesMONTO_PENDIENTE: TFloatField
      FieldName = 'MONTO_PENDIENTE'
      Origin = 'FACTURAS_PENDIENTES.MONTO_PENDIENTE'
    end
    object qryFactPendientesSTATUS: TIBStringField
      FieldName = 'STATUS'
      Origin = 'FACTURAS_PENDIENTES.STATUS'
      FixedChar = True
      Size = 1
    end
    object qryFactPendientesIN_POR: TIBStringField
      FieldName = 'IN_POR'
      Origin = 'FACTURAS_PENDIENTES.IN_POR'
      Size = 12
    end
    object qryFactPendientesFECHA_MOD: TDateTimeField
      FieldName = 'FECHA_MOD'
      Origin = 'FACTURAS_PENDIENTES.FECHA_MOD'
    end
    object qryFactPendientesMOD_POR: TIBStringField
      FieldName = 'MOD_POR'
      Origin = 'FACTURAS_PENDIENTES.MOD_POR'
      Size = 12
    end
    object qryFactPendientesNOMBRE_CTE: TIBStringField
      FieldName = 'NOMBRE_CTE'
      Origin = 'CLIENTES.NOMBRE_CTE'
      Size = 60
    end
    object qryFactPendientesNOMBRE_FACTURAR: TIBStringField
      FieldName = 'NOMBRE_FACTURAR'
      Origin = 'CLIENTES.NOMBRE_FACTURAR'
      Size = 40
    end
    object qryFactPendientesDIRECCION_CONT: TIBStringField
      FieldName = 'DIRECCION_CONT'
      Origin = 'CLIENTES.DIRECCION_CONT'
      Size = 60
    end
    object qryFactPendientesTELEF_CONTACTO: TIBStringField
      FieldName = 'TELEF_CONTACTO'
      Origin = 'CLIENTES.TELEF_CONTACTO'
      Size = 14
    end
    object qryFactPendientesCODIGO_CTE: TIntegerField
      FieldName = 'CODIGO_CTE'
      Origin = 'FACTURAS.CODIGO_CTE'
    end
    object qryFactPendientesFECHA: TDateTimeField
      FieldName = 'FECHA'
      Origin = 'FACTURAS.FECHA'
    end
    object qryFactPendientesDESCRIPCION: TIBStringField
      FieldName = 'DESCRIPCION'
