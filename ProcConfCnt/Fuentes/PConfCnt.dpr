...
uses
  ...
  UDatModReportes in 'UDatModReportes.pas' {dmReportes: TDataModule},
  ...
  UConfCtasFijasDistCnt in 'UConfCtasFijasDistCnt.pas' {frmConfCtasFicasDisCnt},
  UConfCtasDistCnt in 'UConfCtasDistCnt.pas' {frmConfCtasDisCnt},
  UConfCamposFijosCnt in 'UConfCamposFijosCnt.pas' {frmCamposFijosCnt},
  UGlobalCp in '..\..\..\Comun\UGlobalCp.pas',
  UControlAct in '..\..\..\Comun\UControlAct.pas' {frmControlSistema},
  UAyudaCuentasT in 'UAyudaCuentasT.pas' {frmAyudaCuentasT},
  UDatModCatalogo in 'UDatModCatalogo.pas' {dmCatalogo: TDataModule},
  UCatalogo in 'UCatalogo.pas' {frmCatalogo},
  UFormDistribucionEstatusCNT in 'UFormDistribucionEstatusCNT.pas' {frmConfEstatusCnt};
...
begin
  ...
  Application.Title := 'Configuracion ctas Cnt';
