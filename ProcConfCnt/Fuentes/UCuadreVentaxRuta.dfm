object frmCuadreXRuta: TfrmCuadreXRuta
  Left = 193
  Top = 109
  Width = 801
  Height = 587
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      ...
      object ScrollBox1: TScrollBox
        ...
        object RxSpeedButton1: TRxSpeedButton
          ...
          Alignment = taRightJustify
          DropDownMenu = PopupMenuCostosGastos
          Caption = 'Opciones'
          Glyph.Data = {
        ...
        object Panel1: TPanel
          ...
          object DBText1: TDBText
            ...
            DataSource = dsqrydatosempleados
            ParentColor = False
          end
          ...
          object BitBtn4: TBitBtn
            ...
            Width = 58
            Height = 33
            Hint = 'Cancelar edicion o eliminar record activo'
            Caption = 'Borrar'
            ParentShowHint = False
            ShowHint = True
            TabOrder = 7
        ...
        object BitBtn8: TBitBtn
          ...
          Width = 86
          Height = 25
          Hint = 'Guardar distribucion cuadre'
          Caption = 'Guardar Det'
          ParentShowHint = False
          ShowHint = True
          TabOrder = 2
        ...
        object DBGrid1: TDBGrid
          ...
          Columns = <
            ...
            item
              Expanded = False
              FieldName = 'Monto'
              Title.Caption = 'Monto a Entregar'
              Visible = True
            end>
        end
        ...
        object BitBtn9: TBitBtn
          ...
          Width = 61
          Height = 25
          Hint = 'Insertar distribucion dinero entregado'
          Caption = 'Insertar'
          ParentShowHint = False
          ShowHint = True
          TabOrder = 5
        ...
        object rxCalcular: TBitBtn
          Left = 224
          Top = 393
          Width = 18
          Height = 22
          TabOrder = 7
          OnClick = rxCalcularClick
          Glyph.Data = {
            76010000424D7601000000000000760000002800000020000000100000000100
            04000000000000010000120B0000120B00001000000000000000000000000000
            800000800000008080008000000080008000808000007F7F7F00BFBFBF000000
    ...
    object TabSheet2: TTabSheet
      ...
      object Label4: TLabel
        ...
        Alignment = taCenter
        AutoSize = False
        Caption = 'INVENTARIO ACTUAL RUTA'
        Color = 56797
        ParentColor = False
      end
    ...
    object TabSheet3: TTabSheet
      ...
      object BitBtn14: TBitBtn
        ...
        Width = 83
        Height = 25
        Caption = 'Cargar Salida'
        TabOrder = 2
        OnClick = BitBtn14Click
      end
      object edtNumRuta: TEditN
        Left = 456
        Top = 14
        Width = 49
        Height = 21
        ...
        EditPrecision = 0
        ValueInteger = 0
        ValueDate = 38736.000000000000000000
        ValueTime = 0.972607083333333500
        TimeSeconds = False
  ...
  object dsqrydatosempleados: TDataSource
    DataSet = dmCuadrexRuta.qryDatosEmpleado
    Left = 472
    Top = 256
  end
  object rxVentaxRuta: TRxMemoryData
    FieldDefs = <
      item
        Name = 'ruta'
        DataType = ftInteger
      ...
      item
        Name = 'codigo_prod_inv'
        DataType = ftInteger
      end>
    BeforePost = rxVentaxRutaBeforePost
    Left = 328
    Top = 256
    object rxVentaxRutaruta: TIntegerField
      FieldName = 'ruta'
    end
    object rxVentaxRutafecha: TDateTimeField
      FieldName = 'fecha'
    end
    object rxVentaxRutacodigo_emp: TIntegerField
      FieldName = 'codigo_emp'
    end
    object rxVentaxRutacodigo_prod: TIntegerField
      FieldName = 'codigo_prod'
    end
    object rxVentaxRutanombre_vendedor: TStringField
      FieldName = 'nombre_vendedor'
      Size = 40
    end
    object rxVentaxRutaCantSalida: TFloatField
      FieldName = 'CantSalida'
    end
    object rxVentaxRutaCantRegreso: TFloatField
      FieldName = 'CantRegreso'
    end
    object rxVentaxRutacantidad: TFloatField
      DisplayLabel = 'Cant.Venta'
      FieldName = 'cantidad'
    end
    object rxVentaxRutaprecio: TFloatField
      FieldName = 'precio'
      DisplayFormat = ',0.00'
    end
    object rxVentaxRutamonto: TFloatField
      FieldName = 'monto'
      DisplayFormat = ',0.00'
    end
    object rxVentaxRutadescuento: TFloatField
      FieldName = 'descuento'
    end
    object rxVentaxRutaitbi: TFloatField
      FieldName = 'itbi'
    end
    object rxVentaxRutaformaPago: TSmallintField
      FieldName = 'formaPago'
    end
    object rxVentaxRutaNumeroDoc: TStringField
      FieldName = 'NumeroDoc'
    end
    object rxVentaxRutaDescripcion: TStringField
      FieldName = 'Descripcion'
      Size = 30
    end
    object rxVentaxRutaValorTotal: TFloatField
      FieldName = 'ValorTotal'
    end
    object rxVentaxRutaCodigoCliente: TIntegerField
      FieldName = 'CodigoCliente'
    end
    object rxVentaxRutaOrigen: TSmallintField
      FieldName = 'Origen'
    end
    object rxVentaxRutarecarga: TFloatField
      DisplayLabel = 'Recarga'
      FieldName = 'recarga'
    end
    object rxVentaxRutacodigo_prod_inv: TIntegerField
      FieldName = 'codigo_prod_inv'
    end
  end
  object dsrxVentaxRuta: TDataSource
    DataSet = rxVentaxRuta
    Left = 472
    Top = 200
  end
  object dsqryBlcRuta: TDataSource
    DataSet = dmCuadrexRuta.qryBlcRuta
    Left = 88
    Top = 152
  end
  ...
  object rxVentaTotal: TRxMemoryData
    FieldDefs = <
      item
        Name = 'formaPago'
        DataType = ftSmallint
    ...
    Left = 608
    Top = 152
    object rxVentaTotalformaPago: TSmallintField
      FieldName = 'formaPago'
    end
    object rxVentaTotalorigen: TFloatField
      FieldName = 'origen'
    end
    object rxVentaTotalMonto: TFloatField
      FieldName = 'Monto'
      DisplayFormat = ',0.00'
    end
    object rxVentaTotalDescFPago: TStringField
      FieldName = 'DescFPago'
      Size = 15
    end
    object rxVentaTotalDebito: TFloatField
      FieldName = 'Debito'
    end
    object rxVentaTotalCredito: TFloatField
      FieldName = 'Credito'
    end
    object rxVentaTotalDiferencia: TFloatField
      FieldName = 'Diferencia'
      DisplayFormat = ',0.00'
    end
  end
  object dsrxVentatotal: TDataSource
    DataSet = rxVentaTotal
    Left = 607
    Top = 200
  end
  object dstblCuadreRuta: TDataSource
    DataSet = dmCuadrexRuta.tblCuadreruta
    Left = 200
    Top = 264
  end
  object MainMenu1: TMainMenu
    ...
    object Reporte1: TMenuItem
      Caption = 'Reporte'
      object ReImprimirCuadre1: TMenuItem
        Caption = 'Re-Imprimir Cuadre'
        OnClick = ReImprimirCuadre1Click
      end
      object CuadreVendedor1: TMenuItem
        Caption = 'Cuadre Vendedor'
        OnClick = CuadreVendedor1Click
      end
    end
  end
  ...
  object dsqryCargarDatosCuadreRuta: TDataSource
    DataSet = dmCuadrexRuta.qryCargarDatosCuadreRuta
    Left = 604
    Top = 256
  end
  ...
  object PopupMenuCostosGastos: TPopupMenu
    Left = 84
    Top = 264
    object CreditoNormal1: TMenuItem
      Caption = 'Credito Normal'
      OnClick = CreditoNormal1Click
    end
    object CostosGastos1: TMenuItem
      Caption = '&Costos/Gastos'
      OnClick = CostosGastos1Click
    end
    object Proveedores1: TMenuItem
      Caption = 'P&roveedores'
      OnClick = Proveedores1Click
    end
    object CentroCostos1: TMenuItem
      Caption = 'C&entro Costos'
    end
    object Productos1: TMenuItem
      Caption = 'Prod&uctos'
      OnClick = Productos1Click
    end
    object Prestamos1: TMenuItem
      Caption = 'Prestam&os'
      OnClick = Prestamos1Click
    end
  end
end
