...
begin
  QRLabel1.Caption := 
  'Desde ' + FormatDateTime('mmm-dd-yyyy',dmReportes.qryRelacionFacturas.Params[1].Value) +
  ' a ' + FormatDateTime('mmm-dd-yyyy',dmReportes.qryRelacionFacturas.Params[2].Value);
end;
