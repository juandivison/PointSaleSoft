...
begin
  ...
  begin
    ...
    Null, 'Abono a Factura',
    'A',  Null, Null, Date,null,null,null]);
  ...
  dmcxc.StpProcActBlceCteyTrncxcStatus.Params[5].Value:= ExtraerFecha(Date);
  ...
  //  end;
    ...
    dmIngresos.qryfctingresos.Params[0].Value:= ExtraerFecha(Date);//fecha
...
begin
  ...
  dmcxc.qrytrancxcfecha.Value          := ExtraerFecha(Date);
...
begin
  ...
  qckReciboAbonoCXC.xtipoVenta:= xtipoVenta;
