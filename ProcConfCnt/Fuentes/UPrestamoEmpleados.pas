...
uses
  ...
  RXDBCtrl, ComCtrls, Grids, DBGrids, DBCtrls, ToolEdit, Mask, Menus,
  ExtCtrls;
...
begin
  ...
  begin
    ...
    dmPrestamo.tblPrestamoFECHA.Value      := ExtraerFecha(Date);
...
begin
  ...
  begin
    ...
    dmPrestamo.tblPrestamo.Post;
    dmPrestamo.tblPrestamo.ApplyUpdates;
    if not dmPrestamo.tblPrestamo.Transaction.InTransaction then
    dmPrestamo.tblPrestamo.Transaction.StartTransaction;
    try
     dmPrestamo.tblPrestamo.Transaction.CommitRetaining;
    except
    dmPrestamo.tblPrestamo.Transaction.RollbackRetaining;
    end;
  end;
end;
