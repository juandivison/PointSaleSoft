object dmReportes: TdmReportes
  ...
  object qryResumenVentas: TIBQuery
    ...
    CachedUpdates = False
    SQL.Strings = (
      'SELECT FECHA, MONEDA, SUM(Valor_documento) venta '
  ...
  object qryDatosRepVentaDiaria: TIBQuery
    ...
    SQL.Strings = (
      'SELECT   *'
      'FROM Proc_datos_venta_diaria_c(:Fechaini, :Fechafin,:xciaActiva)'
      'Where moneda between :monedaini and :monedafin'
      'ORDER BY '
      'CODIGO_EMPLEADO, '
      'TIPO_DOCUMENTO, moneda,tipo_doc, tipo_tranf, FECHA, '
    ...
    object qryDatosRepVentaDiariaMONTO_DESC_ITEM: TFloatField
      FieldName = 'MONTO_DESC_ITEM'
      Origin = 'PROC_DATOS_VENTA_DIARIA.MONTO_DESC_ITEM'
    end
    object qryDatosRepVentaDiariaVALOR_VENTA_DET: TFloatField
      FieldName = 'VALOR_VENTA_DET'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.VALOR_VENTA_DET'
    end
    object qryDatosRepVentaDiariaMONTO_TOTAL_ITBIS: TFloatField
      FieldName = 'MONTO_TOTAL_ITBIS'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.MONTO_TOTAL_ITBIS'
    end
    object qryDatosRepVentaDiariaPROPINA: TFloatField
      FieldName = 'PROPINA'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.PROPINA'
    end
    object qryDatosRepVentaDiariaPROPINALEGAL: TFloatField
      FieldName = 'PROPINALEGAL'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.PROPINALEGAL'
    end
    object qryDatosRepVentaDiariaMONTOCOBERTURA: TFloatField
      FieldName = 'MONTOCOBERTURA'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.MONTOCOBERTURA'
    end
    object qryDatosRepVentaDiariaVENTAARS: TSmallintField
      FieldName = 'VENTAARS'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.VENTAARS'
    end
    object qryDatosRepVentaDiariaSERIE_VTA: TIntegerField
      FieldName = 'SERIE_VTA'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.SERIE_VTA'
    end
    object qryDatosRepVentaDiariaMONTO_PAGADO_DIST: TFloatField
      FieldName = 'MONTO_PAGADO_DIST'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.MONTO_PAGADO_DIST'
    end
  end
  object qryDatosRepVentaMesxDia: TIBQuery
    ...
    SQL.Strings = (
        ...
        'SELECT * FROM PROC_DATOS_VENTA_DIA_MES (:FECHAINI,:FECHAFIN,:cia' +
        'key)')
    Left = 128
    Top = 48
    ParamData = <
  ...
  object qryMargenBruto: TIBQuery
    ...
    SQL.Strings = (
      ...
      '  VENTAS_DET.PRECIO_COMPRA,'
      '  INVENTARIO_PRODUCTO.PRECIO,'
      
        '  SUM(VENTAS_DET.CANTIDAD)  * VENTAS_DET.PRECIO_COMPRA CostoNeto' +
        ','
      ...
      'And (INVENTARIO_PRODUCTO.cia_key=:ciakey)'
      'GROUP BY'
      '  INVENTARIO_PRODUCTO.CODIGO_TEXTO,'
      '  INVENTARIO_PRODUCTO.CODIGO,'
      '  VENTAS_DET.PRECIO_COMPRA,'
  ...
  object qryViewVentasMast: TIBQuery
    ...
    object qryViewVentasMastMONTOPREPAGADO: TFloatField
      FieldName = 'MONTOPREPAGADO'
      Origin = 'VIEW_VENTAS_MAST.MONTOPREPAGADO'
    end
    object qryViewVentasMastSHOWPRECIOCONITBIS: TSmallintField
      FieldName = 'SHOWPRECIOCONITBIS'
      Origin = 'VIEW_VENTAS_MAST.SHOWPRECIOCONITBIS'
    end
  end
  object qryViewVentasDet: TIBQuery
    ...
    object qryViewVentasDetPRECIOSINITBIS: TFloatField
      FieldKind = fkInternalCalc
      FieldName = 'PRECIOSINITBIS'
      Origin = 'VIEW_VENTAS_DET.PRECIOSINITBIS'
      ReadOnly = True
    end
    object qryViewVentasDetMONTOVENTASINITBIS: TFloatField
      FieldKind = fkInternalCalc
      FieldName = 'MONTOVENTASINITBIS'
      Origin = 'VIEW_VENTAS_DET.MONTOVENTASINITBIS'
      ReadOnly = True
    end
  ...
  object qryDatosRepVentaDiaria_0: TIBQuery
    ...
    SQL.Strings = (
      'SELECT   *'
      'FROM Proc_datos_venta_diaria(:Fechaini, :Fechafin,:xciaActiva)'
      'Where moneda between :monedaini and :monedafin'
  ...
  object qryDatosRepVentaDiariaRes: TIBQuery
    ...
    SQL.Strings = (
        ...
        'po_documento, r.Tipo_doc,'
      'sum(r.monto_venta) monto_venta, '
      'SUM(distinct r.DEBITO+r.CREDITO) valor_documento,'
      'sum(MONTO_DESC_ITEM) MONTO_DESC_ITEM,'
      
        'Sum(Distinct r.monto_recibido)  monto_recibido, Count(Distinct r' +
        '.numero_documento) cantVta'
      'FROM Proc_datos_venta_diaria(:Fechaini, :Fechafin,:ciakey) r'
    ...
    object qryDatosRepVentaDiariaResMONTO_VENTA: TFloatField
      FieldName = 'MONTO_VENTA'
    end
    ...
    object qryDatosRepVentaDiariaResMONTO_DESC_ITEM: TFloatField
      FieldName = 'MONTO_DESC_ITEM'
    end
  end
  ...
  object qryReporteOrdenesComp: TIBQuery
    ...
    SQL.Strings = (
      ...
      'coalesce(l.codigo,0) codigo_empleado,i.descripcion descProducto,'
      ...
      'inner join ORDEN_COMP_DET o on m.NUMERO = o.NUMERO'
        ...
        'left outer join INVENTARIO_PRODUCTO i on i.CODIGO = o.COD_SERV_P' +
        'ROD '
    ...
    object qryReporteOrdenesCompDESCPRODUCTO: TIBStringField
      FieldName = 'DESCPRODUCTO'
      Origin = 'INVENTARIO_PRODUCTO.DESCRIPCION'
      Size = 80
    end
    object qryReporteOrdenesCompFECHA_DEBERECIBIR: TDateTimeField
  ...
  object qryDatosVentaDet_Pendiente: TIBQuery
    Database = dmConectar.IBDatabase1
    Transaction = dmConectar.IBTransaction1
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      ...
      'u.NOMBRECOMPLETO nombre_vendedor,'
      'R.NUMERO_DOC_PAGO NUMERO_DOCUMENTO,'
      'R.NUMERO_FACTURA NUMERO_FACTURA,'
      'R.CODIGO_CTE CODIGO_CLIENTE,'
      'COALESCE(NOMBRE_FACTURAR, R.NOMBRE_CLIENTE_GENERAL),'
      'D.CODIGO_PROD CODIGO_PRODUCTO,'
      
        'COALESCE(D.DESCRIPCION, D.DESCRIPCIONPRODUCTO) DESCRIPCION_PRODU' +
        'CTO,'
      'IIF(D.STATUS_DET = '#39'C'#39',0, D.CANTIDAD) cantidad,'
      'D.PRECIO PRECIO_PRODUCTO,'
      'IIF(D.STATUS_DET = '#39'C'#39',0, D.MONTO_DESC_ITEM) MONTO_DESC_ITEM,'
      'IIF(D.STATUS_DET = '#39'C'#39',0, D.VALOR_SERVICIO_DET) VALOR_DOCUMENTO'
      'FROM VENTAS_MAST R'
      'INNER JOIN VENTAS_DET D ON D.NUMERO = R.NUMERO'
      'LEFT OUTER JOIN CLIENTES C ON C.CODIGO_CTE = R.CODIGO_CTE'
      'inner join MONEDA m on m.CODIGO = r.MONEDA'
      'inner join USUARIO u on u.CODIGO_EMPLEADO = r.COD_USR_CAJA'
      'WHERE    '
      '    --R.CIA_KEY =1 '
      '    R.CIA_KEY =:CIAKEY '
      '    AND D.STATUS_DET = '#39'A'#39' '
      '    AND R.FECHA BETWEEN :FECHAINI AND :FECHAFIN'
      '    --AND R.FECHA = '#39'03/10/2024'#39
      '    AND R.STATUS IN ('#39'C'#39', '#39'A'#39', '#39'R'#39', '#39'D'#39', '#39'P'#39');')
    Left = 16
    Top = 152
    ParamData = <
      item
  ...
  object qryDatosRepVentaDiariaSubDetail: TIBQuery
    Database = dmConectar.IBDatabase1
    Transaction = dmConectar.IBTransaction1
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      ...
      'Where moneda between :monedaini and :monedafin'
        ...
        'oc, tipo_tranf, FECHA, '
      'NUMERO_DOCUMENTO, CODIGO_CLIENTE')
    OnFilterRecord = qryDatosRepVentaDiariaSubDetailFilterRecord
    Left = 128
    Top = 88
    ParamData = <
      item
    ...
    object qryDatosRepVentaDiariaSubDetailMONEDA: TIBStringField
      FieldName = 'MONEDA'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.MONEDA'
      FixedChar = True
      Size = 1
    end
    object qryDatosRepVentaDiariaSubDetailDEBITO: TFloatField
      FieldName = 'DEBITO'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.DEBITO'
    end
    object qryDatosRepVentaDiariaSubDetailCREDITO: TFloatField
      FieldName = 'CREDITO'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.CREDITO'
    end
    object qryDatosRepVentaDiariaSubDetailTIPO_DOCUMENTO: TIBStringField
      FieldName = 'TIPO_DOCUMENTO'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.TIPO_DOCUMENTO'
      Size = 30
    end
    object qryDatosRepVentaDiariaSubDetailNUMERO_TRN: TIntegerField
      FieldName = 'NUMERO_TRN'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.NUMERO_TRN'
    end
    object qryDatosRepVentaDiariaSubDetailMONTO_INICIAL: TFloatField
      FieldName = 'MONTO_INICIAL'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.MONTO_INICIAL'
    end
    object qryDatosRepVentaDiariaSubDetailMONTO_RECIBIDO: TFloatField
      FieldName = 'MONTO_RECIBIDO'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.MONTO_RECIBIDO'
    end
    object qryDatosRepVentaDiariaSubDetailMONTO_TOTAL_ITBIS: TFloatField
      FieldName = 'MONTO_TOTAL_ITBIS'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.MONTO_TOTAL_ITBIS'
    end
    object qryDatosRepVentaDiariaSubDetailPROPINA: TFloatField
      FieldName = 'PROPINA'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.PROPINA'
    end
    object qryDatosRepVentaDiariaSubDetailPROPINALEGAL: TFloatField
      FieldName = 'PROPINALEGAL'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.PROPINALEGAL'
    end
    object qryDatosRepVentaDiariaSubDetailMONTOCOBERTURA: TFloatField
      FieldName = 'MONTOCOBERTURA'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.MONTOCOBERTURA'
    end
    object qryDatosRepVentaDiariaSubDetailNUM_TRANSFERENCIA: TIntegerField
      FieldName = 'NUM_TRANSFERENCIA'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.NUM_TRANSFERENCIA'
    end
    object qryDatosRepVentaDiariaSubDetailMONTO_PAGADO_DIST: TFloatField
      FieldName = 'MONTO_PAGADO_DIST'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.MONTO_PAGADO_DIST'
    end
  end
  object qryDatosRepVentaDiariaNew: TIBQuery
    Database = dmConectar.IBDatabase1
    Transaction = dmConectar.IBTransaction1
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'SELECT   p.*'
        ...
        'FROM Proc_datos_venta_diaria_n(:Fechaini, :Fechafin,:xciaActiva)' +
        ' p'
      'Where moneda between :monedaini and :monedafin'
      'ORDER BY '
      'p.MONEDA, '
      ...
      'p.FECHA, '
      'p.CODIGO_CLIENTE')
    OnFilterRecord = qryDatosRepVentaDiariaNewFilterRecord
    Left = 111
    Top = 217
    ParamData = <
      item
    ...
    object qryDatosRepVentaDiariaNewTEMP: TIBStringField
      FieldName = 'TEMP'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.TEMP'
      Size = 150
    end
    object qryDatosRepVentaDiariaNewXSMS: TIBStringField
      FieldName = 'XSMS'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.XSMS'
      Size = 200
    end
    object qryDatosRepVentaDiariaNewCODIGO_CLIENTE: TIntegerField
      FieldName = 'CODIGO_CLIENTE'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.CODIGO_CLIENTE'
    end
    object qryDatosRepVentaDiariaNewNOMBRE_FACTURAR: TIBStringField
      FieldName = 'NOMBRE_FACTURAR'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.NOMBRE_FACTURAR'
      Size = 80
    end
    object qryDatosRepVentaDiariaNewNUMERO_DOCUMENTO: TIntegerField
      FieldName = 'NUMERO_DOCUMENTO'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.NUMERO_DOCUMENTO'
    end
    object qryDatosRepVentaDiariaNewVALOR_DOCUMENTO: TFloatField
      FieldName = 'VALOR_DOCUMENTO'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.VALOR_DOCUMENTO'
    end
    object qryDatosRepVentaDiariaNewVALOR_VENTA_DET: TFloatField
      FieldName = 'VALOR_VENTA_DET'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.VALOR_VENTA_DET'
    end
    object qryDatosRepVentaDiariaNewTIPO_TRANF: TSmallintField
      FieldName = 'TIPO_TRANF'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.TIPO_TRANF'
    end
    object qryDatosRepVentaDiariaNewMONEDA: TIBStringField
      FieldName = 'MONEDA'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.MONEDA'
      FixedChar = True
      Size = 1
    end
    object qryDatosRepVentaDiariaNewFECHA: TDateTimeField
      FieldName = 'FECHA'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.FECHA'
    end
    object qryDatosRepVentaDiariaNewTIPO_DOC: TIntegerField
      FieldName = 'TIPO_DOC'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.TIPO_DOC'
    end
    object qryDatosRepVentaDiariaNewSTATUS: TIBStringField
      FieldName = 'STATUS'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.STATUS'
      FixedChar = True
      Size = 1
    end
    object qryDatosRepVentaDiariaNewDEBITO: TFloatField
      FieldName = 'DEBITO'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.DEBITO'
    end
    object qryDatosRepVentaDiariaNewCREDITO: TFloatField
      FieldName = 'CREDITO'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.CREDITO'
    end
    object qryDatosRepVentaDiariaNewTIPO_DOCUMENTO: TIBStringField
      FieldName = 'TIPO_DOCUMENTO'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.TIPO_DOCUMENTO'
      Size = 30
    end
    object qryDatosRepVentaDiariaNewNOMBRE_VENDEDOR: TIBStringField
      FieldName = 'NOMBRE_VENDEDOR'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.NOMBRE_VENDEDOR'
      Size = 35
    end
    object qryDatosRepVentaDiariaNewCODIGO_EMPLEADO: TIntegerField
      FieldName = 'CODIGO_EMPLEADO'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.CODIGO_EMPLEADO'
    end
    object qryDatosRepVentaDiariaNewCODIGO_PRODUCTO: TIBStringField
      FieldName = 'CODIGO_PRODUCTO'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.CODIGO_PRODUCTO'
      Size = 40
    end
    object qryDatosRepVentaDiariaNewPRECIO_PRODUCTO: TIntegerField
      FieldName = 'PRECIO_PRODUCTO'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.PRECIO_PRODUCTO'
    end
    object qryDatosRepVentaDiariaNewDESCUENTO: TFloatField
      FieldName = 'DESCUENTO'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.DESCUENTO'
    end
    object qryDatosRepVentaDiariaNewMONTO_DESC_ITEM: TFloatField
      FieldName = 'MONTO_DESC_ITEM'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.MONTO_DESC_ITEM'
    end
    object qryDatosRepVentaDiariaNewDESCRIPCION_PRODUCTO: TIBStringField
      FieldName = 'DESCRIPCION_PRODUCTO'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.DESCRIPCION_PRODUCTO'
      Size = 80
    end
    object qryDatosRepVentaDiariaNewCANTIDAD: TFloatField
      FieldName = 'CANTIDAD'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.CANTIDAD'
    end
    object qryDatosRepVentaDiariaNewDESC_PRODUCTO: TIBStringField
      FieldName = 'DESC_PRODUCTO'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.DESC_PRODUCTO'
      Size = 80
    end
    object qryDatosRepVentaDiariaNewDESC_TIPO_INVENTARIO: TIBStringField
      FieldName = 'DESC_TIPO_INVENTARIO'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.DESC_TIPO_INVENTARIO'
      Size = 30
    end
    object qryDatosRepVentaDiariaNewXTIPO_INVENTARIO: TIntegerField
      FieldName = 'XTIPO_INVENTARIO'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.XTIPO_INVENTARIO'
    end
    object qryDatosRepVentaDiariaNewSTATUS_DET: TIBStringField
      FieldName = 'STATUS_DET'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.STATUS_DET'
      FixedChar = True
      Size = 1
    end
    object qryDatosRepVentaDiariaNewNUMERO_TRN: TIntegerField
      FieldName = 'NUMERO_TRN'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.NUMERO_TRN'
    end
    object qryDatosRepVentaDiariaNewMONTO_INICIAL: TFloatField
      FieldName = 'MONTO_INICIAL'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.MONTO_INICIAL'
    end
    object qryDatosRepVentaDiariaNewNUMERO_FACTURA: TIntegerField
      FieldName = 'NUMERO_FACTURA'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.NUMERO_FACTURA'
    end
    object qryDatosRepVentaDiariaNewMONTO_RECIBIDO: TFloatField
      FieldName = 'MONTO_RECIBIDO'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.MONTO_RECIBIDO'
    end
    object qryDatosRepVentaDiariaNewMONTO_TOTAL_ITBIS: TFloatField
      FieldName = 'MONTO_TOTAL_ITBIS'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.MONTO_TOTAL_ITBIS'
    end
    object qryDatosRepVentaDiariaNewPROPINA: TFloatField
      FieldName = 'PROPINA'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.PROPINA'
    end
    object qryDatosRepVentaDiariaNewPROPINALEGAL: TFloatField
      FieldName = 'PROPINALEGAL'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.PROPINALEGAL'
    end
    object qryDatosRepVentaDiariaNewMONTOCOBERTURA: TFloatField
      FieldName = 'MONTOCOBERTURA'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.MONTOCOBERTURA'
    end
    object qryDatosRepVentaDiariaNewVENTAARS: TSmallintField
      FieldName = 'VENTAARS'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.VENTAARS'
    end
    object qryDatosRepVentaDiariaNewESCXC: TSmallintField
      FieldName = 'ESCXC'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.ESCXC'
    end
    object qryDatosRepVentaDiariaNewSERIE_VTA: TIntegerField
      FieldName = 'SERIE_VTA'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.SERIE_VTA'
    end
    object qryDatosRepVentaDiariaNewNUM_TRANSFERENCIA: TIntegerField
      FieldName = 'NUM_TRANSFERENCIA'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.NUM_TRANSFERENCIA'
    end
    object qryDatosRepVentaDiariaNewMONTO_PAGADO_DIST: TFloatField
      FieldName = 'MONTO_PAGADO_DIST'
      Origin = 'PROC_DATOS_VENTA_DIARIA_C.MONTO_PAGADO_DIST'
    end
  end
  object qryFPagoTicketV2: TIBQuery
    Database = dmConectar.IBDatabase1
    Transaction = dmConectar.IBTransaction1
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      ...
      'order by r.numero')
    OnFilterRecord = qryFPagoTicketV2FilterRecord
    Left = 96
    Top = 432
    ParamData = <
      item
    ...
    object qryFPagoTicketV2TIPO_PAGO: TSmallintField
      FieldName = 'TIPO_PAGO'
      Origin = 'DETALLE_PAGOS.TIPO_PAGO'
    end
    object qryFPagoTicketV2MONTO_PAGADO: TFloatField
      FieldName = 'MONTO_PAGADO'
      Origin = 'VENTAS_MAST.MONTO_PAGADO'
    end
    object qryFPagoTicketV2MONTO_CAMBIO: TFloatField
      FieldName = 'MONTO_CAMBIO'
      Origin = 'VENTAS_MAST.MONTO_CAMBIO'
    end
    object qryFPagoTicketV2MONTOPAGADODET: TFloatField
      FieldName = 'MONTOPAGADODET'
      Origin = 'DETALLE_PAGOS.MONTO_PAGADO'
    end
    object qryFPagoTicketV2NUMERO: TIntegerField
      FieldName = 'NUMERO'
      Origin = 'VENTAS_MAST.NUMERO'
      Required = True
    end
    object qryFPagoTicketV2FPAGO: TSmallintField
      FieldName = 'FPAGO'
      Origin = 'TIPO_PAGO_DGII.FPAGO'
    end
    object qryFPagoTicketV2FPAGODGII: TSmallintField
      FieldName = 'FPAGODGII'
      Origin = 'TIPO_PAGO_DGII.FPAGODGII'
    end
    object qryFPagoTicketV2FORMA_PAGO: TSmallintField
      FieldName = 'FORMA_PAGO'
      Origin = 'VENTAS_MAST.FORMA_PAGO'
    end
    object qryFPagoTicketV2DESCRIPCION: TIBStringField
      FieldName = 'DESCRIPCION'
      Origin = 'TIPO_PAGO.DESCRIPCION'
      FixedChar = True
      Size = 15
    end
    object qryFPagoTicketV2DESCRIPCIONDGII: TIBStringField
      FieldName = 'DESCRIPCIONDGII'
      Origin = 'TIPO_PAGO_DGII.DESCRIPCIONDGII'
      Size = 40
    end
  end
  object QryRepVtaMaster: TIBQuery
    Database = dmConectar.IBDatabase1
    Transaction = dmConectar.IBTransaction1
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'SELECT  r.NUMERO_TRN, '
      'sum(r.VALOR_DOCUMENTO), Count(r.NUMERO_TRN) cantFPago'
      'FROM Proc_datos_venta_diaria(:FECHAINI, :FECHAFIN,:XCIAACTIVA) r'
      'Left Join usuario u on r.CODIGO_EMPLEADO = u.CODIGO_EMPLEADO'
      'Where moneda Between :monedaini And :monedafin'
      'Group By  r.NUMERO_TRN'
      'Order By  r.NUMERO_TRN')
    Left = 312
    Top = 528
    ParamData = <
      item
    ...
    object QryRepVtaMasterNUMERO_TRN: TIntegerField
      FieldName = 'NUMERO_TRN'
      Origin = 'PROC_DATOS_VENTA_DIARIA.NUMERO_TRN'
    end
    object QryRepVtaMasterSUM: TFloatField
      FieldName = 'SUM'
    end
    object QryRepVtaMasterCANTFPAGO: TIntegerField
      FieldName = 'CANTFPAGO'
      Required = True
    end
  end
  object qryMargenBrutoDet: TIBQuery
    Database = dmConectar.IBDatabase1
    Transaction = dmConectar.IBTransaction1
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      ...
      '  VENTAS_MAST.FECHA,'
      '  VENTAS_DET.FECHA_IN,'
      '  VENTAS_MAST.COD_USR_CAJA,'
      '  USUARIO.NOMBRECOMPLETO AS NOMBREUSER,'
      '  TIPO_INVENTARIO.DESCRIPCION AS DESCTIPOINV,'
      '  INVENTARIO_PRODUCTO.CODIGO_TEXTO,'
      '  INVENTARIO_PRODUCTO.CODIGO,'
      '  IIF(VENTAS_MAST.FORMA_PAGO = '#39'6'#39','#39'Devolucion'#39','
      '      IIF(VENTAS_MAST.FORMA_PAGO = '#39'20'#39','#39'Transferencia'#39','
      '      IIF(VENTAS_MAST.FORMA_PAGO = '#39'1'#39','#39'Efectivo'#39','
      '      IIF(VENTAS_MAST.FORMA_PAGO = '#39'2'#39','#39'Tarjeta'#39','
      
        '      IIF(VENTAS_MAST.FORMA_PAGO IN ('#39'7'#39','#39'8'#39'),'#39'Venta a Credito'#39',' +
        #39'Otro'#39'))))) AS FPago,'
      '  VENTAS_MAST.NUMERO_DOC_PAGO,'
      '  VENTAS_MAST.NUMERO_FACTURA,'
      '  INVENTARIO_PRODUCTO.TIPO,'
      ...
      '  VENTAS_DET.PRECIO,'
      ''
      '  -- Venta neta (seg'#250'n transp_itbis)'
      '  IIF('
      '    (SELECT FIRST 1 transp_itbis FROM registro) = 1,'
      
        '    SUM(VENTAS_DET.VALOR_TOTAL_DET - VENTAS_DET.ITBIS_FISCAL_DET' +
        '),'
      '    SUM(VENTAS_DET.VALOR_TOTAL_DET)'
      '  ) AS MONTO_VENTA_NETO,'
      ''
      '-- ITBIS (si quieres mostrarlo)'
      '  SUM(VENTAS_DET.ITBIS_FISCAL_DET) AS ITBIS_VENTA,'
      '  SUM(VENTAS_DET.ITBI_DET) AS ITBIS_COSTO,'
      '  '
      '  -- Costo neto (seg'#250'n transp_itbis)'
      '  IIF('
      '    (SELECT FIRST 1 transp_itbis FROM registro) = 1,'
      
        '    SUM((VENTAS_DET.PRECIO_COMPRA * VENTAS_DET.CANTIDAD) - VENTA' +
        'S_DET.ITBI_DET),'
      '    SUM(VENTAS_DET.PRECIO_COMPRA * VENTAS_DET.CANTIDAD)'
      '  ) AS COSTO_NETO,'
      ''
      '  -- Beneficio'
      '  IIF('
      '    (SELECT FIRST 1 transp_itbis FROM registro) = 1,'
        ...
        '    SUM(VENTAS_DET.VALOR_TOTAL_DET) - SUM(VENTAS_DET.PRECIO_COMP' +
        'RA * VENTAS_DET.CANTIDAD)'
      '  ) AS BENEFICIO  '
      ''
      'FROM'
      '  VENTAS_MAST'
      
        '  INNER JOIN VENTAS_DET ON VENTAS_MAST.NUMERO = VENTAS_DET.NUMER' +
        'O'
      
        '  LEFT OUTER JOIN INVENTARIO_PRODUCTO ON VENTAS_DET.CODIGO_PROD ' +
        '= INVENTARIO_PRODUCTO.CODIGO'
      
        '  LEFT OUTER JOIN TIPO_INVENTARIO ON INVENTARIO_PRODUCTO.TIPO = ' +
        'TIPO_INVENTARIO.CODIGO'
      
        '  LEFT OUTER JOIN USUARIO ON VENTAS_MAST.COD_USR_CAJA = USUARIO.' +
        'CODIGO_EMPLEADO'
      'WHERE'
      '  VENTAS_MAST.FECHA BETWEEN :FECHAINI AND :FECHAFIN'
      '  AND INVENTARIO_PRODUCTO.cia_key = :ciakey'
      '  AND  VENTAS_MAST.STATUS in ('#39'A'#39','#39'R'#39')'
      'GROUP BY'
      '  VENTAS_MAST.NUMERO,'
      '  VENTAS_DET.SERIE,'
      '  VENTAS_MAST.FECHA,'
      ...
      'ORDER BY'
        ...
        '  VENTAS_MAST.FECHA, VENTAS_DET.FECHA_IN, INVENTARIO_PRODUCTO.TI' +
        'PO, INVENTARIO_PRODUCTO.DESCRIPCION;')
    OnFilterRecord = qryMargenBrutoFilterRecord
    Left = 463
    Top = 54
    ParamData = <
