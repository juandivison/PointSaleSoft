unit UQckFactServIngeservis8_5_N;
...
type
  TqckFactServIngeservis_N = class(TQuickRep)
...
var
  qckFactServIngeservis_N: TqckFactServIngeservis_N;
...
procedure TqckFactServIngeservis_N.QuickRepBeforePrint(
  Sender: TCustomQuickRep; var PrintReport: Boolean);
begin
  qckFactServIngeservis_N.AllDataSets.Add(dmCompania.tblCompania);
...
procedure TqckFactServIngeservis_N.QRLabel23Print(sender: TObject;
  var Value: String);
begin
  Value:=GlbBuscarCodigoVendedor(glbcodVendedor);
end;

procedure TqckFactServIngeservis_N.QRLabel24Print(sender: TObject;
  var Value: String);
begin
  Value:=Value + ' '+dmfactura.qryPorcApplicadoenFactServPorcGAdmin.AsString+'%';
end;

procedure TqckFactServIngeservis_N.QRLabel25Print(sender: TObject;
  var Value: String);
begin
  Value:=Value + ' '+dmfactura.qryPorcApplicadoenFactServPorcItbisGAdmin.AsString+'%';
end;

procedure TqckFactServIngeservis_N.QRLabel26Print(sender: TObject;
  var Value: String);
begin
  Value:=Value + ' '+dmfactura.qryPorcApplicadoenFactServPorcTrans.AsString+'%';
end;

procedure TqckFactServIngeservis_N.QRLabel27Print(sender: TObject;
  var Value: String);
begin
  Value:=Value + ' '+dmfactura.qryPorcApplicadoenFactServPorcDirTec.AsString+'%';
end;

procedure TqckFactServIngeservis_N.QRLabel28Print(sender: TObject;
  var Value: String);
begin
  Value:=Value + ' '+dmfactura.qryPorcApplicadoenFactServPorcItbisDirTec.AsString+'%';
end;

procedure TqckFactServIngeservis_N.QRLabel29Print(sender: TObject;
  var Value: String);
begin
  if (dmFactura.qryVentaFacturaMONTODESCIMPREVISTO.Value > 0) then
  Value:=Value + ' '+dmfactura.qryPorcApplicadoenFactServPORCIMPREVISTO.AsString+'%'
  else Value:='';
end;

procedure TqckFactServIngeservis_N.QRLabel30Print(sender: TObject;
  var Value: String);
begin
  if (dmFactura.qryVentaFacturaMontoDescItbisImprevisto.Value > 0) then
  Value:=Value + ' '+dmfactura.qryPorcApplicadoenFactServPorcItbisImprevisto.AsString+'%'
  else Value:='';
end;

procedure TqckFactServIngeservis_N.DetailBand1BeforePrint(
...
procedure TqckFactServIngeservis_N.QRDBText21Print(sender: TObject;
  var Value: String);
begin
...
procedure TqckFactServIngeservis_N.QRDBText22Print(sender: TObject;
  var Value: String);
begin
  if (Value <> '') then
  Value:='NCF: '+Value;
...
procedure TqckFactServIngeservis_N.ChildBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  TPag.Caption:= IntToStr(qckFactServIngeservis_N.PageNumber);
end;

procedure TqckFactServIngeservis_N.QRSysData3Print(sender: TObject;
  var Value: String);
begin
  Value:=Value +' de ';
end;

procedure TqckFactServIngeservis_N.ColumnHeaderBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
  var
    _xImagen : String;
begin
...
procedure TqckFactServIngeservis_N.QRDBText14Print(sender: TObject;
  var Value: String);
begin
  if (Value ='0.00') then Value:='';
end;

procedure TqckFactServIngeservis_N.QRDBText13Print(sender: TObject;
  var Value: String);
begin
  if (Value = '0.00') then Value:='';
end;

procedure TqckFactServIngeservis_N.QRDBText9Print(sender: TObject;
  var Value: String);
begin
