...
type
  TqckCotServ8_5Limao = class(TQuickRep)
...
var
  qckCotServ8_5Limao: TqckCotServ8_5Limao;
...
procedure TqckCotServ8_5Limao.QuickRepBeforePrint(
...
begin
  ...
  qckCotServ8_5Limao.AllDataSets.Add(dmCompania.tblCompania);
  qckCotServ8_5Limao.AllDataSets.Add(dmDatos.qryMembrete);
end;

procedure TqckCotServ8_5Limao.QRLabel23Print(sender: TObject;
  var Value: String);
begin
...
procedure TqckCotServ8_5Limao.DetailBand1BeforePrint(
...
procedure TqckCotServ8_5Limao.QRDBText22Print(sender: TObject;
  var Value: String);
begin
  if (Value <> '') then
  Value:='NCF: '+Value;
...
procedure TqckCotServ8_5Limao.ChildBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  TPag.Caption:= IntToStr(qckCotServ8_5Limao.PageNumber);
end;

procedure TqckCotServ8_5Limao.QRSysData3Print(sender: TObject;
  var Value: String);
begin
  Value:=Value +' de ';
end;

procedure TqckCotServ8_5Limao.ColumnHeaderBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
  var
    _xImagen : String;
begin
...
procedure TqckCotServ8_5Limao.QRDBText9Print(sender: TObject;
  var Value: String);
begin
...
procedure TqckCotServ8_5Limao.QRLabel25Print(sender: TObject;
  var Value: String);
begin
...
procedure TqckCotServ8_5Limao.QRSubDetail1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
  var
  valor : string;
begin
