object dmTransCnt: TdmTransCnt
  ...
  object tblDepositoMaster: TIBDataSet
    ...
    InsertSQL.Strings = (
      'insert into DEPOSITOS_MASTER'
        ...
        '  (NUMERO, CIA_KEY, FECHA, ID_BANCO, TIPO_CTA, CUENTA_BANCO, MON' +
        'TO, DESCRIPCION, '
      '   STATUS, COD_USUARIO, FECHA_IN, IN_POR, FECHA_UPDATE)'
      'values'
      
        '  (:NUMERO, :CIA_KEY, :FECHA, :ID_BANCO, :TIPO_CTA, :CUENTA_BANC' +
        'O, :MONTO, '
      
        '   :DESCRIPCION, :STATUS, :COD_USUARIO, :FECHA_IN, :IN_POR, :FEC' +
        'HA_UPDATE)')
    RefreshSQL.Strings = (
      'Select '
      '  NUMERO,'
    ...
    object tblDepositoMasterCIA_KEY: TIntegerField
      FieldName = 'CIA_KEY'
      Origin = 'DEPOSITOS_MASTER.CIA_KEY'
    end
  end
  object tblDepositoDet: TIBDataSet
    ...
    object tblDepositoDetMONTO_DEPOSITO: TFloatField
  ...
  object tblDistCashEnCaja: TIBDataSet
    Database = dmConectar.IBDatabase1
    Transaction = dmConectar.IBTransaction1
    BufferChunks = 1000
    CachedUpdates = True
    DeleteSQL.Strings = (
      'delete from DIST_CASHCUADRECAJA'
      'where'
      '  COD_EMPLEADO = :OLD_COD_EMPLEADO and'
      '  FECHA = :OLD_FECHA')
    InsertSQL.Strings = (
      'insert into DIST_CASHCUADRECAJA'
      
        '  (ID, COD_EMPLEADO, FECHA, MONTO_EN_CHEQUE, M2000, M1000, M500,' +
        ' M200, '
      
        '   M100, M50, M25, M20, M10, M5, MONTO_MONEDAS, COD_USUARIO, STA' +
        'TUS, FECHA_IN, '
      '   FECHA_UPDATE)'
      'values'
      
        '  (:ID, :COD_EMPLEADO, :FECHA, :MONTO_EN_CHEQUE, :M2000, :M1000,' +
        ' :M500, '
      
        '   :M200, :M100, :M50, :M25, :M20, :M10, :M5, :MONTO_MONEDAS, :C' +
        'OD_USUARIO, '
      '   :STATUS, :FECHA_IN, :FECHA_UPDATE)')
    RefreshSQL.Strings = (
      'Select '
      ...
      '  FECHA_IN,'
      '  FECHA_UPDATE'
      'from DIST_CASHCUADRECAJA '
      'where'
      '  COD_EMPLEADO = :COD_EMPLEADO and'
      '  FECHA = :FECHA')
    SelectSQL.Strings = (
      'Select * from DIST_CASHCUADRECAJA'
      'Where cod_empleado between :codempini and :codempfin'
      'and fecha between :fechaini and :fechafin')
    ModifySQL.Strings = (
      'update DIST_CASHCUADRECAJA'
      'set'
      '  ID = :ID,'
      '  COD_EMPLEADO = :COD_EMPLEADO,'
      '  FECHA = :FECHA,'
    ...
    GeneratorField.Generator = 'GEN_DIST_CASHCUADRECAJA_ID'
    GeneratorField.ApplyEvent = gamOnPost
    Left = 504
    Top = 160
    object tblDistCashEnCajaID: TIntegerField
      FieldName = 'ID'
      Origin = 'DIST_CASHCUADRECAJA.ID'
      Required = True
    end
    object tblDistCashEnCajaCOD_EMPLEADO: TIntegerField
      FieldName = 'COD_EMPLEADO'
      Origin = 'DIST_CASHCUADRECAJA.COD_EMPLEADO'
      Required = True
    end
    object tblDistCashEnCajaFECHA: TDateTimeField
      FieldName = 'FECHA'
      Origin = 'DIST_CASHCUADRECAJA.FECHA'
      Required = True
    end
    object tblDistCashEnCajaMONTO_EN_CHEQUE: TFloatField
      FieldName = 'MONTO_EN_CHEQUE'
      Origin = 'DIST_CASHCUADRECAJA.MONTO_EN_CHEQUE'
    end
    object tblDistCashEnCajaM2000: TIntegerField
      FieldName = 'M2000'
      Origin = 'DIST_CASHCUADRECAJA.M2000'
    end
    object tblDistCashEnCajaM1000: TIntegerField
      FieldName = 'M1000'
      Origin = 'DIST_CASHCUADRECAJA.M1000'
    end
    object tblDistCashEnCajaM500: TIntegerField
      FieldName = 'M500'
      Origin = 'DIST_CASHCUADRECAJA.M500'
    end
    object tblDistCashEnCajaM200: TIntegerField
      FieldName = 'M200'
      Origin = 'DIST_CASHCUADRECAJA.M200'
    end
    object tblDistCashEnCajaM100: TIntegerField
      FieldName = 'M100'
      Origin = 'DIST_CASHCUADRECAJA.M100'
    end
    object tblDistCashEnCajaM50: TIntegerField
      FieldName = 'M50'
      Origin = 'DIST_CASHCUADRECAJA.M50'
    end
    object tblDistCashEnCajaM25: TIntegerField
      FieldName = 'M25'
      Origin = 'DIST_CASHCUADRECAJA.M25'
    end
    object tblDistCashEnCajaM20: TIntegerField
      FieldName = 'M20'
      Origin = 'DIST_CASHCUADRECAJA.M20'
    end
    object tblDistCashEnCajaM10: TIntegerField
      FieldName = 'M10'
      Origin = 'DIST_CASHCUADRECAJA.M10'
    end
    object tblDistCashEnCajaM5: TIntegerField
      FieldName = 'M5'
      Origin = 'DIST_CASHCUADRECAJA.M5'
    end
    object tblDistCashEnCajaMONTO_MONEDAS: TFloatField
      FieldName = 'MONTO_MONEDAS'
      Origin = 'DIST_CASHCUADRECAJA.MONTO_MONEDAS'
    end
    object tblDistCashEnCajaCOD_USUARIO: TIntegerField
      FieldName = 'COD_USUARIO'
      Origin = 'DIST_CASHCUADRECAJA.COD_USUARIO'
    end
    object tblDistCashEnCajaSTATUS: TIBStringField
      FieldName = 'STATUS'
      Origin = 'DIST_CASHCUADRECAJA.STATUS'
      FixedChar = True
      Size = 1
    end
    object tblDistCashEnCajaFECHA_IN: TDateTimeField
      FieldName = 'FECHA_IN'
      Origin = 'DIST_CASHCUADRECAJA.FECHA_IN'
    end
    object tblDistCashEnCajaFECHA_UPDATE: TDateTimeField
      FieldName = 'FECHA_UPDATE'
      Origin = 'DIST_CASHCUADRECAJA.FECHA_UPDATE'
    end
  end
end
