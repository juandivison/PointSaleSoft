...
type
  TfrmEnviarFileLVentas = class(TForm)
    edtruta: TEdit;
    Label1: TLabel;
...
var
  frmEnviarFileLVentas: TfrmEnviarFileLVentas;

implementation
uses UGlobal, UDatmodDatosGenerales, UDatModCompania;
{$R *.dfm}

procedure TfrmEnviarFileLVentas.FormCreate(Sender: TObject);
begin
  edtruta.Text:= GlbRutaLibroVentas;
  DirectoryListBox1.Directory := GlbRutaLibroVentas
end;

procedure TfrmEnviarFileLVentas.Button1Click(Sender: TObject);
var
...
procedure TfrmEnviarFileLVentas.BitBtn1Click(Sender: TObject);
var
  _targetFile : String;
begin
...
function TfrmEnviarFileLVentas.ProcCompilarFileLVenta(_path: String;
...
function TfrmEnviarFileLVentas.ProcZipFileLVenta(_path: String;
  var targetFile: string): Boolean;
var
  flag : boolean;
  VCLZip1 : TVCLZip;
...
procedure TfrmEnviarFileLVentas.EnviaEmail(_archivoZip: string);
begin
  GlbIDTipoEmail := 3; //Libro de Ventas
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          'Libros de Ventas. '#13''+edtMensaje.Text+'.',
...
procedure TfrmEnviarFileLVentas.BitBtn2Click(Sender: TObject);
var
  _targetFile : String;
begin
