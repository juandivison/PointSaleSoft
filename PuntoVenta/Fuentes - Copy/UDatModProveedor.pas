...
type
  TdmProveedor = class(TDataModule)
    ...
    dmProveedorRNC_PROVEEDOR: TIBStringField;
    dmProveedorMOVIL1: TIBStringField;
    dmProveedorMOVIL2: TIBStringField;
    dmProveedorTELEFONO2: TIBStringField;
    dmProveedorTELEFONO3: TIBStringField;
    dmProveedorEXTENSIONES: TIBStringField;
    ...
    qryProveedoresConGastos: TIBQuery;
    qryProveedoresConGastosCODIGO: TIntegerField;
    qryProveedoresConGastosDESCRIPCION: TIBStringField;
    qryProveedoresConGastosCONDICION: TIntegerField;
    qryProveedoresConGastosTIPODOC: TSmallintField;
    qryProveedoresConGastosRNC_PROVEEDOR: TIBStringField;
    qryProveedoresConGastosTELEFONO: TIBStringField;
    qryProveedoresConGastosMOVIL1: TIBStringField;
  private
