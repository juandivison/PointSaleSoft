...
type
  TqckCertificadoSam = class(TQuickRep)
...
var
  qckCertificadoSam: TqckCertificadoSam;

implementation
 uses UDatModClientes;
{$R *.DFM}

procedure TqckCertificadoSam.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  qckCertificadoSam.QRImage1.Visible:=True;
end;

procedure TqckCertificadoSam.QRLabel1Print(sender: TObject;
  var Value: String);
begin
  Value:=FormatDateTime('dd',now);
end;

procedure TqckCertificadoSam.QRLabel2Print(sender: TObject;
  var Value: String);
begin
  Value:=FormatDateTime('mmm',now);
end;

procedure TqckCertificadoSam.QRLabel3Print(sender: TObject;
  var Value: String);
begin
  Value:=  FormatDateTime('yyyy',now);
end;

procedure TqckCertificadoSam.QRLabel4Print(sender: TObject;
  var Value: String);
begin
...
procedure TqckCertificadoSam.QRDBText14Print(sender: TObject;
  var Value: String);
begin
  Value:='#Póliza:'+Value;
end;
