...
type
  TfrmProcVentaRapidaNueva = class(TForm)
    ...
    SkinData1: TSkinData;procedure BitBtn4Click(Sender: TObject);
...
{procedure TfrmProcVentaRapidaNueva.ActivaPermiso(proceso:integer; iduser:Integer; isperson:integer);
var
  X, y, z:integer;
begin
...
procedure TfrmProcVentaRapidaNueva.qryInventarioAfterOpen(DataSet: TDataSet);
begin
  //rxqryInv.Close;
  //rxqryInv.Open;
  //qryInventario.First;
...
procedure TfrmProcVentaRapidaNueva.rxqryInvAfterScroll(DataSet: TDataSet);
begin
  {FAplicaPrecioMayorista := False;
  Label23.Visible := False;
  if qryClasifPrecio.state = dsInactive then Exit;
...
procedure TfrmProcVentaRapidaNueva.FormActivate(Sender: TObject);
begin
  ProcActUltTrn;
end;

procedure TfrmProcVentaRapidaNueva.DBEdit6Exit(Sender: TObject);
begin
  AbrirClasifPrecio;
  AplicaPrecioMayorista;
end;
