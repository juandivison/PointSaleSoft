object frmPromociones: TfrmPromociones
  ...
  object DBStatusLabel1: TDBStatusLabel
    ...
    Width = 85
    Height = 13
    DatasetName = 'Promociones'
    DataSource = dstblPromociones
  end
  ...
  object dstblPromociones: TDataSource
    AutoEdit = False
    DataSet = dmCuadrexRuta.tblPromociones
    Left = 355
    Top = 226
  end
  object dsqryInventario: TDataSource
    DataSet = dmCuadrexRuta.qryInventario
    Left = 352
    Top = 160
  end
