...
type
  TfrmContabilizarIngCxc = class(TfrmContabilizaDatos)
    Memo1: TMemo;
    DBGridTest: TDBGrid;
...
var
  frmContabilizarIngCxc: TfrmContabilizarIngCxc;
...
procedure TfrmContabilizarIngCxc.FormCreate(Sender: TObject);
var 
 lfecha: TDatetime;
 lstatus: String;
begin
...
procedure TfrmContabilizarIngCxc.btnDatosClick(Sender: TObject);
var
  lfecha :TDatetime;
  lstatus:String;
  nError:Boolean;
...
procedure TfrmContabilizarIngCxc.PrepararDatos;
var
  campos : String;
  strcampokey : string;
  x, y : Integer;
...
procedure TfrmContabilizarIngCxc.ProcDatos;
var
  xmonto  : Extended;
  fCampos : TField;
  NombreCampo : string;
...
procedure TfrmContabilizarIngCxc.HacerTotales;
begin
...
procedure TfrmContabilizarIngCxc.btnProcesarClick(Sender: TObject);
var
  tempo : extended;
begin
  //inherited;
  ...
  GlbDescTipoCNT := 'Transacccion Ingresos Cxc';
  dmDistCnt.rxDatosTransCnt.Close;
  dmDistCnt.rxDatosTransCnt.Open;
  //dmCxc.rxTranCnt.Close;
  //dmCxc.rxTranCnt.Open;
  dmCxc.rxTranCnt.Close;
  dmCxc.rxTranCnt.Open;
  GlbDescTipoCNT := 'Transaccción Ingresos Cxc';
  ...
  frmPrepararDatosCnt.nombreView := 'VIEW_Cobros_cxcACNT';
...
procedure TfrmContabilizarIngCxc.btnContabilizarClick(Sender: TObject);
begin
  inherited;
  //
  btnContabilizar.Enabled:=False;
...
function TfrmContabilizarIngCxc.procPreparaCampootro(xnum : Integer):Boolean;
var
  campos : string;
begin
  Memo1.Clear;
...
procedure TfrmContabilizarIngCxc.dtpkfechaExit(Sender: TObject);
begin
  inherited;
  //
end;
