...
begin
  ...
  if (ExtraerFecha(dtpkfecha.DateTime) = 0) then
  begin
    Messagedlg('Fecha no ha sido asignada, verifique', mtInformation,[mbYes], 0);
  ...
  begin
    ...
    dmTransCnt.tblTransCntMaster.Append;
    dmTransCnt.tblTransCntMasterCIA_KEY.Value := GlbCia_Key; 
  ...
  begin
    ...
    begin
      ...
      begin
        dmTransCnt.tblTransCntDet.Append;
