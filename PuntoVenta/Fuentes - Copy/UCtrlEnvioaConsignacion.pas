...
type
  TfrmConsignaciones = class(TForm)
...
var
  frmConsignaciones: TfrmConsignaciones;
...
procedure TfrmConsignaciones.BitBtn10Click(Sender: TObject);
begin
  dmInventario.tblReparacionesMaster.Prior;
end;

procedure TfrmConsignaciones.BitBtn11Click(Sender: TObject);
begin
  dmInventario.tblReparacionesMaster.Next;
end;

procedure TfrmConsignaciones.BitBtn12Click(Sender: TObject);
begin
  dmInventario.tblReparacionesMaster.Last;
end;

procedure TfrmConsignaciones.BitBtn9Click(Sender: TObject);
begin
  dmInventario.tblReparacionesMaster.First;
end;

procedure TfrmConsignaciones.btnCancelarClick(Sender: TObject);
begin
  if dmInventario.tblReparacionesMaster.State in [dsEdit, dsInsert] then
  dmInventario.tblReparacionesMaster.Cancel;
end;

procedure TfrmConsignaciones.btnCerarAbrirresClick(Sender: TObject);
begin
...
procedure TfrmConsignaciones.btnInsertarClick(Sender: TObject);
begin
...
procedure TfrmConsignaciones.btnModificarClick(Sender: TObject);
begin
  if dmInventario.tblReparacionesMaster.State = dsBrowse then
  dmInventario.tblReparacionesMaster.Edit;
end;

procedure TfrmConsignaciones.btnSalvarClick(Sender: TObject);
begin
  if dmInventario.tblReparacionesMaster.State in [dsEdit, dsInsert] then
  begin
...
procedure TfrmConsignaciones.BitBtn1Click(Sender: TObject);
begin
...
procedure TfrmConsignaciones.BitBtn2Click(Sender: TObject);
begin
  if dmInventario.tblReparacionesDet.State = dsBrowse then
  dmInventario.tblReparacionesDet.Edit;
end;

procedure TfrmConsignaciones.BitBtn4Click(Sender: TObject);
begin
  if dmInventario.tblReparacionesDet.State in [dsEdit, dsInsert] then
  dmInventario.tblReparacionesDet.cancel;
end;

procedure TfrmConsignaciones.BitBtn5Click(Sender: TObject);
begin
  if dmInventario.tblReparacionesMaster.State in [dsEdit, dsInsert] then
  begin
    btnSalvarClick(Self);
...
procedure TfrmConsignaciones.BitBtn6Click(Sender: TObject);
begin
...
procedure TfrmConsignaciones.FormCreate(Sender: TObject);
begin
...
procedure TfrmConsignaciones.Edit1Exit(Sender: TObject);
begin
...
procedure TfrmConsignaciones.RxDBLookupCombo3Change(Sender: TObject);
begin
  Edit1.Text := dmInventario.tblInventarioProdCODIGO.AsString;
end;

procedure TfrmConsignaciones.BitBtn8Click(Sender: TObject);
begin
  Imprimir(0);
end;

procedure TfrmConsignaciones.Imprimir(tipo: smallint);
...
procedure TfrmConsignaciones.BitBtn13Click(Sender: TObject);
begin
  Imprimir(1);
end;
