object frmTransaccionesCxc: TfrmTransaccionesCxc
  ...
  object rxDatosProcCxc: TRxMemoryData
    FieldDefs = <
      item
    ...
    Left = 256
    Top = 344
    object rxDatosProcCxcNOMBRE_FACTURAR: TStringField
      DisplayLabel = 'Nombre Cliente'
      FieldName = 'NOMBRE_FACTURAR'
      Size = 40
    end
    object rxDatosProcCxcCODIGO_CLIENTE: TIntegerField
      DisplayLabel = 'Codigo'
      FieldName = 'CODIGO_CLIENTE'
    end
    object rxDatosProcCxcNUMERO_DOC: TIntegerField
      DisplayLabel = 'Numero Documento'
      FieldName = 'NUMERO_DOC'
    end
    object rxDatosProcCxcVALOR_DOCUMENTO: TFloatField
      DisplayLabel = 'Valor Documento'
      FieldName = 'VALOR_DOCUMENTO'
    end
    object rxDatosProcCxcBALANCE_ACT: TFloatField
      DisplayLabel = 'Balance Actual'
      FieldName = 'BALANCE_ACT'
    end
    object rxDatosProcCxcOrigen: TSmallintField
      FieldName = 'Origen'
    end
    object rxDatosProcCxcNumeroSerie: TIntegerField
      FieldName = 'NumeroSerie'
    end
  end
  object dsrxDatosProcCxc: TDataSource
    DataSet = rxDatosProcCxc
    Left = 256
    Top = 392
  end
end
