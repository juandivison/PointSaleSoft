object frmPresupuestoVta: TfrmPresupuestoVta
  Left = 223
  Top = 134
  Width = 1135
  Height = 613
  ...
  object qryProductos: TIBQuery
    ...
    SQL.Strings = (
        ...
        'Select i.CODIGO,p.DESCRIPCION proveedor, i.DESCRIPCION, i.CANTID' +
        'AD, i.PRECIO, l.*,i.Precio_Minimo'
      'from INVENTARIO_PRODUCTO i'
      'left outer join LOTE l on l.CODIGO = i.codigo'
      'left outer join PROVEEDORES p on p.CODIGO_CTE = l.CODIGO_PROV'
    ...
    object qryProductosPROVEEDOR: TIBStringField
      FieldName = 'PROVEEDOR'
    ...
    object qryProductosCODIGO1: TIntegerField
      FieldName = 'CODIGO1'
      Origin = 'LOTE.CODIGO'
    end
    ...
    object qryProductosCODIGO_PROV: TIntegerField
    ...
    object qryProductosCANT_IN: TIntegerField
      FieldName = 'CANT_IN'
      Origin = 'LOTE.CANT_IN'
    end
    object qryProductosCANT_OUT: TIntegerField
      FieldName = 'CANT_OUT'
    ...
    object qryProductosSERIE_TRN_REGPED: TIntegerField
      FieldName = 'SERIE_TRN_REGPED'
      Origin = 'LOTE.SERIE_TRN_REGPED'
    end
    object qryProductosCOD_PROV_ANT: TIntegerField
      FieldName = 'COD_PROV_ANT'
      Origin = 'LOTE.COD_PROV_ANT'
    end
  ...
  object rxPresupuesto: TRxMemoryData
    FieldDefs = <
      item
        Name = 'codigo'
        DataType = ftInteger
    ...
    AfterPost = rxPresupuestoAfterPost
    Left = 520
    Top = 184
    object rxPresupuestocodigo: TIntegerField
      FieldName = 'codigo'
    end
    object rxPresupuestoDescripcion: TStringField
      FieldName = 'Descripcion'
      Size = 80
    end
    object rxPresupuestoCantidad: TCurrencyField
      FieldName = 'Cantidad'
    end
    object rxPresupuestoPrecio: TCurrencyField
      FieldName = 'Precio'
    end
    object rxPresupuestoValor: TCurrencyField
      FieldName = 'Valor'
    end
  end
  object DataSource2: TDataSource
    DataSet = rxPresupuesto
    Left = 760
    Top = 216
  end
