...
uses
  ...
  StdCtrls, Buttons, RxMemDS, RXDBCtrl, Mask, rxToolEdit, RxToolEdit;
...
type
  TfrmPrepararDatosCnt = class(TForm)
    ...
    DBGrid3: TDBGrid;
    Button1: TButton;
    tblMastercnt: TIBDataSet;
    tblMasterDetalle: TIBDataSet;
    tblMasterDetalleSERIE: TFloatField;
    tblMasterDetalleNUMERO: TIntegerField;
    tblMasterDetalleCODIGO_DEPTO: TIntegerField;
    tblMasterDetalleDESCRIPCION_TRN: TIBStringField;
    tblMasterDetalleDEBITO_TRN: TFloatField;
    tblMasterDetalleCREDITO_TRN: TFloatField;
    tblMasterDetalleCUENTA1: TIBStringField;
    tblMasterDetalleCUENTA2: TIBStringField;
    tblMasterDetalleCUENTA3: TIBStringField;
    tblMasterDetalleSTATUS_APLICADA: TIBStringField;
    tblMasterDetalleSTATUS: TIBStringField;
    tblMasterDetalleIN_POR: TIBStringField;
    tblMasterDetalleFECHA_IN: TDateTimeField;
    tblMasterDetalleMOD_POR: TIBStringField;
    tblMasterDetalleFECHA_MOD: TDateTimeField;
    tblMasterDetalleNUM_DOC: TFloatField;
    tblMasterDetalleCOD_CTA_CONCEPTO: TIntegerField;
    tblMasterDetalleCODIGO_CENTRO_COSTO: TIntegerField;
    tblMastercntNUMERO: TIntegerField;
    tblMastercntFECHA: TDateTimeField;
    tblMastercntTIPO_DOC: TSmallintField;
    tblMastercntDESCRIPCION: TIBStringField;
    tblMastercntMONTO: TFloatField;
    tblMastercntSTATUS: TIBStringField;
    tblMastercntIN_POR: TIBStringField;
    tblMastercntFECHA_IN: TDateTimeField;
    tblMastercntMOD_POR: TIBStringField;
    tblMastercntFECHA_MOD: TDateTimeField;
    BitBtn2: TBitBtn;
    RxDBGrid1: TRxDBGrid;
...
procedure TfrmPrepararDatosCnt.ProcDatos;
var
  monto : Extended;
begin
  qryDistribucionCntDet.Close;
