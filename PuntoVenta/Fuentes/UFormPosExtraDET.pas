...
begin
  ...
  begin
    ...
    frmProcVentaRapida.rxVentaLevelPrecio.Value:= dmcalculos.qryConsultaPosExtraDetLEVEL_PRECIO_VENT.Value;
...
begin
  ...
  frmProcVentaRapida.QryPrecios.Params[0].Value:=frmProcVentaRapida.rxVentaCodArticulo.Value;
  frmProcVentaRapida.QryPrecios.Open;
  frmProcVentaRapida.QryPrecios.Locate('Codigo', frmProcVentaRapida.rxVentaCodArticulo.Value,[]);
