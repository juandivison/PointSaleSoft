...
begin
  ...
  begin
    ...
    begin
      ...
      'FormatearExcel.exe',
      FormatDateTime('yyyy/mm/dd',dbEditFechaInicial.Date), // fecha ini
      FormatDateTime('yyyy/mm/dd',dbEditFechaFinal.Date), // fecha fin
...
begin
  if FileExists(GlbNombreArchivo) then
   EjecutarFormatearExcelYEsperar(
      ...
      if (output = '') then
      ShowMessage('No se ha generado el reporte.') else
      ShowMessage(output);
end;
