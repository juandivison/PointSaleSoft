object dmVentas: TdmVentas
  ...
  object tblVtaMast: TIBDataSet
    ...
    InsertSQL.Strings = (
      'insert into Ventas_mast'
        ...
        'ITBIS, '
      '   COD_USR_CAJA, COD_SUBCLIENTE, IDDGII_MOTIVO_NCR)'
      'values'
    ...
    object tblVtaMastIDDGII_MOTIVO_NCR: TSmallintField
  ...
  object qryPrecioMaxInv: TIBQuery
    Database = dmConectar.IBDatabase1
    Transaction = dmConectar.IBTransaction1
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'Select Max(Precio)  PrecioMax From INVENTARIO_PRODUCTO'
    ...
    object qryPrecioMaxInvPRECIOMAX: TFloatField
      FieldName = 'PRECIOMAX'
    end
  end
  object tblncfasignado: TIBDataSet
    Database = dmConectar.IBDatabase1
    Transaction = dmConectar.IBTransaction1
    BufferChunks = 1000
    CachedUpdates = True
    ...
    InsertSQL.Strings = (
      'insert into NCF_ASIGNADOS'
        ...
        'T, FECHA_UPDATE, '
      '   CODIGO_USUARIO_UPD, ECF, NUMERO_NCF_REFERENCIA)'
      'values'
    ...
    Left = 544
    Top = 512
    object tblncfasignadoSERIE: TIntegerField
      FieldName = 'SERIE'
      Origin = 'NCF_ASIGNADOS.SERIE'
      Required = True
    end
    object tblncfasignadoTIPO_NCF: TIBStringField
      FieldName = 'TIPO_NCF'
      Origin = 'NCF_ASIGNADOS.TIPO_NCF'
      Required = True
      Size = 2
    end
    object tblncfasignadoNUMERO_NCF: TIBStringField
      FieldName = 'NUMERO_NCF'
      Origin = 'NCF_ASIGNADOS.NUMERO_NCF'
      Required = True
      Size = 21
    end
    object tblncfasignadoFECHA: TDateTimeField
      FieldName = 'FECHA'
      Origin = 'NCF_ASIGNADOS.FECHA'
      Required = True
    end
    object tblncfasignadoCODIGO_CTE: TIntegerField
      FieldName = 'CODIGO_CTE'
      Origin = 'NCF_ASIGNADOS.CODIGO_CTE'
    end
    object tblncfasignadoNOMBRE_COMPLETO: TIBStringField
      FieldName = 'NOMBRE_COMPLETO'
      Origin = 'NCF_ASIGNADOS.NOMBRE_COMPLETO'
      Size = 80
    end
    object tblncfasignadoCEDULA: TIBStringField
      FieldName = 'CEDULA'
      Origin = 'NCF_ASIGNADOS.CEDULA'
    end
    object tblncfasignadoDIRECCION: TIBStringField
      FieldName = 'DIRECCION'
      Origin = 'NCF_ASIGNADOS.DIRECCION'
      Size = 80
    end
    object tblncfasignadoCIUDAD: TIBStringField
      FieldName = 'CIUDAD'
      Origin = 'NCF_ASIGNADOS.CIUDAD'
      Size = 40
    end
    object tblncfasignadoMONTO: TFloatField
      FieldName = 'MONTO'
      Origin = 'NCF_ASIGNADOS.MONTO'
    end
    object tblncfasignadoSTATUS: TIBStringField
      FieldName = 'STATUS'
      Origin = 'NCF_ASIGNADOS.STATUS'
      Size = 1
    end
    object tblncfasignadoCODIGO_USUARIO: TIntegerField
      FieldName = 'CODIGO_USUARIO'
      Origin = 'NCF_ASIGNADOS.CODIGO_USUARIO'
    end
    object tblncfasignadoFECHA_INSERT: TDateTimeField
      FieldName = 'FECHA_INSERT'
      Origin = 'NCF_ASIGNADOS.FECHA_INSERT'
    end
    object tblncfasignadoFECHA_UPDATE: TDateTimeField
      FieldName = 'FECHA_UPDATE'
      Origin = 'NCF_ASIGNADOS.FECHA_UPDATE'
    end
    object tblncfasignadoCODIGO_USUARIO_UPD: TIntegerField
      FieldName = 'CODIGO_USUARIO_UPD'
      Origin = 'NCF_ASIGNADOS.CODIGO_USUARIO_UPD'
    end
    object tblncfasignadoECF: TIBStringField
      FieldName = 'ECF'
      Origin = 'NCF_ASIGNADOS.ECF'
      Size = 13
    end
    object tblncfasignadoNUMERO_NCF_REFERENCIA: TIBStringField
