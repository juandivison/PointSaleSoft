object dmDespacho: TdmDespacho
  ...
  object tblDespachoMasterRep: TIBQuery
    ...
    object tblDespachoMasterRepNCF: TIBStringField
      FieldName = 'NCF'
      Origin = 'DESPACHO_MASTER.NCF'
      Size = 21
    end
    object tblDespachoMasterRepRNC_PROVEEDOR: TIBStringField
      FieldName = 'RNC_PROVEEDOR'
      Origin = 'DESPACHO_MASTER.RNC_PROVEEDOR'
      Size = 15
    end
    object tblDespachoMasterRepINVENTARIO_ID: TIntegerField
      FieldName = 'INVENTARIO_ID'
      Origin = 'DESPACHO_MASTER.INVENTARIO_ID'
    end
    object tblDespachoMasterRepSERIE_INV_ID: TIntegerField
      FieldName = 'SERIE_INV_ID'
      Origin = 'DESPACHO_MASTER.SERIE_INV_ID'
    end
    object tblDespachoMasterRepINV_ID_ORIGEN: TIntegerField
      FieldName = 'INV_ID_ORIGEN'
      Origin = 'DESPACHO_MASTER.INV_ID_ORIGEN'
    end
    object tblDespachoMasterRepINV_ID_DESTINO: TIntegerField
      FieldName = 'INV_ID_DESTINO'
      Origin = 'DESPACHO_MASTER.INV_ID_DESTINO'
    end
    object tblDespachoMasterRepFORMA_PAGO: TSmallintField
      FieldName = 'FORMA_PAGO'
      Origin = 'DESPACHO_MASTER.FORMA_PAGO'
    end
    object tblDespachoMasterRepNUMERO_FACTURA: TIntegerField
      FieldName = 'NUMERO_FACTURA'
      Origin = 'DESPACHO_MASTER.NUMERO_FACTURA'
    end
    object tblDespachoMasterRepSTATUS_CNT: TIBStringField
      FieldName = 'STATUS_CNT'
  ...
  object QryRepDespachoDet: TIBQuery
    Database = dmConectar.IBDatabase1
    Transaction = dmConectar.IBTransaction1
    OnCalcFields = QryRepDespachoDetCalcFields
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'select * from DESPACHO'
    ...
    object QryRepDespachoDetCANT_UNIDADES: TFloatField
      FieldName = 'CANT_UNIDADES'
      Origin = 'DESPACHO.CANT_UNIDADES'
    end
    object QryRepDespachoDetUNIDADID: TIntegerField
      FieldName = 'UNIDADID'
      Origin = 'DESPACHO.UNIDADID'
    end
    object QryRepDespachoDetSTATUS_CNT: TIBStringField
      FieldName = 'STATUS_CNT'
      Origin = 'DESPACHO.STATUS_CNT'
      FixedChar = True
      Size = 1
    end
    object QryRepDespachoDetVALORDESCUENTO: TCurrencyField
      FieldKind = fkCalculated
      FieldName = 'VALORDESCUENTO'
      Calculated = True
    end
    object QryRepDespachoDetCANTOFERTA: TIntegerField
      FieldName = 'CANTOFERTA'
      Origin = 'DESPACHO.CANTOFERTA'
    end
  end
  ...
  object tblEditarDespachoMaster: TIBDataSet
    Database = dmConectar.IBDatabase1
    Transaction = dmConectar.IBTransaction1
    BufferChunks = 1000
    CachedUpdates = False
    SelectSQL.Strings = (
      'Select * from DESPACHO_MASTER')
    OnFilterRecord = tblEditarDespachoMasterFilterRecord
    Left = 216
    Top = 296
    object tblEditarDespachoMasterNUMERO: TIntegerField
      DisplayLabel = 'Numero'
      FieldName = 'NUMERO'
      Origin = 'DESPACHO_MASTER.NUMERO'
      Required = True
    end
    object tblEditarDespachoMasterFECHA: TDateTimeField
      DisplayLabel = 'Fecha'
      FieldName = 'FECHA'
      Origin = 'DESPACHO_MASTER.FECHA'
    end
    object tblEditarDespachoMasterTIPO_TRN: TSmallintField
      DisplayLabel = 'TipoTrn'
      FieldName = 'TIPO_TRN'
      Origin = 'DESPACHO_MASTER.TIPO_TRN'
    end
    object tblEditarDespachoMasterCODIGO_DESPACHADOR: TIntegerField
      DisplayLabel = 'CodDespachador'
      FieldName = 'CODIGO_DESPACHADOR'
      Origin = 'DESPACHO_MASTER.CODIGO_DESPACHADOR'
    end
    object tblEditarDespachoMasterCODIGO_EMP: TIntegerField
      DisplayLabel = 'CodigoEmp'
      FieldName = 'CODIGO_EMP'
      Origin = 'DESPACHO_MASTER.CODIGO_EMP'
    end
    object tblEditarDespachoMasterMONTO_TOTAL: TFloatField
      DisplayLabel = 'Monto Total'
      FieldName = 'MONTO_TOTAL'
      Origin = 'DESPACHO_MASTER.MONTO_TOTAL'
    end
    object tblEditarDespachoMasterNUM_ORDEN: TFloatField
      DisplayLabel = 'Numero Orden'
      FieldName = 'NUM_ORDEN'
      Origin = 'DESPACHO_MASTER.NUM_ORDEN'
    end
    object tblEditarDespachoMasterSTATUS: TIBStringField
      DisplayLabel = 'Status'
      FieldName = 'STATUS'
      Origin = 'DESPACHO_MASTER.STATUS'
      FixedChar = True
    ...
    object tblEditarDespachoMasterFECHA_IN: TDateTimeField
      FieldName = 'FECHA_IN'
      Origin = 'DESPACHO_MASTER.FECHA_IN'
    end
    object tblEditarDespachoMasterIN_POR: TIBStringField
      FieldName = 'IN_POR'
      Origin = 'DESPACHO_MASTER.IN_POR'
      Size = 12
    end
    object tblEditarDespachoMasterFECHA_MOD: TDateTimeField
      FieldName = 'FECHA_MOD'
      Origin = 'DESPACHO_MASTER.FECHA_MOD'
    end
    object tblEditarDespachoMasterMOD_POR: TIBStringField
      FieldName = 'MOD_POR'
      Origin = 'DESPACHO_MASTER.MOD_POR'
      Size = 12
    end
    object tblEditarDespachoMasterCODIGO_RUTA: TIntegerField
      FieldName = 'CODIGO_RUTA'
      Origin = 'DESPACHO_MASTER.CODIGO_RUTA'
    end
    object tblEditarDespachoMasterNUM_CONDUCE: TIntegerField
      DisplayLabel = 'Num Conduce'
      FieldName = 'NUM_CONDUCE'
      Origin = 'DESPACHO_MASTER.NUM_CONDUCE'
    end
    object tblEditarDespachoMasterCODIGO_PROV: TIntegerField
      DisplayLabel = 'Codigo Prov'
      FieldName = 'CODIGO_PROV'
      Origin = 'DESPACHO_MASTER.CODIGO_PROV'
    end
    object tblEditarDespachoMasterNCF: TIBStringField
      DisplayLabel = 'Ncf'
      FieldName = 'NCF'
      Origin = 'DESPACHO_MASTER.NCF'
      Size = 21
    end
    object tblEditarDespachoMasterRNC_PROVEEDOR: TIBStringField
      DisplayLabel = 'Rnc Proveedor'
      FieldName = 'RNC_PROVEEDOR'
      Origin = 'DESPACHO_MASTER.RNC_PROVEEDOR'
      Size = 15
    end
    object tblEditarDespachoMasterINVENTARIO_ID: TIntegerField
      DisplayLabel = 'Inventario ID'
      FieldName = 'INVENTARIO_ID'
      Origin = 'DESPACHO_MASTER.INVENTARIO_ID'
    end
    object tblEditarDespachoMasterSERIE_INV_ID: TIntegerField
      DisplayLabel = 'Serie Inv Id'
      FieldName = 'SERIE_INV_ID'
      Origin = 'DESPACHO_MASTER.SERIE_INV_ID'
    end
    object tblEditarDespachoMasterINV_ID_ORIGEN: TIntegerField
      DisplayLabel = 'Inv Id Origen'
      FieldName = 'INV_ID_ORIGEN'
      Origin = 'DESPACHO_MASTER.INV_ID_ORIGEN'
    end
    object tblEditarDespachoMasterINV_ID_DESTINO: TIntegerField
      DisplayLabel = 'Inv. Id Destino'
      FieldName = 'INV_ID_DESTINO'
      Origin = 'DESPACHO_MASTER.INV_ID_DESTINO'
    end
  end
  object dstblEditarDespachoMaster: TDataSource
    DataSet = tblEditarDespachoMaster
    Left = 216
    Top = 344
  end
end
