...
procedure TqckRepRecibo8_5_11REsp.QRBand4BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if (frmProcVentaRapida.TotalesTipoNCF.Value = '02') then
  begin
    QRLabel10.Enabled:=False;
    //QRLabel5.Left:=QRLabel10.Left;
    //QRDBText15.Left:=679;
    //QRDBText15.BringToFront;
  end;
  ...
  begin
    ...
    QRBand4.HasChild:=False;
  end else
  if (xtipoVenta = 'CREDITO') then
...
procedure TqckRepRecibo8_5_11REsp.QRDBText21Print(sender: TObject;
  var Value: String);
begin
...
procedure TqckRepRecibo8_5_11REsp.QRDBText22Print(sender: TObject;
  var Value: String);
begin
...
procedure TqckRepRecibo8_5_11REsp.QRLabel10Print(sender: TObject;
  var Value: String);
begin
  //Value:=FormatDateTime('dd/mm/yyyy',Now+365);
end;
