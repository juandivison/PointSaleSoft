...
uses UDatModReportes, UGlobal, UDatModCompania, UDatModCxc, UCoreOCXFiscal,
  ...
  UDatModUsuarios, FacturaElectronicaUnit;
...
procedure TfrmTestImpresoraFiscal.Button4Click(Sender: TObject);
var
...
begin
  ...
  try
    ...
    Factura.Descuento   :=10.5;
    Factura.FechaEmision:=now;
    Factura.FechaVencimientoSecuencia:=Now+30;
    Factura.IndicadorMontoGravado:=1;
    Factura.Municipio:='Santo Domingo';
    Factura.NCF      :='A010010010010101001';
    Factura.NCFReferencia:='';
    Factura.PagoACredito :=15000.00;
    Factura.PagoBonosOCertificados:=0;
    Factura.PagoChequeTransferenciaDeposito:=5000.00;
    Factura.PagoEfectivo   :=10000.00;
    ...
    Factura.Recargo:=0;
    Factura.RNCDelComprador:='123456789';
    ...
    try
      ...
      Detalle := TDetalleFactura.Create(2,1,'MANTECA DE CACAO',100,1800,'1235','UNIDAD');
      Factura.AgregarDetalle(Detalle);
      Detalle := TDetalleFactura.Create(2,1,'MARIPOSA DE PAPEL',380,1800,'1236','UNIDAD');
      Factura.AgregarDetalle(Detalle);
