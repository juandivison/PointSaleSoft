...
type
  TdmCuadrexRuta = class(TDataModule)
    ...
    qryVentasPorUsr: TIBQuery;
    qryVentasPorUsrNUMERO: TIntegerField;
    qryVentasPorUsrFECHA: TDateTimeField;
    qryVentasPorUsrCODIGO_CTE: TIntegerField;
    qryVentasPorUsrNOMBRE_FACTURAR: TIBStringField;
    qryVentasPorUsrNOMBRE_CLIENTE_GENERAL: TIBStringField;
    qryVentasPorUsrNUMERO_FACTURA: TIntegerField;
    qryVentasPorUsrNUMERO_DOC_PAGO: TIBStringField;
    qryVentasPorUsrMONEDA: TIBStringField;
    qryVentasPorUsrTIPO_DOC: TSmallintField;
    qryVentasPorUsrSTATUS: TIBStringField;
    qryVentasPorUsrNOMBRE_CAJERO: TIBStringField;
    qryVentasPorUsrCODIGO_CAJERO: TIntegerField;
    qryVentasPorUsrCANTIDAD_LINEAS: TIntegerField;
    qryVentasPorUsrCANTIDAD_ARTICULOS: TFloatField;
    qryVentasPorUsrMONTO_SERVICIO_DET: TFloatField;
    qryVentasPorUsrMONTO_ITBIS_DET: TFloatField;
    qryVentasPorUsrMONTO_DESC_ITEM: TFloatField;
    qryVentasPorUsrSUBTOTAL_DETALLE: TFloatField;
    qryVentasPorUsrTOTAL_DETALLE_CALCULADO: TFloatField;
    qryVentasPorUsrMONTO_TOTAL_ITBIS: TFloatField;
    qryVentasPorUsrPROPINA: TFloatField;
    qryVentasPorUsrPROPINALEGAL: TFloatField;
    qryVentasPorUsrVENTAARS: TSmallintField;
    qryVentasPorUsrMONTO_PAGADO_MASTER: TFloatField;
