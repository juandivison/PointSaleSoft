...
type
  TfrmTrgtr = class(TForm)
    ...
    tRegistroGLBFACTCXCATERCERO: TSmallintField;
    tRegistroDESC_MONTO_TARJETACUADRE: TSmallintField;
...
begin
  ...
  begin
   ...
   try
     ...
     frmConfClaveMaestra.Edit2.Text:=tRegistroCLAVE_MAESTRA.Value;
...
procedure TfrmTrgtr.DBRadioGroup4Change(Sender: TObject);
begin
  if (tRegistroTRANSP_ITBIS.Value=0) then
  begin
