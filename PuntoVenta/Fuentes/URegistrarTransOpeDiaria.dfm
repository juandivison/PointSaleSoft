object frmRegTransOpeDiaria: TfrmRegTransOpeDiaria
  Left = 255
  Top = 152
  Width = 939
  Height = 534
  Caption = 'Registrar Transacciones Operacion diaria'
  Color = clBtnFace
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      ...
      object RxDBLookupCombo6: TRxDBLookupCombo
        ...
        LookupField = 'TIPO_CF'
        LookupDisplay = 'DESCRIPCION'
        LookupSource = dtmTransOpeDiaria.dstblTipoCF
        TabOrder = 6
      end
      ...
      object BitBtn17: TBitBtn
        ...
        Width = 38
        Height = 25
        Hint = 'Quitar valor seleccionado para Tipo Bienes'
        Caption = 'Anular'
  ...
  object ibSqlUpdateTransCostoStatus: TIBSQL
  ...
  object stpProcUpdateTrncxp: TIBStoredProc
    Database = dmConectar.IBDatabase1
    Transaction = dmConectar.IBTransaction1
    StoredProcName = 'Proc_updateTRANS_CXPCosto'
    Left = 532
    Top = 344
    ParamData = <
      item
  ...
  object SelFecha: TGetAnyDate
    Fecha = 41528.000000000000000000
    VFechaF = True
    EligeTipo = False
    TipoRes = 1
    UsaFechaCierre = True
  ...
  object tblTipoPagoCxp: TIBTable
    ...
    Left = 124
    Top = 328
    object tblTipoPagoCxpCODIGO: TSmallintField
      FieldName = 'CODIGO'
      Required = True
    end
    object tblTipoPagoCxpDESCRIPCION: TIBStringField
      FieldName = 'DESCRIPCION'
      Size = 60
    end
  end
  object dstblTipoPagoCxp: TDataSource
