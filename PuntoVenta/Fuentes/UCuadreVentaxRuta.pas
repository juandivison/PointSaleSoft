...
uses
  ...
  RXCtrls, rxToolEdit, Menus, ComCtrls, rxCurrEdit, RxCalc, WinSkinData;
...
begin
  ...
  dmcuadrexruta.qryDatosEmpleado.params[0].Value:=glbCia_Key;
...
begin
  ...
  begin
    ...
    FGlbPorcItbi(ExtraerFecha(rxVentaxRutafecha.Value), qryInventarioCODIGO.Value) / 100;
...
begin
  ...
  begin
    ...
    dmCuadrexRuta.qryCargarDatosCuadreRuta.Tag:= glbCia_Key;
