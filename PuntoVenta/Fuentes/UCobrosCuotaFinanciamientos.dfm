object frmCobroCuotasFinanciamientos: TfrmCobroCuotasFinanciamientos
  ...
  object chkSaldar: TCheckBox
    ...
    ParentFont = False
    TabOrder = 7
    OnClick = chkSaldarClick
  end
  object chkSoloAbono: TCheckBox
    Left = 863
    Top = 127
    Width = 107
    Height = 17
    Hint = 'Cobra solo Abono'
    Caption = 'Solo &Abono'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -16
  ...
  object qryDatosCuota: TIBQuery
    ...
    AfterOpen = qryDatosCuotaAfterOpen
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
  ...
  object rxTotales: TRxMemoryData
    ...
    object rxTotalesNotaCredito: TCurrencyField
      FieldName = 'NotaCredito'
      DisplayFormat = ',0.00'
    end
    object rxTotalesNotaDebito: TCurrencyField
      FieldName = 'NotaDebito'
      DisplayFormat = ',0.00'
    end
    object rxTotalesAbonoACuota: TCurrencyField
      FieldName = 'AbonoACuota'
      DisplayFormat = ',0.00'
    end
    object rxTotalesMontoParaSaldo: TCurrencyField
      FieldName = 'MontoParaSaldo'
      DisplayFormat = ',0.00'
    end
  end
  ...
  object qryFactPend: TIBQuery
    ...
    SQL.Strings = (
      ...
      'And Facturas_pendientes.NUMERO_FACT =:numerofact'
  ...
  object stpProcCobrarFinanc: TIBStoredProc
    Database = dmConectar.IBDatabase1
    Transaction = dmConectar.IBTransaction1
    StoredProcName = 'PROC_COBRAR_FINANCIAMIENTO'
    Left = 64
    Top = 112
    ParamData = <
      item
