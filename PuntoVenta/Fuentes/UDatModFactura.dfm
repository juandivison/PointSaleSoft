object dmFactura: TdmFactura
  ...
  object ibQryViewNCF: TIBQuery
    Database = dmConectar.IBDatabase1
    Transaction = dmConectar.IBTransaction1
    AfterClose = ibQryViewNCFAfterClose
    BeforeClose = ibQryViewNCFBeforeClose
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
  ...
  object qryVentaFactura: TIBQuery
    ...
    SQL.Strings = (
      ...
      '  NCF_ASIGNADOS.DGII_STATUS,'
      '  NCF_ASIGNADOS.NCF_ANTERIOR,'
      '  NCF_ASIGNADOS.TRACK_ID,'
      '  NCF_ASIGNADOS.NUMERO_NCF_REFERENCIA,'
      '  NCF_ASIGNADOS.LAST_ERROR,'
      '  NCF_ASIGNADOS.REINTENTOS,'
      ...
      'VENTAS_MAST.ESTADO_VENTA, '
      'VENTAS_MAST.REF_TRN_ORIGEN, '
      'VENTAS_MAST.REF_NCF_ORIGEN, '
      'VENTAS_MAST.REF_FECHA_ORIGEN, '
      'VENTAS_MAST.REF_ESTADO_ORIGEN,'
      'VENTAS_MAST.IDDGII_MOTIVO_NCR'
      'FROM'
      '  VENTAS_MAST'
    ...
    object qryVentaFacturaDGII_STATUS: TIBStringField
      FieldName = 'DGII_STATUS'
      Origin = 'NCF_ASIGNADOS.DGII_STATUS'
    end
    object qryVentaFacturaNCF_ANTERIOR: TIBStringField
      FieldName = 'NCF_ANTERIOR'
      Origin = 'NCF_ASIGNADOS.NCF_ANTERIOR'
    end
    object qryVentaFacturaTRACK_ID: TIBStringField
      FieldName = 'TRACK_ID'
      Origin = 'NCF_ASIGNADOS.TRACK_ID'
      Size = 50
    end
    object qryVentaFacturaNUMERO_NCF_REFERENCIA: TIBStringField
      FieldName = 'NUMERO_NCF_REFERENCIA'
      Origin = 'NCF_ASIGNADOS.NUMERO_NCF_REFERENCIA'
    end
    object qryVentaFacturaLAST_ERROR: TMemoField
      FieldName = 'LAST_ERROR'
      Origin = 'NCF_ASIGNADOS.LAST_ERROR'
      BlobType = ftMemo
      Size = 8
    end
    object qryVentaFacturaREINTENTOS: TIntegerField
    ...
    object qryVentaFacturaESTADO_VENTA: TIBStringField
      FieldName = 'ESTADO_VENTA'
      Origin = 'VENTAS_MAST.ESTADO_VENTA'
      Size = 10
    end
    object qryVentaFacturaREF_TRN_ORIGEN: TIntegerField
      FieldName = 'REF_TRN_ORIGEN'
      Origin = 'VENTAS_MAST.REF_TRN_ORIGEN'
    end
    object qryVentaFacturaREF_NCF_ORIGEN: TIBStringField
      FieldName = 'REF_NCF_ORIGEN'
      Origin = 'VENTAS_MAST.REF_NCF_ORIGEN'
      Size = 19
    end
    object qryVentaFacturaREF_FECHA_ORIGEN: TDateTimeField
      FieldName = 'REF_FECHA_ORIGEN'
      Origin = 'VENTAS_MAST.REF_FECHA_ORIGEN'
    end
    object qryVentaFacturaREF_ESTADO_ORIGEN: TIBStringField
      FieldName = 'REF_ESTADO_ORIGEN'
      Origin = 'VENTAS_MAST.REF_ESTADO_ORIGEN'
      Size = 10
    end
    object qryVentaFacturaIDDGII_MOTIVO_NCR: TSmallintField
  ...
  object qryVentaFacturaDet: TIBQuery
    ...
    SQL.Strings = (
      ...
      '  I.REFERENCIA,'
      '  I.CODIGO_TEXTO,'
      '  COALESCE(I.INVENTARIAR, 0) AS INVENTARIAR,'
      ''
      '  F.DESCRIPCION AS DESC_TIPO_NCF,'
      ''
      '  D.SERIE,'
      ...
      '  D.PORC_DESC_DET,'
      '  ABS(D.ITBI_DET) AS ITBI_DET,'
      '  D.PORC_DESC_ITEM,'
      '  ABS(D.MONTO_DESC_ITEM) AS MONTO_DESC_ITEM,'
      ''
      '  ABS(D.VALOR_SERVICIO_DET) AS VALOR_SERVICIO_DET,'
      '  ABS(D.VALOR_TOTAL_DET) AS VALOR_TOTAL_DET,'
      ''
      '  V.NUMERO_FACTURA,'
      '  D.STATUS_DET,'
      '  V.SERIE_NCF_ASIGNADO,'
      '  N.NUMERO_NCF,'
      '  ABS(V.MONTO_DESCUENTO) AS MONTO_DESCUENTO,'
      ''
      '  D.NUMERO,'
      '  D.CODIGO_BARRA,'
      '  D.NUM_FACTURA,'
      ...
      '  CASE'
        ...
        '    WHEN NULLIF(D.DESCRIPCIONPRODUCTO, '#39#39') IS NULL THEN D.DESCRI' +
        'PCION'
      ...
      ''
      '  /*'
      '    Valores hist'#243'ricos de la l'#237'nea.'
      '    No usar cat'#225'logo actual para reconstruirlos.'
      '  */'
      '  COALESCE(D.MONEDA, V.MONEDA) AS MONEDA,'
      '  COALESCE(D.MONTO_TASA, 1) AS MONTO_TASA,'
      '  COALESCE(D.IDTASAITBIS, 0) AS IDTASAITBIS,'
      ''
      ...
      '  ('
      '    SELECT FIRST 1'
      '      COALESCE(R.TRANSP_ITBIS, 1)'
      '    FROM REGISTRO R'
      '  ) AS TRANSP_ITBIS'
      ''
      'FROM VENTAS_MAST V'
      'INNER JOIN VENTAS_DET D'
      '  ON V.NUMERO = D.NUMERO'
      'LEFT JOIN NCF_ASIGNADOS N'
      '  ON V.SERIE_NCF_ASIGNADO = N.SERIE'
      'LEFT JOIN TIPO_CF F'
      '  ON N.TIPO_NCF = F.TIPO_CF'
      'LEFT JOIN UNIDADES U'
      '  ON D.TIPO_UNIDAD = U.IDUNIDAD'
      'LEFT JOIN INVENTARIO_PRODUCTO I'
      '  ON I.CODIGO = D.CODIGO_PROD'
    ...
    object qryVentaFacturaDetCODIGO_TEXTO: TIBStringField
      FieldName = 'CODIGO_TEXTO'
      Origin = 'INVENTARIO_PRODUCTO.CODIGO_TEXTO'
      Size = 40
    end
    object qryVentaFacturaDetINVENTARIAR: TIntegerField
      FieldName = 'INVENTARIAR'
    end
    object qryVentaFacturaDetMONEDA: TIBStringField
      FieldName = 'MONEDA'
      FixedChar = True
      Size = 1
    end
    object qryVentaFacturaDetMONTO_TASA: TFloatField
      FieldName = 'MONTO_TASA'
    end
    object qryVentaFacturaDetIDTASAITBIS: TFloatField
  ...
  object qryRepCotizaNew: TIBQuery
    ...
    object qryRepCotizaNewSHOWPRECIOCONITBIS: TSmallintField
      FieldName = 'SHOWPRECIOCONITBIS'
      Origin = 'PROC_GETDATOSCOTIZA_NEW.SHOWPRECIOCONITBIS'
    end
  end
  object qryRepCotizaDetNew: TIBQuery
    ...
    SQL.Strings = (
      ...
      'r.DESCRIPCION,  r.SERIE, r.NUMERO, '
        ...
        'oSinItbis, r.PRECIO, r.PORC_DESC_DET, r.ITBI_DET, '
    ...
    object qryRepCotizaDetNewPRECIOSINITBIS: TFloatField
      FieldKind = fkInternalCalc
      FieldName = 'PRECIOSINITBIS'
      Origin = 'VIEW_COTIZACION_DET.PRECIOSINITBIS'
      ReadOnly = True
    end
  end
  ...
  object qryVentaFacturaDet_food_0: TIBQuery
    ...
    SQL.Strings = (
      ...
      ''
      '  CASE'
      '    WHEN NULLIF(D.DESCRIPCIONPRODUCTO, '#39#39') IS NULL THEN'
      '      D.DESCRIPCION'
      '    ELSE'
      '      D.DESCRIPCION || '#39' '#39' || D.DESCRIPCIONPRODUCTO'
      '  END AS DESCRIPCIONPRODUCTO,'
      ...
      '  /*'
      '    Valores hist'#243'ricos de la l'#237'nea.'
      '    No usar cat'#225'logo actual durante modificaci'#243'n de factura.'
      '  */'
      '  COALESCE(D.MONEDA, V.MONEDA) AS MONEDA,'
      '  COALESCE(D.MONTO_TASA, 1) AS MONTO_TASA,'
      '  COALESCE(D.IDTASAITBIS, 0) AS IDTASAITBIS,'
      ...
      'INNER JOIN VENTAS_DET D'
      '  ON V.NUMERO = D.NUMERO'
      'LEFT OUTER JOIN NCF_ASIGNADOS N'
      '  ON V.SERIE_NCF_ASIGNADO = N.SERIE'
      'LEFT OUTER JOIN TIPO_CF F'
      '  ON N.TIPO_NCF = F.TIPO_CF'
      'LEFT OUTER JOIN UNIDADES U'
      '  ON D.TIPO_UNIDAD = U.IDUNIDAD'
      'LEFT OUTER JOIN INVENTARIO_PRODUCTO I'
      '  ON I.CODIGO = D.CODIGO_PROD'
      ''
      'WHERE V.NUMERO = :NUMERO'
      ''
      ...
      '  U.CANTIDAD,'
      ''
      '  COALESCE(D.MONEDA, V.MONEDA),'
      '  COALESCE(D.MONTO_TASA, 1),'
      '  COALESCE(D.IDTASAITBIS, 0),'
      ''
      '  D.PORC_DESC_DET,'
      '  D.PORC_DESC_ITEM'
      ''
  ...
  object tblUpdateVenta: TIBDataSet
    ...
    object tblUpdateVentaMONTODESCGASTOSADMIN: TFloatField
      FieldName = 'MONTODESCGASTOSADMIN'
      Origin = 'VENTAS_MAST.MONTODESCGASTOSADMIN'
    end
    object tblUpdateVentaMONTODESCITBISGASTOSADMIN: TFloatField
      FieldName = 'MONTODESCITBISGASTOSADMIN'
      Origin = 'VENTAS_MAST.MONTODESCITBISGASTOSADMIN'
    end
    object tblUpdateVentaMONTODESCTRANSP: TFloatField
      FieldName = 'MONTODESCTRANSP'
      Origin = 'VENTAS_MAST.MONTODESCTRANSP'
    end
    object tblUpdateVentaMONTODESCDIRTECNICA: TFloatField
      FieldName = 'MONTODESCDIRTECNICA'
      Origin = 'VENTAS_MAST.MONTODESCDIRTECNICA'
    end
    object tblUpdateVentaMONTODESCITBISDIRTECNICA: TFloatField
      FieldName = 'MONTODESCITBISDIRTECNICA'
      Origin = 'VENTAS_MAST.MONTODESCITBISDIRTECNICA'
    end
    object tblUpdateVentaMONTODESCIMPREVISTO: TFloatField
      FieldName = 'MONTODESCIMPREVISTO'
      Origin = 'VENTAS_MAST.MONTODESCIMPREVISTO'
    end
    object tblUpdateVentaMONTODESCITBISIMPREVISTO: TFloatField
      FieldName = 'MONTODESCITBISIMPREVISTO'
      Origin = 'VENTAS_MAST.MONTODESCITBISIMPREVISTO'
    end
    object tblUpdateVentaDESC_MONTO_COMBUSTIBLE: TFloatField
      FieldName = 'DESC_MONTO_COMBUSTIBLE'
      Origin = 'VENTAS_MAST.DESC_MONTO_COMBUSTIBLE'
    end
    object tblUpdateVentaDESC_MONTO_PRESTAMO: TFloatField
      FieldName = 'DESC_MONTO_PRESTAMO'
      Origin = 'VENTAS_MAST.DESC_MONTO_PRESTAMO'
    end
    object tblUpdateVentaDESC_MONTO_SINDICATO: TFloatField
      FieldName = 'DESC_MONTO_SINDICATO'
      Origin = 'VENTAS_MAST.DESC_MONTO_SINDICATO'
    end
    object tblUpdateVentaDESC_IMP_SOBRE_RENTA: TFloatField
      FieldName = 'DESC_IMP_SOBRE_RENTA'
      Origin = 'VENTAS_MAST.DESC_IMP_SOBRE_RENTA'
    end
    object tblUpdateVentaDESC_OTROS: TFloatField
      FieldName = 'DESC_OTROS'
      Origin = 'VENTAS_MAST.DESC_OTROS'
    end
    object tblUpdateVentaPORC_DESC_SINDICATO: TIBBCDField
      FieldName = 'PORC_DESC_SINDICATO'
      Origin = 'VENTAS_MAST.PORC_DESC_SINDICATO'
      Precision = 9
      Size = 2
    end
    object tblUpdateVentaPORC_DESC_IMP_SOBRE_RENTA: TIBBCDField
      FieldName = 'PORC_DESC_IMP_SOBRE_RENTA'
      Origin = 'VENTAS_MAST.PORC_DESC_IMP_SOBRE_RENTA'
      Precision = 9
      Size = 2
    end
    object tblUpdateVentaDESC_RUTA: TFloatField
      FieldName = 'DESC_RUTA'
      Origin = 'VENTAS_MAST.DESC_RUTA'
    end
    object tblUpdateVentaOTROS_DESCUENTOS_2: TFloatField
      FieldName = 'OTROS_DESCUENTOS_2'
      Origin = 'VENTAS_MAST.OTROS_DESCUENTOS_2'
    end
    object tblUpdateVentaOTROS_DESCUENTOS_3: TFloatField
      FieldName = 'OTROS_DESCUENTOS_3'
      Origin = 'VENTAS_MAST.OTROS_DESCUENTOS_3'
    end
    object tblUpdateVentaMONTO_DESC_CHOFER: TFloatField
      FieldName = 'MONTO_DESC_CHOFER'
      Origin = 'VENTAS_MAST.MONTO_DESC_CHOFER'
    end
    object tblUpdateVentaTIPO_VENTA: TSmallintField
      FieldName = 'TIPO_VENTA'
      Origin = 'VENTAS_MAST.TIPO_VENTA'
    end
    object tblUpdateVentaCOMENTARIO: TIBStringField
      FieldName = 'COMENTARIO'
      Origin = 'VENTAS_MAST.COMENTARIO'
      Size = 80
    end
    object tblUpdateVentaCOTIZACION_ORIGEN: TIntegerField
      FieldName = 'COTIZACION_ORIGEN'
      Origin = 'VENTAS_MAST.COTIZACION_ORIGEN'
    end
    object tblUpdateVentaREFERENCIACTE: TIBStringField
      FieldName = 'REFERENCIACTE'
      Origin = 'VENTAS_MAST.REFERENCIACTE'
    end
    object tblUpdateVentaMONTO_RECARGO: TFloatField
      FieldName = 'MONTO_RECARGO'
      Origin = 'VENTAS_MAST.MONTO_RECARGO'
    end
    object tblUpdateVentaTIPONCFIFISCAL: TIntegerField
      FieldName = 'TIPONCFIFISCAL'
      Origin = 'VENTAS_MAST.TIPONCFIFISCAL'
    end
    object tblUpdateVentaMONTO_EXONERADO_ITBIS: TFloatField
      FieldName = 'MONTO_EXONERADO_ITBIS'
      Origin = 'VENTAS_MAST.MONTO_EXONERADO_ITBIS'
    end
    object tblUpdateVentaNIF_IMPRESO: TSmallintField
      FieldName = 'NIF_IMPRESO'
      Origin = 'VENTAS_MAST.NIF_IMPRESO'
    end
    object tblUpdateVentaIDRETENCION: TIntegerField
      FieldName = 'IDRETENCION'
      Origin = 'VENTAS_MAST.IDRETENCION'
    end
    object tblUpdateVentaPROPINALEGAL: TFloatField
      FieldName = 'PROPINALEGAL'
      Origin = 'VENTAS_MAST.PROPINALEGAL'
    end
    object tblUpdateVentaPORCPROPINALEGAL: TFloatField
      FieldName = 'PORCPROPINALEGAL'
      Origin = 'VENTAS_MAST.PORCPROPINALEGAL'
    end
    object tblUpdateVentaPROPINA: TFloatField
      FieldName = 'PROPINA'
      Origin = 'VENTAS_MAST.PROPINA'
    end
    object tblUpdateVentaTICKET_ID: TIntegerField
      FieldName = 'TICKET_ID'
      Origin = 'VENTAS_MAST.TICKET_ID'
    end
    object tblUpdateVentaSUB_TOTALITBIS: TFloatField
      FieldName = 'SUB_TOTALITBIS'
      Origin = 'VENTAS_MAST.SUB_TOTALITBIS'
    end
    object tblUpdateVentaCOD_USR_CAJA: TIntegerField
      FieldName = 'COD_USR_CAJA'
      Origin = 'VENTAS_MAST.COD_USR_CAJA'
    end
    object tblUpdateVentaCOD_SUBCLIENTE: TIntegerField
      FieldName = 'COD_SUBCLIENTE'
      Origin = 'VENTAS_MAST.COD_SUBCLIENTE'
    end
    object tblUpdateVentaVENTAARS: TSmallintField
      FieldName = 'VENTAARS'
      Origin = 'VENTAS_MAST.VENTAARS'
    end
    object tblUpdateVentaFECHAINICIAPOLIZA: TDateTimeField
      FieldName = 'FECHAINICIAPOLIZA'
      Origin = 'VENTAS_MAST.FECHAINICIAPOLIZA'
    end
    object tblUpdateVentaTIPO_AFILIADO: TSmallintField
      FieldName = 'TIPO_AFILIADO'
      Origin = 'VENTAS_MAST.TIPO_AFILIADO'
    end
    object tblUpdateVentaIDNUMERODVEH: TIntegerField
      FieldName = 'IDNUMERODVEH'
      Origin = 'VENTAS_MAST.IDNUMERODVEH'
    end
    object tblUpdateVentaCOD_CAJA: TIntegerField
      FieldName = 'COD_CAJA'
      Origin = 'VENTAS_MAST.COD_CAJA'
    end
    object tblUpdateVentaSERIE_ECF_ASIGNADO: TIntegerField
      FieldName = 'SERIE_ECF_ASIGNADO'
      Origin = 'VENTAS_MAST.SERIE_ECF_ASIGNADO'
    end
    object tblUpdateVentaTIPO_INGRESO: TSmallintField
      FieldName = 'TIPO_INGRESO'
      Origin = 'VENTAS_MAST.TIPO_INGRESO'
    end
    object tblUpdateVentaIDDGII_MOTIVO_NCR: TSmallintField
      FieldName = 'IDDGII_MOTIVO_NCR'
      Origin = 'VENTAS_MAST.IDDGII_MOTIVO_NCR'
    end
    object tblUpdateVentaESTADO_VENTA: TIBStringField
      FieldName = 'ESTADO_VENTA'
      Origin = 'VENTAS_MAST.ESTADO_VENTA'
      Size = 10
    end
    object tblUpdateVentaREF_TRN_ORIGEN: TIntegerField
      FieldName = 'REF_TRN_ORIGEN'
      Origin = 'VENTAS_MAST.REF_TRN_ORIGEN'
    end
    object tblUpdateVentaREF_NCF_ORIGEN: TIBStringField
      FieldName = 'REF_NCF_ORIGEN'
      Origin = 'VENTAS_MAST.REF_NCF_ORIGEN'
      Size = 19
    end
    object tblUpdateVentaREF_FECHA_ORIGEN: TDateTimeField
      FieldName = 'REF_FECHA_ORIGEN'
      Origin = 'VENTAS_MAST.REF_FECHA_ORIGEN'
    end
    object tblUpdateVentaREF_ESTADO_ORIGEN: TIBStringField
      FieldName = 'REF_ESTADO_ORIGEN'
      Origin = 'VENTAS_MAST.REF_ESTADO_ORIGEN'
      Size = 10
    end
    object tblUpdateVentaNUMERO_NCF: TIBStringField
      FieldName = 'NUMERO_NCF'
      Origin = 'NCF_ASIGNADOS.NUMERO_NCF'
      Size = 21
    end
  ...
  object qryLookDev: TIBQuery
    Database = dmConectar.IBDatabase1
    Transaction = dmConectar.IBTransaction1
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'select num_doc from TRANS_CXC_DET'
      'where numero_trn_origen =:numerotrnvta'
      'order by serie desc')
    Left = 872
    Top = 544
    ParamData = <
    ...
    object qryLookDevNUM_DOC: TIntegerField
      FieldName = 'NUM_DOC'
      Origin = 'TRANS_CXC_DET.NUM_DOC'
      Required = True
    end
  end
  object qryctabcofact: TIBQuery
    Database = dmConectar.IBDatabase1
    Transaction = dmConectar.IBTransaction1
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
        ...
        'SELECT r.FACT_DESCBANCO, r.FACT_TITLAR, r.FACT_DESCNUMCTA FROM B' +
        'ANCOS_DET R'
      'WHERE r.CIA_KEY =:ciakey AND r.ACTIVAENFCT=1')
    Left = 952
    Top = 536
    ParamData = <
      item
    ...
    object qryctabcofactFACT_DESCBANCO: TIBStringField
      FieldName = 'FACT_DESCBANCO'
      Origin = 'BANCOS_DET.FACT_DESCBANCO'
      Size = 40
    end
    object qryctabcofactFACT_TITLAR: TIBStringField
      FieldName = 'FACT_TITLAR'
      Origin = 'BANCOS_DET.FACT_TITLAR'
      Size = 60
    end
    object qryctabcofactFACT_DESCNUMCTA: TIBStringField
  ...
  object qryVentaFacturaDet_BCK: TIBQuery
    Database = dmConectar.IBDatabase1
    Transaction = dmConectar.IBTransaction1
    BufferChunks = 1000
    CachedUpdates = False
