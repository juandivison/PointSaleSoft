object dmInventario: TdmInventario
  ...
  object tblTipoInventario: TIBQuery
    ...
    object tblTipoInventarioIDINDICADORBOSERV: TSmallintField
      FieldName = 'IDINDICADORBOSERV'
      Origin = 'TIPO_INVENTARIO.IDINDICADORBOSERV'
    end
  end
  object IBUpdateSQL2: TIBUpdateSQL
    ...
    ModifySQL.Strings = (
      ...
      '  CODIGO = :CODIGO,'
      '  DESCRIPCION = :DESCRIPCION,'
      '  IDINDICADORBOSERV = :IDINDICADORBOSERV'
      'where'
      '  CODIGO = :OLD_CODIGO')
    InsertSQL.Strings = (
      'insert into TIPO_INVENTARIO'
      '  (CODIGO, DESCRIPCION, IDINDICADORBOSERV)'
      'values'
      '  (:CODIGO, :DESCRIPCION, :IDINDICADORBOSERV)')
    DeleteSQL.Strings = (
  ...
  object qryLote: TIBQuery
    ...
    SQL.Strings = (
      ...
      'LOTE_NUM,'
      'sum((coalesce(CANT_IN,0) - coalesce(CANT_OUT,0))) CANT'
      'FROM LOTE'
      'WHERE (CANT_IN - CANT_OUT)  > 0'
      'AND CODIGO=:CODIGO'
      'group by FECHA_VENCIMIENTO,LOTE_NUM'
  ...
  object tblTasaITBIS: TIBDataSet
    ...
    object tblTasaITBISIDITBISECF: TSmallintField
  ...
  object qryInvOtro: TIBQuery
    Database = dmConectar.IBDatabase1
    Transaction = dmConectar.IBTransaction1
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'Select sum(i.cantidad) qtyOtro'
    ...
    object qryInvOtroQTYOTRO: TFloatField
      FieldName = 'QTYOTRO'
    end
  end
end
