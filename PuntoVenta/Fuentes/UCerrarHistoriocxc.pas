...
type
  TfrmVTrnDiaria = class(TForm)
    ...
    ibprocactualizaBlcBanco: TIBStoredProc;
  ...
  public
    ...
    procedure ActualizaBalanceActBanco;
...
procedure TfrmVTrnDiaria.ActualizaBalanceActBanco;
begin
  //ibprocactualizaBlcBanco.Params[0].Value:= //codigo_banco
  //ibprocactualizaBlcBanco.Params[1].Value:= //fecha_blc
  //ibprocactualizaBlcBanco.Params[2].Value:= //balance_act
end;
