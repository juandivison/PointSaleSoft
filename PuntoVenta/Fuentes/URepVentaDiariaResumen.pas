...
type
  TqckRepVentaDiariaResumen = class(TQuickRep)
    QRBand1: TQRBand;
    QRLabel2: TQRLabel;
    QRLabel3: TQRLabel;
...
var
  qckRepVentaDiariaResumen: TqckRepVentaDiariaResumen;
...
procedure TqckRepVentaDiariaResumen.QRLabel3Print(sender: TObject;
  var Value: String);
begin
...
procedure TqckRepVentaDiariaResumen.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
...
procedure TqckRepVentaDiariaResumen.QRDBText10Print(sender: TObject;
  var Value: String);
begin
  if value = '0.00' then value :='';
end;

procedure TqckRepVentaDiariaResumen.QRDBText11Print(sender: TObject;
  var Value: String);
begin
  if value = '0.00' then value :='';
end;

procedure TqckRepVentaDiariaResumen.QRDBText12Print(sender: TObject;
  var Value: String);
begin
  if value = '0.00' then value :='';
end;

procedure TqckRepVentaDiariaResumen.QRDBText8Print(sender: TObject;
  var Value: String);
begin
  if value = '0.00' then value :='';
end;

procedure TqckRepVentaDiariaResumen.ChildBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TqckRepVentaDiariaResumen.ProcTotal;
var
  Suma, Total : Real;
...
procedure TqckRepVentaDiariaResumen.QRBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TqckRepVentaDiariaResumen.QRLabel2Print(sender: TObject;
  var Value: String);
begin
...
procedure TqckRepVentaDiariaResumen.QRExpr1Print(sender: TObject;
  var Value: String);
begin
  if (Value = '1') then
  Value:='PESO' else
...
procedure TqckRepVentaDiariaResumen.QRSysData2Print(sender: TObject;
  var Value: String);
begin
  Value:=IntToStr(qckRepVentaDiariaResumen.PageNumber);
end;
