object frmCobroCuotasXFinanc: TfrmCobroCuotasXFinanc
  ...
  object edtDebito: TEditN
    Left = 400
    Top = 197
    Width = 57
    Height = 21
    Hint = 'Monto ser'#225' sumado'
    Color = clSilver
    Enabled = False
    ParentShowHint = False
    ShowHint = True
    ...
    EditPrecision = 0
    ValueInteger = 0
    ValueDate = 40838.000000000000000000
    ValueTime = 0.717407037037037000
    TimeSeconds = False
    FirstCharUpper = False
    FirstCharUpList = ' ('
    WidthOnFocus = 0
  ...
  object edtCredito: TEditN
    Left = 459
    Top = 197
    Width = 57
    Height = 21
    Hint = 'Monto sera Descontado'
    Color = clSilver
    Enabled = False
    ParentShowHint = False
    ShowHint = True
  ...
  object tblCobroDeCuotasFinanc: TIBDataSet
    ...
    InsertSQL.Strings = (
      'insert into FINANCIAMIENTO'
        ...
        'ND, NUM_FACTURA, '
      '   MONTO_CAP_INICIAL, NOTA_DEBITO, NOTA_CREDITO)'
      'values'
        ...
        '   :CUOTASPEND, :NUM_FACTURA, :MONTO_CAP_INICIAL, :NOTA_DEBITO, ' +
        ':NOTA_CREDITO)')
    RefreshSQL.Strings = (
      'Select '
      '  SERIE,'
    ...
    ModifySQL.Strings = (
      ...
      '  MONTO_CAP_INICIAL = :MONTO_CAP_INICIAL,'
    ...
    object tblCobroDeCuotasFinancNUM_FACTURA: TIntegerField
      FieldName = 'NUM_FACTURA'
      Origin = 'FINANCIAMIENTO.NUM_FACTURA'
    end
    object tblCobroDeCuotasFinancMONTO_CAP_INICIAL: TFloatField
      FieldName = 'MONTO_CAP_INICIAL'
      Origin = 'FINANCIAMIENTO.MONTO_CAP_INICIAL'
    end
    object tblCobroDeCuotasFinancNOTA_DEBITO: TFloatField
      FieldName = 'NOTA_DEBITO'
      Origin = 'FINANCIAMIENTO.NOTA_DEBITO'
    end
    object tblCobroDeCuotasFinancNOTA_CREDITO: TFloatField
      FieldName = 'NOTA_CREDITO'
      Origin = 'FINANCIAMIENTO.NOTA_CREDITO'
    end
  end
  ...
  object qryDatosCuota: TIBQuery
    ...
    object qryDatosCuotaMONTOCAPITAL_PARASALDO: TFloatField
      FieldName = 'MONTOCAPITAL_PARASALDO'
      Origin = 'PROC_BUSCAR_CUOTAFINANC.MONTOCAPITAL_PARASALDO'
    end
  end
