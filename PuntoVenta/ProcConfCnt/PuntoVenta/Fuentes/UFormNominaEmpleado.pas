...
uses UFormSelFecha, UDatModNomina, UGlobal, UDatModCompania,
  ...
  URepComision, URepComResVendedor;
...
begin
  ...
  begin
    ...
    dmNomina.tblNominaTIPO_NOMINA.Value  :=1;//Quincenal
    dmNomina.tblNominaFECHA_NOMINA.Value :=GlbFechaNomina;
    dmNomina.tblNominaSALARIO_BRUTO.Value:=dmNomina.qryEmpleadosSALARIO.Value / 2;
...
begin                                                 //Afp
  ...
  begin
    dmNomina.tblNominaMONTO_AFP.Value  := dmNomina.tblNominaSALARIO_BRUTO.Value *
                                          dmNomina.qryDeduccionesPORCIENTO_EMP.Value;
...
begin
  ...
  dmNomina.qryDeducciones.Params[0].Value:= GlbFechaNomina;
