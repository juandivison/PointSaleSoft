...
begin
  ...
  begin
    ...
    dmDistCnt.tblDistCntCtaFijaNOMBRE_CAMPO_CNTDET.Value := 'TRNCNT_DETALLE';
...
begin
  ...
  begin
    ...
    dmDistCnt.tblDisCtaFijaMasterMODULO.IsNull or
    dmDistCnt.tblDisCtaFijaMasterIDTIPO_PAGO.IsNull then
    begin
