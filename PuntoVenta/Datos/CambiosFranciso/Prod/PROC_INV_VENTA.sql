SET TERM ^ ;
ALTER PROCEDURE PROC_INV_VENTA (
    INVID integer )
RETURNS (
    CODIGO integer,
    ...
    CIA_KEY integer,
    PORCITBIS numeric(15,2),
    descripcionadicional  blob sub_type 1  )
AS
BEGIN
  FOR  SELECT CODIGO,
             p.CODIGO_TEXTO,
             ...
             p.precioventa3,
             p.precioventa4,
             p.USARLEVELPRECIO, p.CIA_KEY, p.porcitbis,
             p.descripcionadicional           
      ...
      INTO :CODIGO,
           ...
           :precioventa3,
           :precioventa4,
           :USARLEVELPRECIO, :cia_key, :porcitbis,
...
GRANT EXECUTE
 ON PROCEDURE PROC_INV_VENTA TO  DIVISON;
