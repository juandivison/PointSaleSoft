object dmControl: TdmControl
  ...
  object qryControlMaster: TIBQuery
    Database = dmCon.IBDatabase1
    Transaction = dmCon.IBTransaction1
    AfterScroll = qryControlMasterAfterScroll
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'Select * From Control'
      'Where '
      'Sistema =:sistema And '
      'Sub_Sistema =:subSistema  And Cod_cia =:codCia ')
    Left = 176
    Top = 16
    ParamData = <
      item
    ...
    object qryControlMasterSISTEMA: TIntegerField
      FieldName = 'SISTEMA'
      Origin = 'CONTROL.SISTEMA'
      Required = True
    end
    object qryControlMasterSUB_SISTEMA: TIntegerField
      FieldName = 'SUB_SISTEMA'
      Origin = 'CONTROL.SUB_SISTEMA'
      Required = True
    end
    object qryControlMasterCOD_CIA: TIntegerField
      FieldName = 'COD_CIA'
      Origin = 'CONTROL.COD_CIA'
      Required = True
    end
    object qryControlMasterFECHA_ACT: TDateTimeField
      FieldName = 'FECHA_ACT'
      Origin = 'CONTROL.FECHA_ACT'
      Required = True
    end
    object qryControlMasterDESCRIPCION: TIBStringField
      FieldName = 'DESCRIPCION'
      Origin = 'CONTROL.DESCRIPCION'
      Size = 30
    end
    object qryControlMasterSTATUS: TIBStringField
      FieldName = 'STATUS'
      Origin = 'CONTROL.STATUS'
      FixedChar = True
      Size = 1
  ...
  object qryControlDetalle: TIBQuery
    Database = dmCon.IBDatabase1
    Transaction = dmCon.IBTransaction1
    BufferChunks = 1000
    CachedUpdates = False
