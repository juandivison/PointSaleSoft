...
uses UDatModCompania, UGlobal, UDmRep;
...
procedure TqckRepDeposito.QRLabel2Print(sender: TObject;
  var Value: String);
begin
  Value:= FormatDateTime('dd-mmm-yyyy',dtmodrep.qryRepDepositos.Params[0].Value)
  + ' al ' + FormatDateTime('dd-mmm-yyyy',dtmodrep.qryRepDepositos.Params[1].Value);
end;
