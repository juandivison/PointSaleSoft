object frmEditarPedido: TfrmEditarPedido
  ...
  object DBDateEdit1: TDBDateEdit
    ...
    Height = 21
    DataField = 'FECHA'
    DataSource = dmDespacho.dstblEditarDespachoMaster
    NumGlyphs = 2
    TabOrder = 1
  end
  ...
  object PopupMenu1: TPopupMenu
    ...
    object Conduce1: TMenuItem
      Caption = '#Conduce'
      OnClick = Conduce1Click
    end
    object NumeroOrden1: TMenuItem
      Caption = '#Numero Orden'
      OnClick = NumeroOrden1Click
    end
    object FormaPago1: TMenuItem
      Caption = 'Forma Pago'
    end
  end
end
