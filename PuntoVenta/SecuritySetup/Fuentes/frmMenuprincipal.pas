...
type
  TfrmMenu = class(TForm)
    ...
    areas1: TMenuItem;
    Roles1: TMenuItem;
    AsignarPermisos1: TMenuItem;
    AsignarRoleaUsuario1: TMenuItem;
    ...
    procedure AsignarPermisos1Click(Sender: TObject);
    procedure AsignarRoleaUsuario1Click(Sender: TObject);
...
uses UConectar, UDatModCon, uLogin, UGlobal, uglobalCp, UDatModUsuarios,
  ...
  UFormSecprocesos, UFormPermisos, UFormTareas, UFormroles,
  UFormAsignarPermisoUsuarios, UFormAsignarRolaUsuarios;
...
begin
  frmPermisos:=TfrmPermisos.Create(Nil);
  try
...
procedure TfrmMenu.areas1Click(Sender: TObject);
begin
...
procedure TfrmMenu.Roles1Click(Sender: TObject);
begin
  frmRoles:=TfrmRoles.Create(nil);
  try
    frmRoles.showmodal;
  finally
  frmRoles.free;
...
procedure TfrmMenu.AsignarPermisos1Click(Sender: TObject);
begin
  frmPermisousuarios:=TfrmPermisousuarios.Create(Nil);
  try
   frmPermisousuarios.Showmodal;
  finally
  frmPermisousuarios.Free;
  frmPermisousuarios:=Nil;
  end;
end;

procedure TfrmMenu.AsignarRoleaUsuario1Click(Sender: TObject);
begin
  frmAsignarRol:=TfrmAsignarRol.Create(nil);
  try
    frmAsignarRol.showmodal;
  finally
  frmAsignarRol.Free;
  frmAsignarRol:=Nil;
  end;
