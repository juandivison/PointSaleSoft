...
type
  TqckSolOrdenDeCompraNew = class(TQuickRep)
...
var
  qckSolOrdenDeCompraNew: TqckSolOrdenDeCompraNew;
...
procedure TqckSolOrdenDeCompraNew.QuickRepBeforePrint(
  Sender: TCustomQuickRep; var PrintReport: Boolean);
begin
  qckSolOrdenDeCompraNew.AllDataSets.Add(dmCompania.tblCompania);
end;

procedure TqckSolOrdenDeCompraNew.QRLabel23Print(sender: TObject;
  var Value: String);
begin
  Value:=GlbBuscarCodigoVendedor(glbcodVendedor);
end;

procedure TqckSolOrdenDeCompraNew.QRLabel24Print(sender: TObject;
  var Value: String);
begin
  Value:=Value + ' '+dmfactura.qryPorcApplicadoenFactServPorcGAdmin.AsString+'%';
end;

procedure TqckSolOrdenDeCompraNew.QRLabel25Print(sender: TObject;
  var Value: String);
begin
  Value:=Value + ' '+dmfactura.qryPorcApplicadoenFactServPorcItbisGAdmin.AsString+'%';
end;

procedure TqckSolOrdenDeCompraNew.QRLabel26Print(sender: TObject;
  var Value: String);
begin
  Value:=Value + ' '+dmfactura.qryPorcApplicadoenFactServPorcTrans.AsString+'%';
end;

procedure TqckSolOrdenDeCompraNew.QRLabel27Print(sender: TObject;
  var Value: String);
begin
  Value:=Value + ' '+dmfactura.qryPorcApplicadoenFactServPorcDirTec.AsString+'%';
end;

procedure TqckSolOrdenDeCompraNew.QRLabel28Print(sender: TObject;
  var Value: String);
begin
  Value:=Value + ' '+dmfactura.qryPorcApplicadoenFactServPorcItbisDirTec.AsString+'%';
end;

procedure TqckSolOrdenDeCompraNew.QRLabel29Print(sender: TObject;
  var Value: String);
begin
  Value:=Value + ' '+dmfactura.qryPorcApplicadoenFactServPORCIMPREVISTO.AsString+'%';
end;

procedure TqckSolOrdenDeCompraNew.QRLabel30Print(sender: TObject;
  var Value: String);
begin
  Value:=Value + ' '+dmfactura.qryPorcApplicadoenFactServPorcItbisImprevisto.AsString+'%';
end;

procedure TqckSolOrdenDeCompraNew.DetailBand1BeforePrint(
...
procedure TqckSolOrdenDeCompraNew.QRDBText21Print(sender: TObject;
  var Value: String);
begin
...
procedure TqckSolOrdenDeCompraNew.QRDBText22Print(sender: TObject;
  var Value: String);
begin
  //if (Value <> '') then Value:='NCF: '+Value;
end;

procedure TqckSolOrdenDeCompraNew.ChildBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  TPag.Caption:= IntToStr(qckSolOrdenDeCompraNew.PageNumber);
end;

procedure TqckSolOrdenDeCompraNew.QRSysData3Print(sender: TObject;
  var Value: String);
begin
  Value:=Value +' de ';
end;

procedure TqckSolOrdenDeCompraNew.ColumnHeaderBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
  var
    _xImagen : String;
begin
...
procedure TqckSolOrdenDeCompraNew.QRDBText10Print(sender: TObject;
  var Value: String);
begin
