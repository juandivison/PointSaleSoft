...
uses Windows, SysUtils, Messages, Classes, Graphics, Controls,
  StdCtrls, ExtCtrls, Forms, QuickRpt, QRCtrls, DB,Variants, RxMemDS;
...
procedure TqckRepXServ.QRBand3AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  //if (ExtraerFecha(dmCxc.qryRepServFECHA_DET.Value) = GlbUltimoDiaMes(dmCxc.qryRepServFECHA_DET.Value)) then
  //begin
