unit UQckFactCredArtioffice8_5_F_1Std;
...
type
  TqckFactCredArtioffice8_5_F_1Std = class(TQuickRep)
...
var
  qckFactCredArtioffice8_5_F_1Std: TqckFactCredArtioffice8_5_F_1Std;

implementation
uses UDatModCompania, UDatModClientes, UGlobal,
  URepComprobante, UDatModFactura, UQckFactCredArtioffice8_5_F_1;


{$R *.DFM}

procedure TqckFactCredArtioffice8_5_F_1Std.QuickRepBeforePrint(
  Sender: TCustomQuickRep; var PrintReport: Boolean);
begin
  qckFactCredArtioffice8_5_F_1Std.AllDataSets.Add(dmCompania.tblCompania);
...
procedure TqckFactCredArtioffice8_5_F_1Std.QRLabel23Print(sender: TObject;
  var Value: String);
begin
  Value:=GlbBuscarCodigoVendedor(glbcodVendedor);
end;

procedure TqckFactCredArtioffice8_5_F_1Std.QRLabel24Print(sender: TObject;
  var Value: String);
begin
  Value:=Value + ' '+dmfactura.qryPorcApplicadoenFactServPorcGAdmin.AsString+'%';
end;

procedure TqckFactCredArtioffice8_5_F_1Std.QRLabel25Print(sender: TObject;
  var Value: String);
begin
  Value:=Value + ' '+dmfactura.qryPorcApplicadoenFactServPorcItbisGAdmin.AsString+'%';
end;

procedure TqckFactCredArtioffice8_5_F_1Std.QRLabel26Print(sender: TObject;
  var Value: String);
begin
  Value:=Value + ' '+dmfactura.qryPorcApplicadoenFactServPorcTrans.AsString+'%';
end;

procedure TqckFactCredArtioffice8_5_F_1Std.QRLabel27Print(sender: TObject;
  var Value: String);
begin
  Value:=Value + ' '+dmfactura.qryPorcApplicadoenFactServPorcDirTec.AsString+'%';
end;

procedure TqckFactCredArtioffice8_5_F_1Std.QRLabel28Print(sender: TObject;
  var Value: String);
begin
  Value:=Value + ' '+dmfactura.qryPorcApplicadoenFactServPorcItbisDirTec.AsString+'%';
end;

procedure TqckFactCredArtioffice8_5_F_1Std.QRLabel29Print(sender: TObject;
  var Value: String);
begin
  Value:=Value + ' '+dmfactura.qryPorcApplicadoenFactServPORCIMPREVISTO.AsString+'%';
end;

procedure TqckFactCredArtioffice8_5_F_1Std.QRLabel30Print(sender: TObject;
  var Value: String);
begin
  Value:=Value + ' '+dmfactura.qryPorcApplicadoenFactServPorcItbisImprevisto.AsString+'%';
end;

procedure TqckFactCredArtioffice8_5_F_1Std.DetailBand1BeforePrint(
...
procedure TqckFactCredArtioffice8_5_F_1Std.QRDBText22Print(sender: TObject;
  var Value: String);
begin
  if (Value <> '') then
  Value:='NCF: '+Value;
...
procedure TqckFactCredArtioffice8_5_F_1Std.ChildBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  TPag.Caption:= IntToStr(qckFactCredArtioffice8_5_F_1Std.PageNumber);
end;

procedure TqckFactCredArtioffice8_5_F_1Std.QRSysData3Print(sender: TObject;
  var Value: String);
begin
  Value:=Value +' de ';
end;

procedure TqckFactCredArtioffice8_5_F_1Std.ColumnHeaderBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
  var
    _xImagen : String;
begin
...
procedure TqckFactCredArtioffice8_5_F_1Std.QRDBText21Print(sender: TObject;
  var Value: String);
begin
...
procedure TqckFactCredArtioffice8_5_F_1Std.QRDBText9Print(sender: TObject;
  var Value: String);
begin
...
procedure TqckFactCredArtioffice8_5_F_1Std.QRLabel4Print(sender: TObject;
  var Value: String);
begin
  if (strtipodoc <> '') then
  Value:=strtipodoc;
...
procedure TqckFactCredArtioffice8_5_F_1Std.QRDBText4Print(sender: TObject;
  var Value: String);
begin
  if value = '0' then value :='';
end;

procedure TqckFactCredArtioffice8_5_F_1Std.QRDBText13Print(sender: TObject;
  var Value: String);
begin
