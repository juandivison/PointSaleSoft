...
begin
  ...
  begin
    if not dmFactura.qryVentaFacturaDetDESCRIPCIONADICIONAL.IsNull then
...
procedure TqckRepReciboReimpTicketSurtidoraNew.QuickRepStartPage(
...
procedure TqckRepReciboReimpTicketSurtidoraNew.QRLabel12Print(sender: TObject;
  var Value: String);
begin
   dmreportes.qryFPagoTicket.Close;
  dmreportes.qryFPagoTicket.Params[0].Value:= dmFactura.qryVentaFacturaNUMERO.Value;
...
begin
  ...
  begin
    ...
    //qckRepReciboReimpTicketSurtidoraNew.Page.Length + 0.347;
