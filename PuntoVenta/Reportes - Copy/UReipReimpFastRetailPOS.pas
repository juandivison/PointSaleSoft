...
procedure TqckRepReciboReimpFRetailPOS.ColumnHeaderBand1AfterPrint(
...
procedure TqckRepReciboReimpFRetailPOS.ColumnHeaderBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TqckRepReciboReimpFRetailPOS.QRDBText26Print(sender: TObject;
  var Value: String);
begin
  Value:='Válida hasta:'+Value;
end;

procedure TqckRepReciboReimpFRetailPOS.QRDBText14Print(sender: TObject;
  var Value: String);
begin
