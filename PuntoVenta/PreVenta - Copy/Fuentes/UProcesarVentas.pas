...
uses
  ...
  Buttons,  RxLookup, RXCtrls, ImgList, DBActns, ActnList, Menus,
  ExtDlgs, RxMemDS, WinSkinData, RxCalc, RxToolEdit ;
...
begin
  ...
  begin
    ...
    //dmventas.tblVentasDetalleVALOR_TOTAL_DET.Value *
    //FGlbPorcItbi(ExtraerFecha(dmVentas.tblVentasMastFECHA.Value)) / 100;
    //dmventas.tblVentasDetalleVALOR_TOTAL_DET.Value:=
    //dmventas.tblVentasDetalleVALOR_TOTAL_DET.Value  +
    //dmventas.tblVentasDetalleITBI_DET.Value;
  end;
