...
implementation
 uses UDatModDespacho, UGlobal, UDatosVentas, UDatModInventario,
  ...
  UDatModCompania, UPrecioProdXUnidad;
...
begin
  ...
  begin
    ...
    stpProcActInv.Params[5].Value:= rxDataPrecioTUnidad.Value; //Fecha Vencimiento
    stpProcActInv.Params[6].Value:= rxDataTipoUnidad.Value; //Fecha Vencimiento
