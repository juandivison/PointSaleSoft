object frmShowFinancVigente: TfrmShowFinancVigente
  Left = 206
  Top = 114
  Width = 951
  Height = 353
  Caption = 'Financiamiento(s) Vigente(s) '
  Color = clBtnFace
  ...
  object RxLabel1: TRxLabel
    ...
    Align = alTop
    Alignment = taCenter
    Caption = 'SELECCIONE FINANCIAMIENTO A COBRAR CUOTA'
    Color = 56797
    ParentColor = False
  end
  ...
  object RxDBGrid1: TRxDBGrid
    ...
    Width = 935
    Height = 209
    Hint = 'Haga click en el financiamiento a cobrar cuota'
    Align = alTop
  ...
  object qryMostrarFinancVigente: TIBQuery
    Database = dmConectar.IBDatabase1
    Transaction = dmConectar.IBTransaction1
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'select * from view_Show_Financ_vigente'
    ...
    object qryMostrarFinancVigenteBALANCE_ACT: TFloatField
      DisplayLabel = 'Balance Act'
      FieldName = 'BALANCE_ACT'
      Origin = 'VIEW_SHOW_FINANC_VIGENTE.BALANCE_ACT'
    end
    object qryMostrarFinancVigenteCANT_CUOTAS: TIntegerField
      DisplayLabel = '#Cuotas'
      FieldName = 'CANT_CUOTAS'
      Origin = 'VIEW_SHOW_FINANC_VIGENTE.CANT_CUOTAS'
    end
    object qryMostrarFinancVigenteCODIGO_CTE: TIntegerField
      DisplayLabel = 'CodCte'
      FieldName = 'CODIGO_CTE'
      Origin = 'VIEW_SHOW_FINANC_VIGENTE.CODIGO_CTE'
    end
    object qryMostrarFinancVigenteCREDITO_ACUM: TFloatField
      DisplayLabel = 'Credito Acum'
      FieldName = 'CREDITO_ACUM'
      Origin = 'VIEW_SHOW_FINANC_VIGENTE.CREDITO_ACUM'
    end
    object qryMostrarFinancVigenteCUOTASPEND: TIntegerField
      DisplayLabel = '#Cuotas Pend'
      FieldName = 'CUOTASPEND'
      Origin = 'VIEW_SHOW_FINANC_VIGENTE.CUOTASPEND'
    end
    object qryMostrarFinancVigenteDEBITO_ACUM: TFloatField
      DisplayLabel = 'Debito Acum'
      FieldName = 'DEBITO_ACUM'
      Origin = 'VIEW_SHOW_FINANC_VIGENTE.DEBITO_ACUM'
    end
    object qryMostrarFinancVigenteFECHA: TDateTimeField
      DisplayLabel = 'Fecha'
      FieldName = 'FECHA'
      Origin = 'VIEW_SHOW_FINANC_VIGENTE.FECHA'
    end
    object qryMostrarFinancVigenteFECHA_ULT_PAGO: TDateTimeField
      DisplayLabel = 'Fecha Ult. Pago'
      FieldName = 'FECHA_ULT_PAGO'
      Origin = 'VIEW_SHOW_FINANC_VIGENTE.FECHA_ULT_PAGO'
    end
    object qryMostrarFinancVigenteMONTOINICIAL: TFloatField
      DisplayLabel = 'Monto Inicial'
      FieldName = 'MONTOINICIAL'
      Origin = 'VIEW_SHOW_FINANC_VIGENTE.MONTOINICIAL'
    end
    object qryMostrarFinancVigenteNUM_FACTURA: TIntegerField
      DisplayLabel = '#Factura'
      FieldName = 'NUM_FACTURA'
      Origin = 'VIEW_SHOW_FINANC_VIGENTE.NUM_FACTURA'
    end
    object qryMostrarFinancVigenteNUMERO_TRN: TIntegerField
      DisplayLabel = '#Trn'
      FieldName = 'NUMERO_TRN'
      Origin = 'VIEW_SHOW_FINANC_VIGENTE.NUMERO_TRN'
    end
    object qryMostrarFinancVigentePORC_MORA: TFloatField
      DisplayLabel = '%Mora'
      FieldName = 'PORC_MORA'
      Origin = 'VIEW_SHOW_FINANC_VIGENTE.PORC_MORA'
    end
    object qryMostrarFinancVigentePORCIENTO: TFloatField
      DisplayLabel = '% Interes'
      FieldName = 'PORCIENTO'
      Origin = 'VIEW_SHOW_FINANC_VIGENTE.PORCIENTO'
    end
    object qryMostrarFinancVigenteSERIE: TIntegerField
      DisplayLabel = 'Serie'
      FieldName = 'SERIE'
      Origin = 'VIEW_SHOW_FINANC_VIGENTE.SERIE'
    end
    object qryMostrarFinancVigenteSTATUS: TIBStringField
      DisplayLabel = 'Status'
      FieldName = 'STATUS'
      Origin = 'VIEW_SHOW_FINANC_VIGENTE.STATUS'
      FixedChar = True
      Size = 1
    end
    object qryMostrarFinancVigenteDESCRIPCION: TIBStringField
      DisplayLabel = 'Frec. Pagos'
      FieldName = 'DESCRIPCION'
      Origin = 'VIEW_SHOW_FINANC_VIGENTE.DESCRIPCION'
      Size = 30
    end
  end
  object DataSource1: TDataSource
    DataSet = qryMostrarFinancVigente
    Left = 336
    Top = 56
  end
