...
begin
  ...
  //dmcxc.qryTipoMvtoIngreso.close;
  //dmcxc.qryTipoMvtoIngreso.Params[2].Value:=2;//debito
  //dmcxc.qryTipoMvtoIngreso.ExecQuery;
  //if dmcxc.qryTipoMvtoIngreso.Open then
  //begin
  //  Total:=dmcxc.qryTipoMvtoIngreso.current.Vars[0].AsFloat;
  //  suma:=suma + total;
